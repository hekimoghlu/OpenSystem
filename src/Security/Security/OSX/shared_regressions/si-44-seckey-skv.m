...
static void testSecureKeyVaultKeyRawSign() {
...
static void testSecureKeyVaultKeySign() {
...
int si_44_seckey_skv(int argc, char *const *argv) {
    @autoreleasepool {
        plan_tests(10);
        testSecureKeyVaultKeyRawSign();
        testSecureKeyVaultKeySign();
        return 0;
    }
}
