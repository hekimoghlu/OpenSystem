...
#define SEC_CK_PASSWORD_INCORRECT   SecStringWithDefaultValue("Incorrect Password For â€œ%@â€", "CloudKeychain", 0, "Incorrect Password For â€œ%@â€", "Title for alert when password has been entered incorrectly")
...
#define SEC_CK_DONT_ALLOW           SecStringWithDefaultValue("Donâ€™t Allow", "CloudKeychain", 0, "Donâ€™t Allow", "Donâ€™t Allow button")
...
#define SEC_CK_APPROVAL_TITLE           SecStringWithDefaultValue("Approve â€œ%@â€?", "CloudKeychain", 0, "Approve â€œ%@â€?", "Title for alert when approving another device")
...
#define SEC_CK_APPROVAL_BODY_IOS_IPAD	SecStringWithDefaultValue("Enter the password for the Apple Account â€œ%@â€ to allow this new iPad to use your iCloud account.", "CloudKeychain", 0, "Enter the password for the Apple Account â€œ%@â€ to allow this new iPad to use your iCloud account.", "Body text when approving an iPad")
#define SEC_CK_APPROVAL_BODY_IOS_IPHONE	SecStringWithDefaultValue("Enter the password for the Apple Account â€œ%@â€ to allow this new iPhone to use your iCloud account.", "CloudKeychain", 0, "Enter the password for the Apple Account â€œ%@â€ to allow this new iPhone to use your iCloud account.", "Body text when approving an iPhone")
#define SEC_CK_APPROVAL_BODY_IOS_IPOD	SecStringWithDefaultValue("Enter the password for the Apple Account â€œ%@â€ to allow this new iPod to use your iCloud account.", "CloudKeychain", 0, "Enter the password for the Apple Account â€œ%@â€ to allow this new iPod to use your iCloud account.", "Body text when approving an iPod")
#define SEC_CK_APPROVAL_BODY_IOS_MAC	SecStringWithDefaultValue("Enter the password for the Apple Account â€œ%@â€ to allow this new Mac to use your iCloud account.", "CloudKeychain", 0, "Enter the password for the Apple Account â€œ%@â€ to allow this new Mac to use your iCloud account.", "Body text when approving another Mac")
#define SEC_CK_APPROVAL_BODY_IOS_GENERIC	SecStringWithDefaultValue("Enter the password for the Apple Account â€œ%@â€ to allow this new device to use your iCloud account.", "CloudKeychain", 0, "Enter the password for the Apple Account â€œ%@â€ to allow this new device to use your iCloud account.", "Body text when approving another (generic) device")
...
#define SEC_TRUST_CERTIFICATE_ERROR         SecStringWithDefaultValue("Certificate %ld â€œ%@â€ has errors: ", "Trust", 0, "Certificate %ld â€œ%@â€ has errors: ", "Preface for per-certificate errors")

#define SEC_TRUST_ERROR_SUBTYPE_BLOCKED     SecStringWithDefaultValue("â€œ%@â€ certificate is blocked", "Trust", 0, "â€œ%@â€ certificate is blocked", "Error for blocked certificates")
#define SEC_TRUST_ERROR_SUBTYPE_REVOKED     SecStringWithDefaultValue("â€œ%@â€ certificate is revoked", "Trust", 0, "â€œ%@â€ certificate is revoked", "Error for revoked certificates")
#define SEC_TRUST_ERROR_SUBTYPE_KEYSIZE     SecStringWithDefaultValue("â€œ%@â€ certificate is using a broken key size", "Trust", 0, "â€œ%@â€ certificate is using a broken key size", "Error for certificates with weak key sizes")
#define SEC_TRUST_ERROR_SUBTYPE_WEAKHASH    SecStringWithDefaultValue("â€œ%@â€ certificate is using a broken signature algorithm", "Trust", 0, "â€œ%@â€ certificate is using a broken signature algorithm", "Error for certificates with weak signature algorithms")
#define SEC_TRUST_ERROR_SUBTYPE_DENIED      SecStringWithDefaultValue("User or administrator set â€œ%@â€ certificate as distrusted", "Trust", 0, "User or administrator set â€œ%@â€ certificate as distrusted", "Error for certificates with deny trust settings")
#define SEC_TRUST_ERROR_SUBTYPE_COMPLIANCE  SecStringWithDefaultValue("â€œ%@â€ certificate is not standards compliant", "Trust", 0, "â€œ%@â€ certificate is not standards compliant", "Error for certificates that violate standards")
#define SEC_TRUST_ERROR_SUBTYPE_EXPIRED     SecStringWithDefaultValue("â€œ%@â€ certificate is expired", "Trust", 0, "â€œ%@â€ certificate is expired", "Error for certificates that are expired")
#define SEC_TRUST_ERROR_SUBTYPE_TRUST       SecStringWithDefaultValue("â€œ%@â€ certificate is not trusted", "Trust", 0, "â€œ%@â€ certificate is not trusted", "Error for certificates that are not trusted")
#define SEC_TRUST_ERROR_SUBTYPE_NAME        SecStringWithDefaultValue("â€œ%@â€ certificate name does not match input", "Trust", 0, "â€œ%@â€ certificate name does not match input", "Error for certificates whose names do not match the policy")
#define SEC_TRUST_ERROR_SUBTYPE_USAGE       SecStringWithDefaultValue("â€œ%@â€ certificate is not permitted for this usage", "Trust", 0, "â€œ%@â€ certificate is not permitted for this usage", "Error for certificates whose usages do not match the policy")
...
#define SEC_TRUST_ERROR_SUBTYPE_ISSUER      SecStringWithDefaultValue("â€œ%@â€ certificate does not meet issuer constraints", "Trust", 0, "â€œ%@â€ certificate does not meet issuer constraints", "Error for certificates which violate constraints set on their issuer")
#define SEC_TRUST_ERROR_SUBTYPE_INVALID     SecStringWithDefaultValue("Unknown trust error for â€œ%@â€ certificate", "Trust", 0, "Unknown trust error for â€œ%@â€ certificate", "Error for unknown error")
