    ...
    switch (algorithm) {
        ...
        case SEC_OID_DES_CBC:
            rv = SecCmsContentInfoSetContentEncAlg(
                (SecArenaPoolRef)poolp, &(encd->contentInfo), algorithm, NULL, keysize);
            break;
        default:
            ...
            rv = SecCmsContentInfoSetContentEncAlgID(
                (SecArenaPoolRef)poolp, &(encd->contentInfo), pbe_algid, keysize);
