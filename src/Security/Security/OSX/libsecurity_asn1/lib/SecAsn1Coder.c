 ...
 */
OSStatus SecAsn1Decode(SecAsn1CoderRef coder,
 ...
 */
OSStatus SecAsn1EncodeItem(SecAsn1CoderRef coder, const void* src, const SecAsn1Template* templ, SecAsn1Item* dest)
{
    if ((coder == NULL) || (src == NULL) || (templ == NULL) || (dest == NULL)) {
        return errSecParam;
    }
