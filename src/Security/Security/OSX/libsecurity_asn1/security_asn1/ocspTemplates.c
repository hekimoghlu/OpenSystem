...
const SecAsn1Template kSecAsn1OCSPCertIDTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPCertID)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPCertID, algId), kSecAsn1AlgorithmIDTemplate},
    ...
    {SEC_ASN1_INTEGER | SEC_ASN1_SIGNED_INT, offsetof(SecAsn1OCSPCertID, serialNumber)},
    {0}};

const SecAsn1Template kSecAsn1OCSPRequestTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPRequest)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPRequest, reqCert), kSecAsn1OCSPCertIDTemplate},
...
const SecAsn1Template kSecAsn1OCSPSignatureTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPSignature)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPSignature, algId), kSecAsn1AlgorithmIDTemplate},
...
const SecAsn1Template kSecAsn1OCSPTbsRequestTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPTbsRequest)},
    /* optional version, explicit tag 0, default 0 */
    {SEC_ASN1_EXPLICIT | SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | 0,
    ...
    {SEC_ASN1_SEQUENCE_OF, offsetof(SecAsn1OCSPTbsRequest, requestList), kSecAsn1OCSPRequestTemplate},
    {SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | SEC_ASN1_EXPLICIT | 2,
     offsetof(SecAsn1OCSPTbsRequest, requestExtensions),
     kSecAsn1SequenceOfCertExtensionTemplate},
    {0}};

const SecAsn1Template kSecAsn1OCSPSignedRequestTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPSignedRequest)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPSignedRequest, tbsRequest), kSecAsn1OCSPTbsRequestTemplate},
...
const SecAsn1Template kSecAsn1OCSPRevokedInfoTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPRevokedInfo)},
...
const SecAsn1Template kSecAsn1OCSPCertStatusGoodTemplate[] = {
    {SEC_ASN1_POINTER | SEC_ASN1_CONTEXT_SPECIFIC | 0, offsetof(SecAsn1OCSPCertStatus, nullData), kSecAsn1NullTemplate}};
...
const SecAsn1Template kSecAsn1OCSPCertStatusUnknownTemplate[] = {
    {SEC_ASN1_CONTEXT_SPECIFIC | 2, offsetof(SecAsn1OCSPCertStatus, nullData), kSecAsn1NullTemplate}};

const SecAsn1Template kSecAsn1OCSPSingleResponseTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPSingleResponse)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPSingleResponse, certID), kSecAsn1OCSPCertIDTemplate},
    {SEC_ASN1_ANY, offsetof(SecAsn1OCSPSingleResponse, certStatus), kSecAsn1AnyTemplate},
    ...
    {SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | SEC_ASN1_EXPLICIT | 1,
...
const SecAsn1Template kSecAsn1OCSPResponseDataTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPResponseData)},
    /* optional version, explicit tag 0, default 0 */
    {SEC_ASN1_EXPLICIT | SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | 0,
    ...
    {SEC_ASN1_SEQUENCE_OF, offsetof(SecAsn1OCSPResponseData, responses), kSecAsn1OCSPSingleResponseTemplate},
    {SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | SEC_ASN1_EXPLICIT | 1,
...
const SecAsn1Template kSecAsn1OCSPBasicResponseTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPBasicResponse)},
    {SEC_ASN1_ANY, offsetof(SecAsn1OCSPBasicResponse, tbsResponseData)},
    {SEC_ASN1_INLINE, offsetof(SecAsn1OCSPBasicResponse, algId), kSecAsn1AlgorithmIDTemplate},
...
const SecAsn1Template kSecAsn1OCSPResponseBytesTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPResponseBytes)},
...
const SecAsn1Template kSecAsn1OCSPResponseTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPResponse)},
...
const SecAsn1Template kSecAsn1OCSPDRequestTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPDRequest)},
    {SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | SEC_ASN1_EXPLICIT | 0,
    ...
    {SEC_ASN1_OPTIONAL | SEC_ASN1_CONSTRUCTED | SEC_ASN1_CONTEXT_SPECIFIC | SEC_ASN1_EXPLICIT | 4,
     offsetof(SecAsn1OCSPDRequest, urls),
     kSecAsn1SequenceOfIA5StringTemplate},
    {0}};

const SecAsn1Template kSecAsn1OCSPDRequestsTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPDRequests)},
    {SEC_ASN1_INTEGER, offsetof(SecAsn1OCSPDRequests, version)},
    {SEC_ASN1_SEQUENCE_OF, offsetof(SecAsn1OCSPDRequests, requests), kSecAsn1OCSPDRequestTemplate},
    {0}};

const SecAsn1Template kSecAsn1OCSPDReplyTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPDReply)},
...
const SecAsn1Template kSecAsn1OCSPDRepliesTemplate[] = {
    {SEC_ASN1_SEQUENCE, 0, NULL, sizeof(SecAsn1OCSPReplies)},
    {SEC_ASN1_INTEGER, offsetof(SecAsn1OCSPReplies, version)},
    {SEC_ASN1_SEQUENCE_OF, offsetof(SecAsn1OCSPReplies, replies), kSecAsn1OCSPDReplyTemplate},
    {0}};
