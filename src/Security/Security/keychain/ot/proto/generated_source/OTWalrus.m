...
BOOL OTWalrusReadFrom(__unsafe_unretained OTWalrus *self, __unsafe_unretained PBDataReader *reader) {
...
{
    return OTWalrusReadFrom(self, reader);
}
...
{
    OTWalrus *copy = [[[self class] allocWithZone:zone] init];
    if (self->_has.enabled)
    {
...
{
    OTWalrus *other = (OTWalrus *)object;
