...
/*
 ...
 is the set of elements in B, but not in A. The relative complement of A in B is denoted B âˆ– A according to the ISO 31-11 standard
 sometimes written B âˆ’ A
