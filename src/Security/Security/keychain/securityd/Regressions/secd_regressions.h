...
ONE_TEST(secd_39_sosdictionaryupdate)
...
DISABLED_ONE_TEST(secd_52_account_changed)
...
ONE_TEST(secd_232_sos_compatibility_mode)
#endif
...
ONE_TEST(secd_90_sos_circle_legacy_test)
