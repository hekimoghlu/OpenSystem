...
static void tests(void)
{
    ...
    // fix this as if the timed event had triggered in handleUpdateCircles
    bool fixedIdentities = [alice_account.trust fixICloudIdentities:alice_account circle:alice_account.trust.trustedCircle];
    ok(fixedIdentities, "failed to fix icloud identity");
