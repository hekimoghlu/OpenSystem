 ...
 */
/*
 * ntlmBlobPriv.h - Private routines used by NtlmGenerator module. 
 */
 ...
 */
#define NTLM_ERR_PARSE_ERR			errSecParam
...
OSStatus ntlmDesCrypt(
	...
	unsigned char *outData);			// DES_BLOCK_SIZE bytes
