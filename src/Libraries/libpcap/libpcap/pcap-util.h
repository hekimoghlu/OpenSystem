...
/*
 * Set inteface in a mode that prevent input packet to make it up the stack
 */
#define HAS_PCAP_DIVERT_INPUT 1

SPI_AVAILABLE(macos(15.0), ios(15.0), tvos(15.0), watchos(11.0), bridgeos(9.0))
extern int pcap_get_divert_input(pcap_t *, int *);
