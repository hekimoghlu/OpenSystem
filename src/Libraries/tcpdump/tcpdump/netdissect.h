...
#ifdef __APPLE__
#define PT_IPERF	21	/* iperf-2 UDP */
#define PT_IPERF3	22	/* iperf-3 UDP */
#define PT_IPERF3_64	23	/* iperf-3 UDP with 64 bit packet ID */
#define PT_SUTTP	24	/* Simple UDP throughput test protocol */
#endif /* __APPLE__ */
...
#ifdef __APPLE__
extern void pktap_if_print(struct netdissect_options *,
                            const struct pcap_pkthdr *,
                            const u_char *);
extern void pcapng_print(struct netdissect_options *,
                            const struct pcap_pkthdr *,
                            const u_char *);
#endif /* __APPLE__ */
