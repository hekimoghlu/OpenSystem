...
static bool
log_get_total_iter(struct statistic *s, void *ptr)
{
...
static bool
log_print_header_iter(struct statistic *s, void *ptr)
{
...
static bool
log_print_cell(struct statistic *s, void *ptr)
{
...
static bool
log_print_globalstats(char *s, void *ptr)
{
	printf("%s\n", s);
	return true;
}
...
void
top_logging_loop_body(void *tinst, bool with_sleep)
{
	top_insert(tinst);
	log_print_all(tinst);
	fflush(stdout);
