...
static bool
pstate_insert_cell(struct statistic *s, const void *sample)
{
...
struct statistic *
top_pstate_create(WINDOW *parent, const char *name)
{
	return create_statistic(STATISTIC_PSTATE, parent, NULL, &callbacks, name);
}
