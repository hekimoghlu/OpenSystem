...
static const DateIntervalFormatTestItem testItems[] = {
    ...
    { "ja",    "MMMd",      CAP_NONE,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 1.0*_DAY,   u"9æœˆ27æ—¥ï½ž28æ—¥" },

    { "cs",    "MMMEd",     CAP_NONE,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"po 27.\u202F9.\u2009\u2013\u2009pÃ¡ 26.\u202F11." },
    { "cs",    "yMMMM",     CAP_NONE,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"zÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs",    "yMMMM",     CAP_NONE,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 1.0*_DAY,   u"zÃ¡Å™Ã­ 2010" },
#if !UCONFIG_NO_BREAK_ITERATION
    { "cs",    "MMMEd",     CAP_BEGIN, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"Po 27.\u202F9.\u2009\u2013\u2009pÃ¡ 26.\u202F11." },
    { "cs",    "yMMMM",     CAP_BEGIN, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"ZÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs",    "yMMMM",     CAP_BEGIN, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 1.0*_DAY,   u"ZÃ¡Å™Ã­ 2010" },
    { "cs",    "MMMEd",     CAP_LIST,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"Po 27.\u202F9.\u2009\u2013\u2009pÃ¡ 26.\u202F11." },
    { "cs",    "yMMMM",     CAP_LIST,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"ZÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs",    "yMMMM",     CAP_LIST,  MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 1.0*_DAY,   u"ZÃ¡Å™Ã­ 2010" },
    { "cs",    "MMMEd",     CAP_ALONE, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"po 27.\u202F9.\u2009\u2013\u2009pÃ¡ 26.\u202F11." },
#endif
    { "cs",    "yMMMM",     CAP_ALONE, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 60.0*_DAY,  u"zÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs",    "yMMMM",     CAP_ALONE, MIN_NONE,   tzUSPacific, Date201009270800,              Date201009270800 + 1.0*_DAY,   u"zÃ¡Å™Ã­ 2010" },
    ...
    // rdar://72744707
    { "hi@calendar=japanese", "yMMMEd", CAP_NONE, MIN_NONE, tzUSPacific, Date201009270800,     Date201009270800 + 31.0*_DAY,  u"\u0938\u094B\u092E, 27 \u0938\u093F\u0924\u0970 \u2013 \u0917\u0941\u0930\u0941, 28 \u0905\u0915\u094D\u0924\u0942\u0970 22 \u0939\u0947\u0907\u0938\u0947\u0907" }, // "à¤¸à¥‹à¤®, 27 à¤¸à¤¿à¤¤à¥° \u2013 à¤—à¥à¤°à¥, 28 à¤…à¤•à¥à¤¤à¥‚à¥° 22 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡"
    { "hi@calendar=japanese", "yMMMEd", CAP_NONE, MIN_NONE, tzUSPacific, Date201009270800,     Date201009270800 + 410.0*_DAY, u"\u0938\u094B\u092E, 27 \u0938\u093F\u0924\u0970 22 \u2013 \u0936\u0941\u0915\u094D\u0930, 11 \u0928\u0935\u0970 23 \u0939\u0947\u0907\u0938\u0947\u0907" }, // "à¤¸à¥‹à¤®, 27 à¤¸à¤¿à¤¤à¥° 22 \u2013 à¤¶à¥à¤•à¥à¤°, 11 à¤¨à¤µà¥° 23 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡"
    ...
    { "ru",    "yMd",       CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201103021030,      Date201712300900,              u"02.03.2011â€”30.12.2017" },
    { "ru",    "yMMMMd",    CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201103021030,      Date201712300900,              u"2 Ð¼Ð°Ñ€Ñ‚Ð° 2011â€‰â€”â€‰30 Ð´ÐµÐºÐ°Ð±Ñ€Ñ 2017â€¯Ð³." },
    { "ru",    "yMEd",      CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201103021030,      Date201712300900,              u"Ð¡Ñ€, 02.03.2011â€‰â€”â€‰Ð¡Ð±, 30.12.2017" },
    { "ru",    "GyMd",      CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201103021030,      Date201712300900,              u"02.03.2011â€”30.12.2017 Ð½. Ñ." },
    ...
    { "ru",    "MMMMd",     CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201806071700,      Date201806151700,              u"7â€”15 Ð¸ÑŽÐ½Ñ" },
    { "ru",    "yMMMMd",    CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201806071700,      Date201807131700,              u"7 Ð¸ÑŽÐ½Ñâ€‰â€”â€‰13 Ð¸ÑŽÐ»Ñ 2018â€¯Ð³." },
    { "ru",    "yMMMd",     CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201712291600,      Date201802271600,              u"29 Ð´ÐµÐº. 2017â€‰â€”â€‰27 Ñ„ÐµÐ²Ñ€. 2018â€¯Ð³." },
    { "ru",    "yMMM",      CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date201509011700,      Date201510011700,              u"ÑÐµÐ½Ñ‚.â€‰â€”â€‰Ð¾ÐºÑ‚. 2015â€¯Ð³." },
    { "ru",    "HHmmMMMdE", CAP_NONE,  MIN_NONE,   tzAmericaLosAngeles, Date202307180940,      Date202307201040,              u"Ð’Ñ‚, 18 Ð¸ÑŽÐ»Ñ, 09:40â€‰â€”â€‰Ð§Ñ‚, 20 Ð¸ÑŽÐ»Ñ, 10:40"}, // rdar://51847194 + rdar://103558581
...
static const DateIntervalFormatTestItem testItems[] = {
    ...
    { "ja", "MMMd",     CAP_NONE,  tzUSPacific, Date201009270800, Date201009270800 + 1.0*_DAY,   u"9æœˆ27æ—¥ï½ž28æ—¥" },
    { "cs", "MMMEd",    CAP_NONE,  tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"po 27. 9.\u2009\u2013\u2009pÃ¡ 26. 11." },
    { "cs", "yMMMM",    CAP_NONE,  tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"zÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs", "yMMMM",    CAP_NONE,  tzUSPacific, Date201009270800, Date201009270800 + 1.0*_DAY,   u"zÃ¡Å™Ã­ 2010" },
#if !UCONFIG_NO_BREAK_ITERATION
    { "cs", "MMMEd",    CAP_BEGIN, tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"Po 27. 9.\u2009\u2013\u2009pÃ¡ 26. 11." },
    { "cs", "yMMMM",    CAP_BEGIN, tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"ZÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs", "yMMMM",    CAP_BEGIN, tzUSPacific, Date201009270800, Date201009270800 + 1.0*_DAY,   u"ZÃ¡Å™Ã­ 2010" },
    { "cs", "MMMEd",    CAP_LIST,  tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"Po 27. 9.\u2009\u2013\u2009pÃ¡ 26. 11." },
    { "cs", "yMMMM",    CAP_LIST,  tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"ZÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs", "yMMMM",    CAP_LIST,  tzUSPacific, Date201009270800, Date201009270800 + 1.0*_DAY,   u"ZÃ¡Å™Ã­ 2010" },
    { "cs", "MMMEd",    CAP_ALONE, tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"po 27. 9.\u2009\u2013\u2009pÃ¡ 26. 11." },
#endif
    { "cs", "yMMMM",    CAP_ALONE, tzUSPacific, Date201009270800, Date201009270800 + 60.0*_DAY,  u"zÃ¡Å™Ã­\u2013listopad 2010" },
    { "cs", "yMMMM",    CAP_ALONE, tzUSPacific, Date201009270800, Date201009270800 + 1.0*_DAY,   u"zÃ¡Å™Ã­ 2010" },
...
static void TestFormatToResult(void) {
...

    {
        ...
        const UChar* expectedString = u"27. September 2010 um 15:00\u2009\u2013\u20092. MÃ¤rz 2011 um 18:30";
    ...
    }
    {
        ...
        const UChar* expectedString = u"27. September 2010, 15:00â€“22:00 Uhr";
