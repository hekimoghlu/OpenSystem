...
static void TestDisplayKeywordValues(void){
    ...
    static const struct {
        ...
        { "@calendar=islamic",	"ar", u"Ø§Ù„ØªÙ‚ÙˆÙŠÙ… Ø§Ù„Ù‡Ø¬Ø±ÙŠ" },
        { "@calendar=islamic",	"ru", u"ÐºÐ°Ð»ÐµÐ½Ð´Ð°Ñ€ÑŒ Ð¥Ð¸Ð´Ð¶Ñ€Ð°" },        
        #endif  // APPLE_ICU_CHANGES
    };
    for(i = 0; i < UPRV_LENGTHOF(testCases); i++) {
        UErrorCode status = U_ZERO_ERROR;
...
// TODO(rtg): This is a new test in OSICU 76, but from reading the commentary in the original ticket
// and in the PR, it's not clear why "aaaa" should maximize to "aaaa" and not to "en_aaaa_US".  My understanding
// is that if all we have is a single alpha-4 subtag, it should get interpreted as the SCRIPT code (IOW,
// "aaaa" is semantically equivalent to "und_aaaa") and we should maximize based on that.  The difference
// might be that we have to check to see whether "aaaa" is a VALID script code before treating it as such,
// but I don't see where Frank's change for this issue does anything like that.  Need to research this more...
      "en_aaaa_US",
#else
      "aaaa",
#endif // APPLE_ICU_CHANGES
...
// rdar://68351139 change names for region IO per GA, Legal, ET
	...
	{ "mic",                    TEST_ULDN_LOCALE, u"Miâ€™kmaw" }, // rdar://104877633 && rdar://113369993
    ...
    { "sjd",                    TEST_ULDN_LOCALE, u"Kildin SÃ¡mi" }, // rdar://117588343
    { "sje",                    TEST_ULDN_LOCALE, u"Pite SÃ¡mi" }, // rdar://117588343
    { "sju",                    TEST_ULDN_LOCALE, u"Ume SÃ¡mi" }, // rdar://117588343
	...
	{ "bla",                    TEST_ULOC_LOCALE, u"SiksikÃ¡" },
    ...
    // tests for rdar://123787001 (China regulatory regions include "Root" for locale identifier display names when only requesting region)
    // (compare with values under en_StdMidPrc[] below)
    { "_MX",                    TEST_ULDN_LOCALE, u"Mexico" },
    { "_CN",                    TEST_ULDN_LOCALE, u"China mainland" },
    { "_MO",                    TEST_ULDN_LOCALE, u"Macao" },
...
static const UldnItem en_StdMidVrnt[] = {
    ...
    // rdar://108460253 - Update variant name for 'ii' to "Sichuan Yi; Nuosuâ€
...
static const UldnItem en_StdMidPrc[] = {
    ...
    // tests for rdar://123787001 (China regulatory regions include "Root" for locale identifier display names when only requesting region)
    { "_MX",                    TEST_ULDN_LOCALE, u"Mexico" },
    { "_CN",                    TEST_ULDN_LOCALE, u"China" },
    { "_MO",                    TEST_ULDN_LOCALE, u"Macao (China)" },
};
...
static const UldnItem fr_StdMidLong[] = {
	{ "en_US",                  TEST_ULDN_LOCALE, u"anglais (Ã‰.-U.)" },
	{ "US",                     TEST_ULDN_REGION, u"Ã‰tats-Unis" },
	{ "HK",                     TEST_ULDN_REGION, u"Hong Kong" },
	{ "MO",                     TEST_ULDN_REGION, u"Macao" },
	...
	{ "crj",                    TEST_ULDN_LOCALE, u"cri de lâ€™Est (dialecte du Sud)" }, // other sub-lang
	{ "csw",                    TEST_ULDN_LOCALE, u"cri des marais" }, // other sub-lang
	{ "hai",                    TEST_ULDN_LOCALE, u"haÃ¯da" }, // macrolang
	{ "hdn",                    TEST_ULDN_LOCALE, u"haÃ¯da du Nord" }, // distinct name for primary sub-lang
	{ "hax",                    TEST_ULDN_LOCALE, u"haÃ¯da du Sud" }, // other sub-lang
	{ "iu",                     TEST_ULDN_LOCALE, u"inuktitut" }, // macrolang
	{ "ike",                    TEST_ULDN_LOCALE, u"inuktitut de lâ€™Est canadien" }, // distinct name for primary sub-lang
	{ "ikt",                    TEST_ULDN_LOCALE, u"inuktitut de lâ€™Ouest canadien" }, // other sub-lang
	{ "oj",                     TEST_ULDN_LOCALE, u"ojibwa" }, // macrolang
	{ "ojg",                    TEST_ULDN_LOCALE, u"ojibwa de l'Est" }, // distinct name for primary sub-lang
	{ "ojb",                    TEST_ULDN_LOCALE, u"ojibwÃ© du Nord-Ouest" }, // other sub-lang
...
static const UldnItem fr_StdLstLong[] = {
    ...
    { "Hans",                   TEST_ULDN_SCRIPT, u"sinogrammes simplifiÃ©s" },      // rdar://70285470
    { "Hant",                   TEST_ULDN_SCRIPT, u"sinogrammes traditionnels" }    // rdar://70285470
};

static const UldnItem fr_DiaMidLong[] = {
	{ "en_US",                  TEST_ULDN_LOCALE, u"anglais amÃ©ricain" },
};
...
static const UldnItem ca_StdLstLong[] = {
    ...
    { "az",                     TEST_ULDN_LANGUAGE, u"Ã zeri" },                // rdar://107286939
};
...
static const UldnItem ru_StdMidLong[] = {
	{ "cic",                    TEST_ULDN_LOCALE, u"Ñ‡Ð¸ÐºÐ°ÑÐ¾" },
	{ "cic_Latn",               TEST_ULDN_LOCALE, u"Ñ‡Ð¸ÐºÐ°ÑÐ¾" },
};

static const UldnItem ur_StdMidLong[] = {
	{ "ps_Arab",                TEST_ULDN_LOCALE, u"Ù¾Ø´ØªÙˆ (Ø¹Ø±Ø¨ÛŒ)" },
	{ "ps_Arab_AF",             TEST_ULDN_LOCALE, u"Ù¾Ø´ØªÙˆ (Ø¹Ø±Ø¨ÛŒØŒØ§ÙØºØ§Ù†Ø³ØªØ§Ù†)" },
	{ "ur_Aran",                TEST_ULDN_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚)" }, // rdar://47494884
	{ "ur_Arab",                TEST_ULDN_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³Ø®)" }, // rdar://50687287
	{ "ur_Aran_PK",             TEST_ULDN_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚ØŒÙ¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://47494884
	{ "ur_Arab_PK",             TEST_ULDN_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³Ø®ØŒÙ¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://50687287

	{ "ps_Arab",                TEST_ULOC_LOCALE, u"Ù¾Ø´ØªÙˆ (Ø¹Ø±Ø¨ÛŒ)" },
	{ "ps_Arab_AF",             TEST_ULOC_LOCALE, u"Ù¾Ø´ØªÙˆ (Ø¹Ø±Ø¨ÛŒØŒØ§ÙØºØ§Ù†Ø³ØªØ§Ù†)" },
	{ "ur_Aran",                TEST_ULOC_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚)" },     // rdar://47494884
	{ "ur_Arab",                TEST_ULOC_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³Ø®)" },         // rdar://51418203
	{ "ur_Aran_PK",             TEST_ULOC_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚ØŒÙ¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://47494884
	{ "ur_Arab_PK",             TEST_ULOC_LOCALE, u"Ø§Ø±Ø¯Ùˆ (Ù†Ø³Ø®ØŒÙ¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://51418203
};

static const UldnItem pa_Arab_StdMidLong[] = {
	{ "pa_Aran",                TEST_ULDN_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚)" }, // rdar://47494884
	{ "pa_Arab",                TEST_ULDN_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³Ø®)" }, // rdar://50687287
	{ "pa_Aran_PK",             TEST_ULDN_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚, Ù¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://47494884
	{ "pa_Arab_PK",             TEST_ULDN_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³Ø®, Ù¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://50687287

	{ "pa_Aran",                TEST_ULOC_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚)" },      // rdar://51418203
	{ "pa_Arab",                TEST_ULOC_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³Ø®)" },          // rdar://51418203
	{ "pa_Aran_PK",             TEST_ULOC_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³ØªØ¹Ù„ÛŒÙ‚, Ù¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://51418203
	{ "pa_Arab_PK",             TEST_ULOC_LOCALE, u"Ù¾Ù†Ø¬Ø§Ø¨ÛŒ (Ù†Ø³Ø®, Ù¾Ø§Ú©Ø³ØªØ§Ù†)" }, // rdar://51418203
};

static const UldnItem zh_StdMidLong[] = {
	{ "zh_Hans",                TEST_ULDN_LOCALE, u"ç®€ä½“ä¸­æ–‡" },           // rdar://50750364
	{ "zh_Hans_CN",             TEST_ULDN_LOCALE, u"ç®€ä½“ä¸­æ–‡ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://50750364
	{ "zh_Hant",                TEST_ULDN_LOCALE, u"ç¹ä½“ä¸­æ–‡" },           // rdar://50750364
	{ "zh_Hant_HK",             TEST_ULDN_LOCALE, u"ç¹ä½“ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://50750364
	{ "yue_Hans",               TEST_ULDN_LOCALE, u"ç®€ä½“ç²¤è¯­" },           // rdar://50750364
	{ "yue_Hans_CN",            TEST_ULDN_LOCALE, u"ç®€ä½“ç²¤è¯­ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://50750364
	{ "yue_Hant",               TEST_ULDN_LOCALE, u"ç¹ä½“ç²¤è¯­" },           // rdar://50750364
	{ "yue_Hant_HK",            TEST_ULDN_LOCALE, u"ç¹ä½“ç²¤è¯­ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://50750364
	{ "ps_Arab",                TEST_ULDN_LOCALE, u"æ™®ä»€å›¾è¯­ï¼ˆé˜¿æ‹‰ä¼¯æ–‡ï¼‰" },
	{ "ps_Arab_AF",             TEST_ULDN_LOCALE, u"æ™®ä»€å›¾è¯­ï¼ˆé˜¿æ‹‰ä¼¯æ–‡ï¼Œé˜¿å¯Œæ±—ï¼‰" },
	{ "ur_Aran",                TEST_ULDN_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆæ³¢æ–¯ä½“ï¼‰" }, // rdar://47494884
	{ "ur_Arab",                TEST_ULDN_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆèªŠæŠ„ä½“ï¼‰" }, // rdar://50687287
	{ "ur_Aran_PK",             TEST_ULDN_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆæ³¢æ–¯ä½“ï¼Œå·´åŸºæ–¯å¦ï¼‰" }, // rdar://47494884
	{ "ur_Arab_PK",             TEST_ULDN_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆèªŠæŠ„ä½“ï¼Œå·´åŸºæ–¯å¦ï¼‰" }, // rdar://50687287

	{ "zh_Hans",                TEST_ULOC_LOCALE, u"ç®€ä½“ä¸­æ–‡" },           // rdar://51418203
	{ "zh_Hans_CN",             TEST_ULOC_LOCALE, u"ç®€ä½“ä¸­æ–‡ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://51418203
	{ "zh_Hant",                TEST_ULOC_LOCALE, u"ç¹ä½“ä¸­æ–‡" },           // rdar://51418203
	{ "zh_Hant_HK",             TEST_ULOC_LOCALE, u"ç¹ä½“ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://51418203
	{ "yue_Hans",               TEST_ULOC_LOCALE, u"ç®€ä½“ç²¤è¯­" },           // rdar://51418203
	{ "yue_Hans_CN",            TEST_ULOC_LOCALE, u"ç®€ä½“ç²¤è¯­ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://51418203
	{ "yue_Hant",               TEST_ULOC_LOCALE, u"ç¹ä½“ç²¤è¯­" },           // rdar://51418203
	{ "yue_Hant_HK",            TEST_ULOC_LOCALE, u"ç¹ä½“ç²¤è¯­ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://51418203
	{ "ur_Aran",                TEST_ULOC_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆæ³¢æ–¯ä½“ï¼‰" }, // rdar://47494884
	{ "ur_Arab",                TEST_ULOC_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆèªŠæŠ„ä½“ï¼‰" }, // rdar://51418203
	{ "ur_Aran_PK",             TEST_ULOC_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆæ³¢æ–¯ä½“ï¼Œå·´åŸºæ–¯å¦ï¼‰" }, // rdar://47494884
	{ "ur_Arab_PK",             TEST_ULOC_LOCALE, u"ä¹Œå°”éƒ½è¯­ï¼ˆèªŠæŠ„ä½“ï¼Œå·´åŸºæ–¯å¦ï¼‰" }, // rdar://51418203

	{ "HK",                     TEST_ULDN_REGION, u"é¦™æ¸¯" },
	{ "MO",                     TEST_ULDN_REGION, u"æ¾³é—¨" },
    
    { "ars",                    TEST_ULDN_LANGUAGE, u"é˜¿æ‹‰ä¼¯è¯­ï¼ˆå†…å¿—ï¼‰" },  // rdar://69728925
	{ "ii",                     TEST_ULDN_LANGUAGE, u"å‡‰å±±å½è¯­" },  // rdar://107440844,rdar://108460253
    { "pqm",                    TEST_ULDN_LANGUAGE, u"æ²ƒæ‹‰æ–¯æ‰˜åŸºè¯­" }, // rdar://107600615
    { "se",                     TEST_ULDN_LANGUAGE, u"åŒ—è¨ç±³è¯­" }, // rdar://117588343
	...
	{ "rhg",                    TEST_ULOC_LOCALE, u"ç½—å…´äºšè¯­" },
	{ "Adlm",                   TEST_ULDN_SCRIPT, u"é˜¿å¾·æ‹‰å§†æ–‡" },
	{ "Rohg",                   TEST_ULDN_SCRIPT, u"å“ˆä¹ƒæ–æ–‡" },
	{ "Syrc",                   TEST_ULDN_SCRIPT, u"å™åˆ©äºšæ–‡" },
	{ "apw",                    TEST_ULOC_LOCALE, u"é˜¿å¸•å¥‡è¯­ï¼ˆè¥¿æ–¹ï¼‰" },
	{ "guc",                    TEST_ULOC_LOCALE, u"ç“¦å°¤è¯­" },
	{ "nnp",                    TEST_ULOC_LOCALE, u"ä¸‡ç§‹è¯­" }, // rdar://108037783
	{ "Wcho",                   TEST_ULDN_SCRIPT, u"ä¸‡ç§‹æ–‡" }, // rdar://108037783
    
    // tests for rdar://125648144
    { "blo",                   TEST_ULDN_LANGUAGE, u"é˜¿å°¼è¯­" },
    { "kxv",                   TEST_ULDN_LANGUAGE, u"åº“ç»´è¯­" },
    { "vmw",                   TEST_ULDN_LANGUAGE, u"é©¬åº“é˜¿è¯­" },
    { "xnr",                   TEST_ULDN_LANGUAGE, u"åº·æ ¼é‡Œè¯­" }, 
};
...
static const UldnItem zh_Hant_StdMidLong[] = {
    ...
    { "ars",                    TEST_ULDN_LANGUAGE, u"é˜¿æ‹‰ä¼¯æ–‡ï¼ˆå…§å¿—ï¼‰" },  // rdar://69728925
	{ "apw",                    TEST_ULOC_LOCALE, u"é˜¿å¸•åˆ‡æ–‡ï¼ˆè¥¿éƒ¨ï¼‰" }, // rdar://89394823, rdar://91073737 #298 Add/update more localized names for apw, Western Apache
};
...
static const UldnItem yue_StdMidLong[] = {
	{ "HK",                     TEST_ULDN_REGION, u"é¦™æ¸¯" },
	{ "MO",                     TEST_ULDN_REGION, u"æ¾³é–€" },
	{ "ii",                     TEST_ULDN_LANGUAGE, u"æ¶¼å±±å½æ–‡" },  // rdar://107440844,rdar://108460253
    { "pqm",                    TEST_ULDN_LANGUAGE, u"æ²ƒæ‹‰æ–¯æ‰˜åŸºè¯­" }, // rdar://107600615
};

static const UldnItem yue_Hans_StdMidLong[] = {
	{ "zh_Hans_CN",             TEST_ULOC_LOCALE, u"ç®€ä½“ä¸­æ–‡ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://53136228
	{ "zh_Hant_HK",             TEST_ULOC_LOCALE, u"ç¹ä½“ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://53136228
	{ "yue_Hans_CN",            TEST_ULOC_LOCALE, u"ç®€ä½“ç²¤è¯­ï¼ˆä¸­å›½å¤§é™†ï¼‰" }, // rdar://53136228
	{ "yue_Hant_HK",            TEST_ULOC_LOCALE, u"ç¹ä½“ç²¤è¯­ï¼ˆé¦™æ¸¯ï¼‰" },    // rdar://53136228
	{ "HK",                     TEST_ULDN_REGION, u"é¦™æ¸¯" },
	{ "MO",                     TEST_ULDN_REGION, u"æ¾³é—¨" },
	{ "apw",                    TEST_ULOC_LOCALE, u"é˜¿å¸•å¥‡è¯­ï¼ˆè¥¿æ–¹ï¼‰" }, // rdar://89394823, rdar://91073737 #298 Add/update more localized names for apw, Western Apache
};

static const UldnItem nds_StdMidLong[] = { // rdar://64703717
	{ "nds",                   TEST_ULOC_LOCALE, u"Neddersassâ€™sch" },
};

static const UldnItem hi_StdMidLong[] = { // rdar://53653337
	{ "Aran",                   TEST_ULDN_SCRIPT, u"à¤¨à¤¸à¥à¤¤à¤¾à¤²à¥€à¤•à¤¼" },
	// tests for rdar://75064267, rdar://89394823, rdar://59762233, rdar://91073737 #298 Add/update more localized names for apw, Western Apache
	{ "rhg",                    TEST_ULOC_LOCALE, u"à¤°à¥‹à¤¹à¤¿à¤‚à¤—à¥à¤¯à¤¾" },
	{ "Adlm",                   TEST_ULDN_SCRIPT, u"à¤à¤¡à¤²à¤®" },
	{ "Rohg",                   TEST_ULDN_SCRIPT, u"à¤¹à¤¨à¤¿à¤«à¤¼à¤¿" },
	{ "Syrc",                   TEST_ULDN_SCRIPT, u"à¤¸à¤¿à¤°à¤¿à¤à¤•" },
	{ "apw",                    TEST_ULOC_LOCALE, u"à¤…à¤ªà¤¾à¤šà¥€, à¤ªà¤¶à¥à¤šà¤¿à¤®à¥€" },
	{ "guc",                    TEST_ULOC_LOCALE, u"à¤µà¤¾à¤¯à¥" },
    { "smj",                    TEST_ULOC_LOCALE, u"à¤²à¥‚à¤²à¥‡ à¤¸à¤¾à¤®à¥€" }, // rdar://117588343
	{ "JM",                     TEST_ULDN_REGION, u"à¤œà¤®à¥ˆà¤•à¤¾"}, // rdar://52174281, which supersedes rdar://16850007
};
...
static const UldnItem mni_Beng_StdMidLong[] = { // rdar://54153189
	{ "mni_Beng",               TEST_ULDN_LOCALE, u"à¦®à§ˆà¦¤à§ˆà¦²à§‹à¦¨à§ (à¦¬à¦¾à¦‚à¦²à¦¾)" },
	{ "mni_Mtei",               TEST_ULDN_LOCALE, u"à¦®à§ˆà¦¤à§ˆà¦²à§‹à¦¨à§ (à¦®à§€à¦¤à§ˆ à¦®à¦¯à¦¼à§‡à¦•)" },
};

static const UldnItem mni_Mtei_StdMidLong[] = { // rdar://54153189
	{ "mni_Beng",               TEST_ULDN_LOCALE, u"ê¯ƒê¯¤ê¯‡ê¯©ê¯‚ê¯£ê¯Ÿ (ê¯•ê¯ªê¯‚ê¯¥)" },
	{ "mni_Mtei",               TEST_ULDN_LOCALE, u"ê¯ƒê¯¤ê¯‡ê¯©ê¯‚ê¯£ê¯Ÿ (ê¯ƒê¯¤ê¯‡ê¯© ê¯ƒê¯Œê¯¦ê¯›)" },
};

static const UldnItem sat_Olck_StdMidLong[] = { // rdar://54153189
	{ "sat_Olck",               TEST_ULDN_LOCALE, u"á±¥á±Ÿá±±á±›á±Ÿá±²á±¤ (á±šá±ž á±ªá±¤á± á±¤)" },
	{ "sat_Deva",               TEST_ULDN_LOCALE, u"á±¥á±Ÿá±±á±›á±Ÿá±²á±¤ (á±«á±®á±£á±Ÿá±±á±Ÿá±œá±Ÿá±¨á±¤)" },
};

static const UldnItem sat_Deva_StdMidLong[] = { // rdar://54153189
	{ "sat_Olck",               TEST_ULDN_LOCALE, u"à¤¸à¤¾à¤¨à¤¤à¤¾à¤¡à¤¼à¥€ (à¤…à¤² à¤šà¥€à¤•à¥€)" },
	{ "sat_Deva",               TEST_ULDN_LOCALE, u"à¤¸à¤¾à¤¨à¤¤à¤¾à¤¡à¤¼à¥€ (à¤¦à¥‡à¤µà¤¾à¤¨à¤¾à¤—à¤¾à¤°à¥€)" },
};
...
static const UldnItem es_MX_StdBegLong[] = { // rdar://69835367
    { "019",                TEST_ULDN_REGION, u"AmÃ©rica" },
    { "002",                TEST_ULDN_REGION, u"Ãfrica" },
    { "150",                TEST_ULDN_REGION, u"Europa" },
    { "142",                TEST_ULDN_REGION, u"Asia" },
    { "009",                TEST_ULDN_REGION, u"OceanÃ­a" },
	{ "HK",                 TEST_ULDN_REGION, u"Hong-Kong" },
	{ "MO",                 TEST_ULDN_REGION, u"Macao" },
	{ "guc",                TEST_ULDN_LANGUAGE, u"WayÃº" }, // rdar://59762233
};
...
static const UldnItem ain_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "ain",                TEST_ULOC_LOCALE, u"ã‚¢ã‚¤ãƒŒãƒ»ã‚¤ã‚¿ã‡°" },
};

static const UldnItem am_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "am",                 TEST_ULOC_LOCALE, u"áŠ áˆ›áˆ­áŠ›" },
};

static const UldnItem ff_Adlm_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "ff_Adlm",            TEST_ULOC_LOCALE, u"ðž¤†ðž¤µðž¤¤ðž¤¢ðž¤ª (ðž¤€ðž¤ðž¤‚ðž¤¢ðž¤ƒ)" },
};
...
static const UldnItem kk_StdMidLong[] = { // rdar://95015661
    { "AT",                 TEST_ULDN_REGION,   u"ÐÑƒÑÑ‚Ñ€Ð¸Ñ" },
    { "AU",                 TEST_ULDN_REGION,   u"ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ" },
    { "053",                TEST_ULDN_REGION,   u"ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð°Ð·Ð¸Ñ" },
    { "de_AT",              TEST_ULOC_LOCALE,   u"Ð½ÐµÐ¼Ñ–Ñ Ñ‚Ñ–Ð»Ñ– (ÐÑƒÑÑ‚Ñ€Ð¸Ñ)" },
    { "en_AU",              TEST_ULOC_LOCALE,   u"Ð°Ò“Ñ‹Ð»ÑˆÑ‹Ð½ Ñ‚Ñ–Ð»Ñ– (ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ)" },
	{ "cic",                TEST_ULDN_LOCALE,   u"Ñ‡Ð¸ÐºÐ°ÑÐ¾ Ñ‚Ñ–Ð»Ñ–" }, // rdar://102511347 Incorrect character case for language names in dictionary settings; some tests for 'cic'
    // rdar://95777359
    { "yue_Hans",           TEST_ULOC_LOCALE, u"ÐºÐ°Ð½Ñ‚Ð¾Ð½ Ñ‚Ñ–Ð»Ñ– (Ð¶ÐµÒ£Ñ–Ð»Ð´ÐµÑ‚Ñ–Ð»Ð³ÐµÐ½ Ð¶Ð°Ð·Ñƒ)" },
    { "yue_Hant",           TEST_ULOC_LOCALE, u"ÐºÐ°Ð½Ñ‚Ð¾Ð½ Ñ‚Ñ–Ð»Ñ– (Ð´Ó™ÑÑ‚Ò¯Ñ€Ð»Ñ– Ð¶Ð°Ð·Ñƒ)" },
    { "Hans",               TEST_ULDN_SCRIPT, u"Ð¶ÐµÒ£Ñ–Ð»Ð´ÐµÑ‚Ñ–Ð»Ð³ÐµÐ½ Ò›Ñ‹Ñ‚Ð°Ð¹ Ð¸ÐµÑ€Ð¾Ð³Ð»Ð¸Ñ„Ñ‹" },
    { "Hant",               TEST_ULDN_SCRIPT, u"Ð´Ó™ÑÑ‚Ò¯Ñ€Ð»Ñ– Ò›Ñ‹Ñ‚Ð°Ð¹ Ð¸ÐµÑ€Ð¾Ð³Ð»Ð¸Ñ„Ñ‹" },
    { "en_ZA",              TEST_ULOC_LOCALE, u"Ð°Ò“Ñ‹Ð»ÑˆÑ‹Ð½ Ñ‚Ñ–Ð»Ñ– (ÐžÒ£Ñ‚Ò¯ÑÑ‚Ñ–Ðº ÐÑ„Ñ€Ð¸ÐºÐ°)" },
};

static const UldnItem kk_DiaMidLong[] = { // rdar://95015661
    { "de_AT",              TEST_ULDN_LOCALE,   u"Ð°ÑƒÑÑ‚Ñ€Ð¸ÑÐ»Ñ‹Ò› Ð½ÐµÐ¼Ñ–Ñ Ñ‚Ñ–Ð»Ñ–" },
    { "en_AU",              TEST_ULDN_LOCALE,   u"Ð°ÑƒÑÑ‚Ñ€Ð°Ð»Ð¸ÑÐ»Ñ‹Ò› Ð°Ò“Ñ‹Ð»ÑˆÑ‹Ð½ Ñ‚Ñ–Ð»Ñ–" },
};

static const UldnItem nv_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "nv",                 TEST_ULOC_LOCALE, u"DinÃ© Bizaad" },
};

static const UldnItem rhg_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "rhg",                TEST_ULOC_LOCALE, u"ð´Œð´—ð´¥ð´ð´™ð´šð´’ð´™ð´" },
};

static const UldnItem syr_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "syr",                TEST_ULOC_LOCALE, u"Ü£Ü˜ÜªÜÜÜ" },
};

static const UldnItem ti_StdMidLong[] = { // Apple <rdar:/74820154>
	{ "ti",                TEST_ULOC_LOCALE, u"á‰µáŒáˆ­áŠ›" },
};
...
static const UldnItem ar_StdMidLong[] = { // rdar://123305986 ([TextInputUI]: AB: DawnE21E212: <spelling issue> Slight different spelling for Cantonese)
    { "yue",               TEST_ULOC_LANGUAGE, u"Ø§Ù„ÙƒØ§Ù†ØªÙˆÙ†ÙŠØ©" },
    { "yue",               TEST_ULDN_LANGUAGE, u"Ø§Ù„ÙƒØ§Ù†ØªÙˆÙ†ÙŠØ©" },
};
#endif  // APPLE_ICU_CHANGES

static const UldnItem ro_StdMidLong[] = { // https://unicode-org.atlassian.net/browse/ICU-11563
	{ "mo",                     TEST_ULDN_LOCALE, u"romÃ¢nÄƒ" },
	{ "mo_MD",                  TEST_ULDN_LOCALE, u"romÃ¢nÄƒ (Republica Moldova)" },
	{ "mo",                     TEST_ULDN_LANGUAGE, u"romÃ¢nÄƒ" },
	{ "mo_MD",                  TEST_ULOC_LOCALE, u"romÃ¢nÄƒ (Republica Moldova)" },
	{ "mo",                     TEST_ULOC_LANGUAGE, u"romÃ¢nÄƒ" },
};

static const UldnItem yi_StdMidLong[] = { // https://unicode-org.atlassian.net/browse/ICU-21742
	{ "ji",                     TEST_ULDN_LOCALE, u"×™×™Ö´×“×™×©" },
#if APPLE_ICU_CHANGES
// rdar://
	{ "ji_US",                  TEST_ULDN_LOCALE, u"×™×™Ö´×“×™×© (×¤Ö¿\"×©)" },
#else
	{ "ji_US",                  TEST_ULDN_LOCALE, u"×™×™Ö´×“×™×© (×¤Ö¿×Ö·×¨××™×™× ×™×’×˜×¢ ×©×˜×Ö·×˜×Ÿ)" },
#endif  // APPLE_ICU_CHANGES
	{ "ji",                     TEST_ULDN_LANGUAGE, u"×™×™Ö´×“×™×©" },
	{ "ji_US",                  TEST_ULOC_LOCALE, u"×™×™Ö´×“×™×© (×¤Ö¿×Ö·×¨××™×™× ×™×’×˜×¢ ×©×˜×Ö·×˜×Ÿ)" },
	{ "ji",                     TEST_ULOC_LANGUAGE, u"×™×™Ö´×“×™×©" },
};

static const UldnItem zh_DiaMidLong[] = {
    // zh and zh_Hant both have dialect names for the following in ICU 73
    { "ar_001",                 TEST_ULDN_LOCALE, u"çŽ°ä»£æ ‡å‡†é˜¿æ‹‰ä¼¯è¯­" },
    { "nl_BE",                  TEST_ULDN_LOCALE, u"å¼—æ‹‰èŠ’è¯­" },
    { "ro_MD",                  TEST_ULDN_LOCALE, u"æ‘©å°”å¤šç“¦è¯­" },
    // zh has dialect names for the following in ICU 73
    { "en_AU",                  TEST_ULDN_LOCALE, u"æ¾³å¤§åˆ©äºšè‹±è¯­" },
    { "en_CA",                  TEST_ULDN_LOCALE, u"åŠ æ‹¿å¤§è‹±è¯­" },
    { "en_GB",                  TEST_ULDN_LOCALE, u"è‹±å›½è‹±è¯­" },
    { "en_US",                  TEST_ULDN_LOCALE, u"ç¾Žå›½è‹±è¯­" },
    { "es_419",                 TEST_ULDN_LOCALE, u"æ‹‰ä¸ç¾Žæ´²è¥¿ç­ç‰™è¯­" },
    { "es_ES",                  TEST_ULDN_LOCALE, u"æ¬§æ´²è¥¿ç­ç‰™è¯­" },
    { "es_MX",                  TEST_ULDN_LOCALE, u"å¢¨è¥¿å“¥è¥¿ç­ç‰™è¯­" },
    { "fr_CA",                  TEST_ULDN_LOCALE, u"åŠ æ‹¿å¤§æ³•è¯­" },
    { "fr_CH",                  TEST_ULDN_LOCALE, u"ç‘žå£«æ³•è¯­" },
};

static const UldnItem zh_Hant_DiaMidLong[] = {
    // zh and zh_Hant both have dialect names for the following in ICU 73
    { "ar_001",                 TEST_ULDN_LOCALE, u"ç¾ä»£æ¨™æº–é˜¿æ‹‰ä¼¯æ–‡" },
    { "nl_BE",                  TEST_ULDN_LOCALE, u"æ³•è˜­å¾·æ–¯æ–‡" },
    { "ro_MD",                  TEST_ULDN_LOCALE, u"æ‘©çˆ¾å¤šç“¦æ–‡" },
    // zh_Hant no dialect names for the following in ICU-73,
    // use standard name
#if APPLE_ICU_CHANGES // rdar://
    { "en_AU",                  TEST_ULDN_LOCALE, u"æ¾³æ´²è‹±æ–‡" },
    { "en_CA",                  TEST_ULDN_LOCALE, u"åŠ æ‹¿å¤§è‹±æ–‡" },
    { "en_GB",                  TEST_ULDN_LOCALE, u"è‹±å¼è‹±æ–‡" },
    { "en_US",                  TEST_ULDN_LOCALE, u"ç¾Žå¼è‹±æ–‡" },
#else
    { "en_AU",                  TEST_ULDN_LOCALE, u"è‹±æ–‡ï¼ˆæ¾³æ´²ï¼‰" },
    { "en_CA",                  TEST_ULDN_LOCALE, u"è‹±æ–‡ï¼ˆåŠ æ‹¿å¤§ï¼‰" },
    { "en_GB",                  TEST_ULDN_LOCALE, u"è‹±æ–‡ï¼ˆè‹±åœ‹ï¼‰" },
    { "en_US",                  TEST_ULDN_LOCALE, u"è‹±æ–‡ï¼ˆç¾Žåœ‹ï¼‰" },
#endif // APPLE_ICU_CHANGES
    { "es_419",                 TEST_ULDN_LOCALE, u"è¥¿ç­ç‰™æ–‡ï¼ˆæ‹‰ä¸ç¾Žæ´²ï¼‰" },
    { "es_ES",                  TEST_ULDN_LOCALE, u"è¥¿ç­ç‰™æ–‡ï¼ˆè¥¿ç­ç‰™ï¼‰" },
    { "es_MX",                  TEST_ULDN_LOCALE, u"è¥¿ç­ç‰™æ–‡ï¼ˆå¢¨è¥¿å“¥ï¼‰" },
#if APPLE_ICU_CHANGES // rdar://
    { "fr_CA",                  TEST_ULDN_LOCALE, u"åŠ æ‹¿å¤§æ³•æ–‡" },
    { "fr_CH",                  TEST_ULDN_LOCALE, u"ç‘žå£«æ³•æ–‡" },
#else
    { "fr_CA",                  TEST_ULDN_LOCALE, u"æ³•æ–‡ï¼ˆåŠ æ‹¿å¤§ï¼‰" },
    { "fr_CH",                  TEST_ULDN_LOCALE, u"æ³•æ–‡ï¼ˆç‘žå£«ï¼‰" },
#endif // APPLE_ICU_CHANGES
};
...
static const UldnItem apw_StdMidLong[] = { // rdar://89394823 rdar://94490599
	{ "apw",                TEST_ULOC_LOCALE, u"Ná¹‰ee biyÃ¡tiÊ¼" },
	{ "Latn",               TEST_ULDN_SCRIPT, u"Latin" },
	{ "apw_Latn",           TEST_ULDN_LOCALE, u"Ná¹‰ee biyÃ¡tiÊ¼" },
};

static const UldnItem ber_StdMidLong[] = { // rdar://104877633
	{ "ber",                TEST_ULOC_LOCALE, u"â´°âµŽâ´°âµ£âµ‰âµ–" },
};

static const UldnItem cic_StdMidLong[] = { // rdar://100483742 rdar://100483742
	{ "cic",                TEST_ULOC_LOCALE, u"ChikashshanompaÊ¼" },
	{ "Latn",               TEST_ULDN_SCRIPT, u"Latin" },
	{ "cic_Latn",           TEST_ULDN_LOCALE, u"ChikashshanompaÊ¼" },
};
...
static const UldnItem dz_StdMidLong[] = { // rdar://89394823
	{ "dz",                TEST_ULOC_LOCALE, u"à½¢à¾«à½¼à½„à¼‹à½à¼‹" },
};

static const UldnItem el_StdMidLong[] = { // rdar://84190308, rdar://89394823, rdar://59762233
	{ "NL",                 TEST_ULDN_REGION, u"ÎšÎ¬Ï„Ï‰ Î§ÏŽÏÎµÏ‚" },
	{ "apw",                TEST_ULOC_LOCALE, u"Î‘Ï€Î¬Ï„ÏƒÎ¹, Î”Ï…Ï„Î¹ÎºÎ¿Î¯" },
	{ "guc",                TEST_ULOC_LOCALE, u"ÎŸÏ…Î±Î³Î¿Ï" },
    { "sjd",                TEST_ULOC_LOCALE, u"ÎšÎ¯Î»Î½Ï„Î¹Î½ Î£Î¬Î¼Î¹" }, // rdar://117588343
    { "sje",                TEST_ULOC_LOCALE, u"Î Î¯Ï„Îµ Î£Î¬Î¼Î¹" }, // rdar://117588343
    { "sju",                TEST_ULOC_LOCALE, u"ÎŸÏÎ¼Îµ Î£Î¬Î¼Î¹" }, // rdar://117588343
};

static const UldnItem hmn_StdMidLong[] = { // rdar://104877633
	{ "hmn",                TEST_ULOC_LOCALE, u"ð–¬Œð–¬£ð–¬µ" },
};

static const UldnItem inh_StdMidLong[] = { // rdar://109529736
    { "inh",                TEST_ULOC_LOCALE, u"Ð“Ó€Ð°Ð»Ð³Ó€Ð°Ð¹ Ð¼Ð¾Ñ‚Ñ‚" },
};
    
static const UldnItem sjd_StdMidLong[] = { // rdar://117588343
    { "sjd",                TEST_ULOC_LOCALE, u"ÐšÓ£Ð»Ð»Ñ‚ ÑÐ°Ì„Ð¼ÑŒ ÐºÓ£Ð»Ð»" },
};
        
static const UldnItem sje_StdMidLong[] = { // rdar://117588343
    { "sje",                TEST_ULOC_LOCALE, u"BidumsÃ¡megiella" },
};
        
static const UldnItem sju_StdMidLong[] = { // rdar://117588343
    { "sju",                TEST_ULOC_LOCALE, u"UbmejesÃ¡miengiÃ¤lla" },
};
        
static const UldnItem osa_StdMidLong[] = { // rdar://109529736
    { "osa",                TEST_ULOC_LOCALE, u"ð“ð“˜ð“»ð“˜ð“»ð“Ÿ" },
};


static const UldnItem it_StdMidLong[] = { // rdar://85413154
	{ "SH",                 TEST_ULDN_REGION, u"Sant'Elena" },
	{ "CI",                 TEST_ULDN_REGION, u"CÃ´te d'Ivoire" },
...
static const UldnItem mic_StdMidLong[] = { // rdar://104877633
	{ "mic",                TEST_ULOC_LOCALE, u"LÊ¼nuiÊ¼suti" },
};

static const UldnItem mid_StdMidLong[] = { // rdar://104877633
	{ "mid",                TEST_ULOC_LOCALE, u"à¡Œà¡€à¡à¡ƒà¡€à¡‰à¡€" },
};

static const UldnItem nnp_StdMidLong[] = { // rdar://104877633
	{ "nnp",                TEST_ULOC_LOCALE, u"ðž‹’ðž‹€ðž‹‰ðž‹ƒðž‹•" },
};
...
static const UldnItem rej_Rjng_StdMidLong[] = { // rdar://104877633
	{ "rej",                TEST_ULOC_LOCALE, u"ê¤·ê¤¼ê¥‹ ê¤½ê¥ê¤ºê¥" },
};

static const UldnItem sm_StdMidLong[] = { // rdar://89394823
	{ "sm",                TEST_ULOC_LOCALE, u"Gagana faÊ»a SÄmoa" },
};
...
static void TestGetLanguagesForRegion() {
    ...
    if (U_FAILURE(status)) {
        ...
        if (entryCount < kUALanguageEntryMin) {
            ...
            bool foundUgArab = false;
            for (entryPtr++; entryPtr < entries + kUALanguageEntryMin; entryPtr++) {
                if (uprv_strcmp(entryPtr->languageCode, "ug_Arab") == 0) {
                    // we found ug_Arab, make sure it has correct status
                    if (entryPtr->status != UALANGSTATUS_REGIONAL_OFFICIAL) {
                        log_err("FAIL: ualoc_getLanguagesForRegion %s, ug_Arab had incorrect status %d\n", region, (int)entryPtr->status);
                    }
                    foundUgArab = true;
                }
                // test for rdar://144628560
                if (uprv_strcmp(entryPtr->languageCode, "yue_Hant") == 0) {
                    log_err("FAIL: ualoc_getLanguagesForRegion %s, found spurious yue_Hant\n", region);
                }
            }
    ...
    if (U_FAILURE(status)) {
        ...
        // Expect about 12 entries, the last should be for ms_Arab with a fraction â‰ˆ 0.012 // rdar://27943264 and subsequent changes
        if (entryCount < 10) {
...
// For rdar://143084229
static const char * appleLocsMAO[]    = { "zxx", "Bali", "Buhd", "Hano", "Ital", "Java", "Tagb", "applesymbols", "ar", "bg", "bn", "bo", "braille", "chr", "cs", "cy", "da", "de", "dingbats", "el", "emoji", "en", "es", "fi", "gez", "gu", "haw", "he", "hi", "hr", "hy", "iu", "ja", "ka", "km", "kn", "ko", "lo", "mi", "ml", "my", "nb", "or", "ornaments", "pa", "pl", "ro", "ru", "si", "sr", "sv", "symbol", "ta", "te", "th", "tl", "tr", "uk", "ur", "vi", "webdings", "zh-Hans", "zh-Hant"
 };
...
static void TestSpecificDisplayNames(void) {
    ...
    static const char* testLanguages[] = {
        ...
        "mi",    "en",      "MÄori",             // rdar://75300243
        "mi",    "en_NZ",   "MÄori",             // rdar://75300243
        "hi_IN", "hi_Latn", "Hindi (Bharat)",    // rdar://125016053 (obsoletes: rdar://80522845)
        "nv",    "hi",      "à¤¨à¤¾à¤µà¤¾à¤¹à¥‹",              // rdar://82306232 (CLDR 42 also updated)
        ...
        "ii",    "yue-Hans","å‡‰å±±å½è¯­",            // rdar://108460253
        "ii",    "yue",     "æ¶¼å±±å½æ–‡",            // rdar://108460253
        "ii",    "zh-Hant", "æ¶¼å±±å½æ–‡",            // rdar://108460253
...
static void TestMvskokeAndLushootseedDisplayNames(void) {
    ...
    static const char* testLanguages[] = {
        "ar", "Ù„ÙˆØ´ÙˆØªØ³ÙŠØ¯", "Ù…Ø³ÙƒÙˆÙƒÙŠ",
        "bg", "Ð›ÑƒÑˆÑƒÑ†Ð¸Ð´", "ÐœÑƒÑÐºÐ¾Ð³Ð¸",
        "ca", "lushootseed", "mvskoke",
        "cs", "lushootseedskÃ¡", "mvskoke",
        "da", "lushootseed", "mvskoke",
        "de", "Lushootseed", "Mvskoke",
        "el", "Î›Î¬ÏƒÎ¿Ï…Ï„ÏƒÎ¹Î½Ï„", "ÎœÎ¿ÏƒÎºÏŒÎ³ÎºÎ¹",
        ...
        "ja", "ãƒ«ã‚·ãƒ¥ãƒ„ã‚£ãƒ¼ãƒ‰èªž", "ãƒžã‚¹ã‚³ã‚®èªž",
        "kk", "Ð»ÑƒÑˆÑƒÑ†Ð¸Ð´ Ñ‚Ñ–Ð»Ñ–", "Ð¼Ð°ÑÐºÐ¾Ð³Ð¸ Ñ‚Ñ–Ð»Ñ–",
        "ko", "ë£¨ìŠˆíŠ¸ì‹œë“œì–´", "ë¨¸ìŠ¤ì½”ê¸°ì–´",
        "lt", "laÅ¡utsidÅ³", "mvskokÅ³",
        "lut", "dxÊ·lÉ™Å¡ucid Â· txÊ·É™lÅ¡ucid Â· xÊ·É™lÅ¡ucid", "mus", // yes, all three forms for lut x lut, and no entry for "mus"
        ...
        "ru", "Ð»ÑƒÑˆÐ¸Ñ†Ð¸Ð´", "Ð¼Ð°ÑÐºÐ¾Ð³Ð¸",
        "sk", "lushootseedskÃ©", "mvskoke",
        "sl", "lushootseed", "mvskoke",
        "sv", "lushootseed", "mvskoke",
        "th", "à¸¥à¸¹à¸Šà¸¹à¸•à¸‹à¸µà¸”", "à¸¡à¸±à¸ªà¸„à¸µà¸à¸µ",
        "tr", "Lushootseed", "Mvskoke",
        "uk", "Ð»ÑƒÑˆÑƒÑ†Ð¸Ð´", "Ð¼Ð°ÑÐºÐ¾Ð³Ñ–",
        "vi", "Tiáº¿ng Lushootseed", "Tiáº¿ng Mvskoke",
        "yue_CN", "å¢ç»é”¡å¾·è¯­", "é©¬æ–¯ç§‘å‰è¯­",
        "zh_CN", "å¢ç»é”¡å¾·è¯­", "é©¬æ–¯ç§‘å‰è¯­",
        "zh_HK", "é­¯è˜‡å¥‡æ–‡", "é¦¬æ–¯ç§‘å‰æ–‡",
        "zh_TW", "é­¯è˜‡å¥‡æ–‡", "é¦¬æ–¯ç§‘å‰æ–‡",
    };
    int32_t testLanguagesLength = UPRV_LENGTHOF(testLanguages);
