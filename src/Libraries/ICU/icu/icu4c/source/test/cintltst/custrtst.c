...
static const UChar valid3[] = { // sample from Bill Siegrist, 100 UTF16 units
                                0xD83D,0xDC2E,                                    // U+1F42E	ðŸ®
                                0xD83D,0xDC3C,                                    // U+1F43C	ðŸ¼
                                0xD83D,0xDC39,                                    // U+1F439	ðŸ¹
                                0xD83D,0xDC31,                                    // U+1F431	ðŸ±
                                0xD83D,0xDE4B,0x200D,0x2640,0xFE0F,               // U+1F64B  U+200D U+2640  U+FE0F	ðŸ™‹â€â™€ï¸
                                0xD83D,0xDE47,0xD83C,0xDFFC,0x200D,0x2642,0xFE0F, // U+1F647 U+1F3FC U+200D  U+2642 U+FE0F	ðŸ™‡ðŸ¼â€â™‚ï¸	
                                0xD83D,0xDE46,0x200D,0x2642,0xFE0F,               // U+1F646  U+200D U+2642  U+FE0F	ðŸ™†â€â™‚ï¸
                                0xD83E,0xDDDA,0xD83C,0xDFFF,0x200D,0x2640,0xFE0F, // U+1F9DA U+1F3FF U+200D  U+2640 U+FE0F ðŸ§šðŸ¿â€â™€ï¸
                                0xD83E,0xDDD6,0xD83C,0xDFFE,0x200D,0x2642,0xFE0F, // U+1F9D6 U+1F3FE U+200D  U+2642 U+FE0F ðŸ§–ðŸ¾â€â™‚ï¸
                                0xD83E,0xDDD6,0xD83C,0xDFFE,0x200D,0x2642,0xFE0F, // U+1F9D6 U+1F3FE U+200D  U+2642 U+FE0F	ðŸ§–ðŸ¾â€â™‚ï¸
                                0xD83E,0xDDDB,0xD83C,0xDFFC,0x200D,0x2642,0xFE0F, // U+1F9DB U+1F3FC U+200D  U+2642 U+FE0F	ðŸ§›ðŸ¼â€â™‚ï¸
                                0xD83E,0xDDD9,0x200D,0x2640,0xFE0F,               // U+1F9D9  U+200D U+2640  U+FE0F	ðŸ§™â€â™€ï¸
                                0xD83D,0xDC68,0xD83C,0xDFFE,0x200D,0x2696,0xFE0F, // U+1F468 U+1F3FE U+200D  U+2696 U+FE0F	ðŸ‘¨ðŸ¾â€âš–ï¸
                                0xD83D,0xDC69,0xD83C,0xDFFC,0x200D,0xD83D,0xDD27, // U+1F469 U+1F3FC U+200D U+1F527	ðŸ‘©ðŸ¼â€ðŸ”§
                                0xD83D,0xDC69,0xD83C,0xDFFF,0x200D,0xD83C,0xDFEB, // U+1F469 U+1F3FF U+200D U+1F3EB	ðŸ‘©ðŸ¿â€ðŸ«
                                0xD83D,0xDC68,0xD83C,0xDFFE,0x200D,0xD83D,0xDCBB, // U+1F468 U+1F3FE U+200D U+1F4BB	ðŸ‘¨ðŸ¾â€ðŸ’»
                                0xD83D,0xDC69,0xD83C,0xDFFD,0x200D,0xD83D,0xDD2C, // U+1F469 U+1F3FD U+200D U+1F52C	ðŸ‘©ðŸ½â€ðŸ”¬
                                0xD83D,0xDC68,0xD83C,0xDFFC,0x200D,0xD83D,0xDE92, // U+1F468 U+1F3FC U+200D U+1F692	ðŸ‘¨ðŸ¼â€ðŸš’
                                0 };
