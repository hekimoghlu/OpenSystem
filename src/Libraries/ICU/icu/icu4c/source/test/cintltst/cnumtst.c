...
#if APPLE_ICU_CHANGES
// rdar://
static const UChar ustr_zh50s[] = u"äº”å"; /* 4E94 5341 spellout 50 */
static const UChar ustr_zh50d[] = u"äº”ã€‡"; /* 4E94 3007 decimal 50 */
static const UChar ustr_zh05a[] = u"é›¶äº”"; /* 96F6 4E94 decimal-alt 05 */
static const UChar ustr_zh05d[] = u"ã€‡äº”"; /* 3007 4E94 decimal 05 */
#endif  // APPLE_ICU_CHANGES
...
#if APPLE_ICU_CHANGES
// some extra tests for rdar://116185298 (D74/21C15: Arabic numerals (1,2,3..) should be set as default when language of device is changed to Arabic instead of Arabic-Indic numerals (Ù£ØŒÙ¢ØŒÙ¡))
...
static const UChar currpat[]  = { 0xA4,0x23,0x2C,0x23,0x23,0x30,0x2E,0x30,0x30,0}; /* Â¤#,##0.00 */
...
static const SetAffixOnCurrFmtItem affixOnCurrFmtItems[] = {
    ...
    { "01 en set no affix ", "en", NULL, NULL, NULL,  NULL, u"Â¤", u"", u"-Â¤", u"", u"Â¤#,##0.00",              123.4, u"Â¤123.40", u"-Â¤123.40" },
    { "02 en set +  prefix", "en", u"$", NULL, NULL,  NULL, u"$", u"", u"-Â¤", u"", u"$#,##0.00;-Â¤#,##0.00",   123.4, u"$123.40", u"-Â¤123.40" },
...
static const TestMinGroupItem minGroupItems[] = {
    { 123.0,      "123.0",      u"123,00",        u"123,00Â â‚¬" },
    { 1234.0,     "1234.0",     u"1234,00",       u"1234,00Â â‚¬" },
    { 12345.0,    "12345.0",    u"12Â 345,00",     u"12Â 345,00Â â‚¬" },
    { 123456.0,   "123456.0",   u"123Â 456,00",    u"123Â 456,00Â â‚¬" },
    { 1234567.0,  "1234567.0",  u"1Â 234Â 567,00",  u"1Â 234Â 567,00Â â‚¬" },
    { 12345678.0, "12345678.0", u"12Â 345Â 678,00", u"12Â 345Â 678,00Â â‚¬" },
...
//        "en_BG", "bg_BG", "en_150", // en_BG exists and has "0.00Â Â¤" -- en_ 150 has "#,##0.00Â Â¤"
        "en_CN", "zh_CN", "en_001",
        "en_CZ", "cs_CZ", "en_CZ",
...
//        "en_BR", "pt_BR", "en_001", // en_BR exists and has "Â¤Â #,##0.00" -- en_001 has "Â¤#,##0.00"
        "en_CL", "es_CL", "en_CL",
        "en_CO", "es_CO", "en_CO",
        "en_GR", "el_GR", "en_150",
        "en_HU", "hu_HU", "en_150",
        "en_ID", "id_ID", "en_001@currency=IDR",
//        "en_MM", "my_MM@numbers=latn", "en_001", // en_MM exists and has "#,##0Â Â¤" -- en_001 "Â¤#,##0.00"
//        "en_MV", "dv_MV", "en_001", // en_MV exists and has "Â¤Â #,##0.00" -- en_001 has "Â¤#,##0.00"
        "en_MX", "es_MX", "en_001",
        "en_RU", "ru_RU", "en_RU",
        "en_TR", "tr_TR", "en_TR",
        "en_UA", "uk_UA", "en_150",
...
//        "en_SA", "ar_SA@numbers=latn", "en", // en_SA exists and has "Â¤Â #,##0.00" -- en_001 has "Â¤#,##0.00"
        "es_AI", "en_AI", "es_419",
        "es_AW", "nl_AW", "es_419",
        "es_BL", "fr_BL", "es_419",
        "es_FK", "en_FK", "es_419",
        ...
        "en_MT", "mt_MT", "en_001",
        "en_MY", "ms_MY", "en_001",
//        "en_NL", "nl_NL", "en_150", // en_NL exists and has "Â¤Â #,##0.00;Â¤Â -#,##0.00" -- en_150 has "#,##0.00Â Â¤"
        "en_PH", "fil_PH", "en_001",
        "en_ZW", "sn_ZW", "en_001",
        "es_US", "en_US", "es_US",
...
static void TestCurrencySymbol(void) {
    ...
    UChar* testCases[] = {
        ...
        u"en_SA", u"SARÂ 1,234.56",  // don't use native currency symbol because it's letters in a different script
        u"ar_US", u"\u200f1,234.56\u00a0$", // rdar://116185298
        u"en_IL", u"â‚ª1,234.56",     // can use native currency symbol because its script code is "common"
        u"he_US", u"\u200f1,234.56\u00a0\u200f$",   // can use native currency symbol because its script code is "common"
        u"th_TH", u"à¸¿1,234.56",     // baseline
        u"fr_TH", u"1,234.56Â à¸¿",    // can use native currency symbol because its gc is Sc (rdar://79879611)
        u"km_KH", u"1,234.56áŸ›",     // baseline
        u"en_KH", u"áŸ›1,234.56",     // can use native currency symbol because its gc is Sc (rdar://79879611)
        // tests for rdar://77057954 (wrong symbol for CNY when region is JP (should get Â¥, got å…ƒ)
        u"zh_JP@currency=CNY", u"CNÂ¥1,234.56",
        u"zh_Hans_JP@currency=CNY", u"CNÂ¥1,234.56",
        u"zh_Hant_JP@currency=CNY", u"CNÂ¥1,234.56", // per rdar://77057954 this is the desired value 
        u"ja_JP@currency=CNY", u"å…ƒÂ 1,234.56",
        u"en_JP@currency=CNY", u"CNÂ¥1,234.56",
        // rdar://88513120
        u"en_CV", u"â€‹Â 1Â 234$56", // decimal separator = actual currency symbol, set currency symbol to ZWSP
        // rdar://97100652
        u"zh-Hant_US@currency=USD", u"$1,234.56",
        // rdar://107639369
        u"en_NL", u"â‚¬Â 1.234,56",
        u"en_BE", u"â‚¬Â 1.234,56",
        // rdar://107636645
        u"en_AT", u"â‚¬Â 1.234,56",
        u"zh-Hant_US@currency=USD", u"$1,234.56",
        // rdar://107676538, fixed in rdar://108767828
        u"fr_CH@currency=CHF", u"CHFÂ 1â€¯234,56",
        // rdar://107711452
        u"en_ID@currency=IDR", u"RpÂ 1.235", // IDR has digits="0"
        // rdar://102824421
        u"es_VE", u"Bs.DÂ 1.234,56" // want default to be VED (Bs.D), not VES (Bs.S)
    };
...
static void TestRgSubtag(void) {
    UChar* testData[] = {
        u"fr_FR",                        u"CAD", u"1234.56", u"1â€¯234,56Â $CA",
        u"fr_CA" ,                       u"CAD", u"1234.56", u"1Â 234,56Â $",
        u"fr_FR@rg=CAzzzz",              u"CAD", u"1234.56", u"1Â 234,56Â $",
        u"fr_FR",                        u"",    u"1234.56", u"1â€¯234,56Â â‚¬",
        u"fr_CA" ,                       u"",    u"1234.56", u"1Â 234,56Â $",
        u"fr_FR@rg=CAzzzz",              u"",    u"1234.56", u"1Â 234,56Â $",
        u"fr_FR@currency=CAD",           u"",    u"1234.56", u"1â€¯234,56Â $CA",
        u"fr_CA@currency=CAD" ,          u"",    u"1234.56", u"1Â 234,56Â $",
        u"fr_FR@rg=CAzzzz;currency=CAD", u"",    u"1234.56", u"1Â 234,56Â $",
        
        u"en_US",                        u"USD", u"10.99",   u"$10.99",
        u"en_US@rg=USzzzz",              u"USD", u"10.99",   u"$10.99",
        u"es_MX",                        u"USD", u"10.99",   u"USDÂ 10.99",
        u"es_US",                        u"USD", u"10.99",   u"$10.99",
        u"es_MX@rg=USzzzz",              u"USD", u"10.99",   u"$10.99",

        u"ar_SA",                        u"USD", u"10.99",   u"\u200fÙ¡Ù Ù«Ù©Ù©\u00a0US$",
...
//        u"pt-BR_US",                     u"USD", u"10.99",   u"$\u00a010.99", // this locale syntax doesn't work in ICU4C
        ...
        u"en_DE",                        u"EUR", u"1234.56", u"1.234,56Â â‚¬",
        u"en_US@rg=DEzzzz",              u"EUR", u"1234.56", u"1.234,56Â â‚¬",
    };
...
static void TestDefaultNumberingSystem(void) {
    const UChar* testCases[] = {
        ...
        u"ar",    u"1,234.56",
        u"ar_SA", u"Ù¡Ù¬Ù¢Ù£Ù¤Ù«Ù¥Ù¦",
        u"ar_AE", u"1,234.56",
        u"ar_GB", u"1,234.56",
        // tests for rdar://135129865
        u"ur",    u"1,234.56", // "control" (correct in CLDR)
        u"ur_IN", u"1,234.56", // Apple override (CLDR has Û±Ù¬Û²Û³Û´Ù«ÛµÛ¶)
...
static void TestIndianSecondaryGrouping(void) {
    const UChar* testCases[] = {
        u"en_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78", // also see rdar://144815432
        u"bn_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"bn_IN@numbers=beng",    u"à§§,à§¨à§©,à§ªà§«à§¬.à§­à§®", u"â‚¹à§§,à§¨à§©,à§ªà§«à§¬.à§­à§®",
        u"gu_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"gu_IN@numbers=gujr",    u"à«§,à«¨à«©,à«ªà««à«¬.à«­à«®", u"â‚¹à«§,à«¨à«©,à«ªà««à«¬.à«­à«®",
        u"hi_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"hi_IN@numbers=deva",    u"à¥§,à¥¨à¥©,à¥ªà¥«à¥¬.à¥­à¥®",  u"â‚¹à¥§,à¥¨à¥©,à¥ªà¥«à¥¬.à¥­à¥®",
        u"kn_IN",                 u"1,23,456.78",  u"â‚¹1,23,456.78",
        u"kn_IN@numbers=knda",    u"à³§,à³¨à³©,à³ªà³«à³¬.à³­à³®",  u"â‚¹à³§,à³¨à³©,à³ªà³«à³¬.à³­à³®",
        u"ml_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"ml_IN@numbers=mlym",    u"àµ§,àµ¨àµ©,àµªàµ«àµ¬.àµ­àµ®", u"â‚¹àµ§,àµ¨àµ©,àµªàµ«àµ¬.àµ­àµ®",
        u"mr_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"mr_IN@numbers=deva",    u"à¥§,à¥¨à¥©,à¥ªà¥«à¥¬.à¥­à¥®", u"â‚¹à¥§,à¥¨à¥©,à¥ªà¥«à¥¬.à¥­à¥®",
        u"or_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"or_IN@numbers=orya",    u"à­§,à­¨à­©,à­ªà­«à­¬.à­­à­®", u"â‚¹à­§,à­¨à­©,à­ªà­«à­¬.à­­à­®",
        u"pa_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"pa_IN@numbers=guru",    u"à©§,à©¨à©©,à©ªà©«à©¬.à©­à©®", u"â‚¹à©§,à©¨à©©,à©ªà©«à©¬.à©­à©®",
        u"ta_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"te_IN",                 u"1,23,456.78", u"â‚¹1,23,456.78",
        u"te_IN@numbers=telu",    u"à±§,à±¨à±©,à±ªà±«à±¬.à±­à±®", u"â‚¹à±§,à±¨à±©,à±ªà±«à±¬.à±­à±®",
        u"ur_IN",                 u"1,23,456.78",  u"â‚¹1,23,456.78",
        u"ur_IN@numbers=arabext", u"Û±Ù¬Û²Û³Ù¬Û´ÛµÛ¶Ù«Û·Û¸",  u"â‚¹Â Û±Ù¬Û²Û³Ù¬Û´ÛµÛ¶Ù«Û·Û¸",
    };
