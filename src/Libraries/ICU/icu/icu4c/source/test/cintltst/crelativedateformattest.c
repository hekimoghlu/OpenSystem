...
/*  text           numeric           text                    numeric */
    ...
    {-1,  -1,  -1},                   {UDAT_REL_NUMERIC_FIELD,  0,  1}, /* "ebben a percben",  "0 perccel ezelÅ‘tt",       -0   */
    {-1,  -1,  -1},                   {UDAT_REL_NUMERIC_FIELD,  0,  1}, /* "ebben a percben",  "0 perc mÃºlva",             0   */
    {UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3}, /* "0,7 perc mÃºlva",   "0,7 perc mÃºlva",           0.7 */
    {UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1}, /* "1 perc mÃºlva",     "1 perc mÃºlva",             1   */
    {UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1}, /* "2 perc mÃºlva",     "2 perc mÃºlva",             2   */
    {UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1}, /* "5 perc mÃºlva",     "5 perc mÃºlva"              5   */
};
