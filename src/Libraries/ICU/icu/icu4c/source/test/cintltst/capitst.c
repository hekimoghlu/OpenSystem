...
void TestTamilSortKey(void) {
    ...
    const struct {
        ...
        {u"à®•", u"à®•à¯"}, {u"à®™", u"à®™à¯"}, {u"à®š", u"à®šà¯"}, {u"à®ž", u"à®žà¯"},
        {u"à®Ÿ", u"à®Ÿà¯"}, {u"à®£", u"à®£à¯"}, {u"à®¤", u"à®¤à¯"}, {u"à®¨", u"à®¨à¯"},
        {u"à®ª", u"à®ªà¯"}, {u"à®®", u"à®®à¯"}, {u"à®¯", u"à®¯à¯"}, {u"à®°", u"à®°à¯"},
        {u"à®²", u"à®²à¯"}, {u"à®µ", u"à®µà¯"}, {u"à®´", u"à®´à¯"}, {u"à®³", u"à®³à¯"},
        {u"à®±", u"à®±à¯"}, {u"à®©", u"à®©à¯"}, {u"à®œ", u"à®œà¯"}, {u"à®¶", u"à®¶à¯"},
        {u"à®·", u"à®·à¯"}, {u"à®¸", u"à®¸à¯"}, {u"à®¹", u"à®¹à¯"}, {u"à®•à¯à®·", u"à®•à¯à®·à¯"},
        {NULL, NULL}
    };
