...
#else
        u"es_MX", u"QQQQ y",  u"1.Âº trimestre 1970",
...
#else
        u"es_MX", u"qqqq",    u"1.Âº trimestre",
        u"es_MX", u"qqq",     u"T1",
        u"es_MX", u"qqqqq",   u"1",
#endif  // APPLE_ICU_CHANGES
    };
...
static void TestHourCycle(void) {
    ...
    const UChar* testCases[] = {
        ...
        u"en_US", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
#if APPLE_ICU_CHANGES
// rdar://
        u"en_CA", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
#else
        u"en_CA", u"Tuesday, March 16, 1943 at 3:45:32â€¯p.m.",
#endif
        u"en_GB", u"Tuesday, 16 March 1943 at 15:45:32",
        u"en_AU", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm",
        // test a couple locales for which we don't have specific locale files (we should still get the correct hour cycle)
        u"en_CO", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM",
        u"en_MX", u"Tuesday, 16 March 1943 at 3:45:32â€¯p.m.",
...
// but probably can't without breaking rdar://112976115.  This needs more thought! --rtg 1/3/24
        ...
        u"en_US@rg=CAzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
        u"en_CA@rg=USzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
        u"en_GB@rg=USzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯pm", // rdar://123446235
        u"en_GB@rg=CAzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯pm", // rdar://123446235
        u"en_GB@rg=AUzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm", // rdar://123446235
#else
        u"en_US@rg=GBzzzz", u"Tuesday, March 16, 1943 at 15:45:32",
        u"en_US@rg=CAzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
        u"en_CA@rg=USzzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
        u"en_GB@rg=USzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM",
        u"en_GB@rg=CAzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM",
        u"en_GB@rg=AUzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM",
#endif // APPLE_ICU_CHANGES
        // test that the hc ("hours") subtag does the right thing
        u"en_US@hours=h23", u"Tuesday, March 16, 1943 at 15:45:32",
        u"en_GB@hours=h12", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm", // rdar://123446235
        // test that the rg and hc subtags do the right thing when used together
#if APPLE_ICU_CHANGES
// rdar://112976115 (SEED: 21A5291h/iPhone13,3: Date format incorrect with en_US@rg=dkzzzz)
// (See block comment above)
        u"en_US@rg=GBzzzz;hours=h12", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM",
        u"en_GB@rg=USzzzz;hours=h23", u"Tuesday, March 16, 1943 at 15:45:32",
#else
        u"en_US@rg=GBzzzz;hours=h12", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM",
...
static const StandardPatternItem stdPatternItems[] = {
    ...
    { "en_MX", UDAT_MEDIUM, UDAT_SHORT, u"25 Feb 2015 at 5:10â€¯a.m." }, // rdar://17705154
    { "es_MX", UDAT_MEDIUM, UDAT_SHORT, u"25 feb 2015, 5:10â€¯a.m." }, // rdar://17705154
    { "es_CL", UDAT_MEDIUM, UDAT_SHORT, u"25-02-2015, 5:10â€¯a.m." }, // rdar://17705154 + rdar://123831373 (CLDR 44 changed CL to 12-hour time)
    { "es_CO", UDAT_MEDIUM, UDAT_SHORT, u"25/02/2015, 5:10â€¯a.m." }, // rdar://123831373
    { "es_419@rg=MXzzzz", UDAT_MEDIUM, UDAT_SHORT, u"25 feb 2015, 5:10â€¯a.m." }, // rdar://17705154
    ...
    { "ur_PK",      UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" },
    { "ur_IN",      UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" }, // result changed for rdar://126856083
    { "ur_Arab",    UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" },
    { "ur_Aran",    UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" },
    { "ur_Arab_PK", UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" },
    { "ur_Aran_PK", UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" },
    { "ur_Arab_IN", UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" }, // result changed for rdar://126856083
    { "ur_Aran_IN", UDAT_MEDIUM, UDAT_SHORT, u"25 ÙØ±ÙˆØŒ 2015ØŒ 5:10 ØµØ¨Ø­" }, // result changed for rdar://126856083
    ...
    { "zh_Hant@calendar=buddhist", UDAT_NONE, UDAT_MEDIUM, u"æ¸…æ™¨5:10:00" },
    { "zh_Hant@calendar=buddhist", UDAT_NONE, UDAT_SHORT,  u"æ¸…æ™¨5:10" },
    // Add tests for rdar://43349838 and rdar://119515016
    { "pl", UDAT_FULL,   UDAT_SHORT, u"Å›roda, 25 lutego 2015 o 05:10" },
    ...
    { "iu_CA",      UDAT_LONG, UDAT_SHORT, u"á••á•á•—áŠá“• 25, 2015 5:10 am" },
    { "nv",         UDAT_LONG, UDAT_SHORT, u"2015 M02 25 5:10 AM" },
    // Add tests for rdar://75760219
    { "zh_Hant@calendar=chinese",    UDAT_FULL, UDAT_NONE, u"2015ä¹™æœªå¹´æ­£æœˆåˆä¸ƒ æ˜ŸæœŸä¸‰" },
    { "zh_Hant@calendar=chinese",    UDAT_LONG, UDAT_NONE, u"2015ä¹™æœªå¹´æ­£æœˆåˆä¸ƒ" },
    { "zh_Hant@calendar=chinese",    UDAT_MEDIUM, UDAT_NONE, u"2015å¹´æ­£æœˆåˆä¸ƒ" },
    { "zh_Hant_HK@calendar=chinese",    UDAT_FULL, UDAT_NONE, u"ä¹™æœªï¼ˆ2015ï¼‰å¹´æ­£æœˆåˆä¸ƒæ˜ŸæœŸä¸‰" },
    { "zh_Hant_HK@calendar=chinese",    UDAT_LONG, UDAT_NONE, u"ä¹™æœªï¼ˆ2015ï¼‰å¹´æ­£æœˆåˆä¸ƒ" },
    { "zh_Hant_HK@calendar=chinese",    UDAT_MEDIUM, UDAT_NONE, u"ä¹™æœªå¹´æ­£æœˆåˆä¸ƒ" },
    // Add tests for rdar://72744707
    { "hi@calendar=japanese", UDAT_FULL,   UDAT_NONE, u"à¤¬à¥à¤§à¤µà¤¾à¤°, 25 à¤«à¤¼à¤°à¤µà¤°à¥€ 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡" }, // "à¤¬à¥à¤§à¤µà¤¾à¤°, 25 à¤«à¤¼à¤°à¤µà¤°à¥€ 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡"
    { "hi@calendar=japanese", UDAT_LONG,   UDAT_NONE, u"25 à¤«à¤¼à¤°à¤µà¤°à¥€ 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡" }, // "25 à¤«à¤¼à¤°à¤µà¤°à¥€ 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡"
    { "hi@calendar=japanese", UDAT_MEDIUM, UDAT_NONE, u"25 à¤«à¤¼à¤°à¥° 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡" }, // "25 à¤«à¤¼à¤°à¥° 27 à¤¹à¥‡à¤‡à¤¸à¥‡à¤‡"
    ...
    { "ff_Adlm", UDAT_FULL,   UDAT_NONE, u"ðž¤ðž¤¶ðž¤«ðž¤§ðž¤¤ðž¤¢ðž¥„ðž¤ªðž¤« ðž¥’ðž¥• ðž¤•ðž¤®ðž¤¤ðž¤¼ðž¤®â¹ ðž¥’ðž¥ðž¥‘ðž¥•" },
    { "ff_Adlm", UDAT_LONG,   UDAT_NONE, u"ðž¥’ðž¥• ðž¤•ðž¤®ðž¤¤ðž¤¼ðž¤®â¹ ðž¥’ðž¥ðž¥‘ðž¥•" },
    { "ff_Adlm", UDAT_MEDIUM, UDAT_NONE, u"ðž¥’ðž¥• ðž¤•ðž¤®ðž¤¤ðž¤¼ðž¤®â¹ ðž¥’ðž¥ðž¥‘ðž¥•" },
    { "ff_Adlm", UDAT_SHORT,  UDAT_NONE, u"ðž¥’ðž¥•-ðž¥’-ðž¥’ðž¥ðž¥‘ðž¥•" },
    ...
    { "uk_UA", UDAT_FULL,   UDAT_NONE, u"ÑÐµÑ€ÐµÐ´Ð°, 25 Ð»ÑŽÑ‚Ð¾Ð³Ð¾ 2015â€¯Ñ€." },
    // Add tests for rdar://116387918
    { "en_HU", UDAT_LONG,   UDAT_NONE, u"2015. February 25." },
    { "en_HU", UDAT_SHORT,  UDAT_NONE, u"2015. 02. 25." },
    { "hu_HU", UDAT_LONG,   UDAT_NONE, u"2015. februÃ¡r 25." },
    { "hu_HU", UDAT_SHORT,  UDAT_NONE, u"2015. 02. 25." },
    // add tests for rdar://116185298
    { "en_US", UDAT_NONE, UDAT_SHORT, u"5:10â€¯AM" },
    { "zh_TW", UDAT_NONE, UDAT_SHORT, u"æ¸…æ™¨5:10" },
    { "hi_IN", UDAT_NONE, UDAT_SHORT, u"à¤¸à¥à¤¬à¤¹ 5:10" },
    { "hi_US", UDAT_NONE, UDAT_SHORT, u"à¤¸à¥à¤¬à¤¹ 5:10" },
    // add test for rdar://129389486
    { "ta",    UDAT_LONG, UDAT_SHORT, u"25 à®ªà®¿à®ªà¯à®°à®µà®°à®¿, 2015, à®•à®¾à®²à¯ˆ 5:10" },
    // add test for rdar://140753035
    { "hi",    UDAT_LONG, UDAT_SHORT, u"25 à¤«à¤¼à¤°à¤µà¤°à¥€ 2015, à¤¸à¥à¤¬à¤¹ 5:10" },
    // add test for rdar://128053661
    { "or",    UDAT_LONG, UDAT_SHORT, u"à¬«à­‡à¬¬à­ƒà¬†à¬°à­€ 25, 2015, 5:10 AM" },
...
static const TimeUnitWithNumStyleItem tuNumStyleItems[] = {
    ...
    { "en_US", UNUM_CURRENCY,              UATIMEUNITSTYLE_FULL,      UATIMEUNITFIELD_SECOND,      0.0, u"Â¤0.00 seconds" }, // before ICU68* was u"$0.00 seconds"
    ...
    // "en_US", UNUM_NUMBERING_SYSTEM, this was a bogus test (numsys should be specified in locale ID) and formerly produced a result arbitrarily using tamil numbering: u"à¯¦ seconds"
    ...
    { "en_US", UNUM_CURRENCY_ACCOUNTING,   UATIMEUNITSTYLE_FULL,      UATIMEUNITFIELD_SECOND,      0.0, u"Â¤0.00 seconds" }, // before ICU68* was u"$0.00 seconds"
    { "en_US", UNUM_CASH_CURRENCY,         UATIMEUNITSTYLE_FULL,      UATIMEUNITFIELD_SECOND,      0.0, u"Â¤0.00 seconds" }, // before ICU68* was u"$0.00 seconds"
    ...
    { "en_US", UNUM_CURRENCY_STANDARD/*16*/,UATIMEUNITSTYLE_FULL,     UATIMEUNITFIELD_SECOND,      0.0, u"Â¤0.00 seconds" }, // before ICU68* was u"$0.00 seconds"
    { NULL, 0, 0, 0, 0.0, NULL }
};
...
static const char * remapResults_hi[] = {
    ...
    "B h:mm:ss",      //   force12
#if APPLE_ICU_CHANGES
// rdar://17278425 (â€œà¤ªà¥‚â€ (â€œAMâ€) â€œà¤…â€ (â€œPMâ€) donâ€™t make sense to Hindi users)
...
//        "en_BG", "en_150", "en_150", "en_150", // rdar://29299919 (all date patterns for bg_BG have "'Ð³'." at the end, short date pattern also doesn't match en_150)
...
static void TestRgSubtag(void) { // rdar://106566783
    UChar* testData[] = {
        ...
        u"es_MX" ,           u"16/03/43, 11:56â€¯p.m.",  // rdar://17705154
        u"es_MX" ,           u"16/03/43, 11:56â€¯p.m.",  // rdar://17705154
        u"es_US",            u"3/16/43, 11:56â€¯p.m.",
        u"en_US",            u"3/16/43, 11:56â€¯PM",
        u"es_MX@rg=USzzzz",  u"3/16/43, 11:56â€¯p.m.",
        u"es_ES@rg=USzzzz",  u"3/16/43, 11:56â€¯p.â€¯m.",

        u"zh_CN",            u"1943/3/16 23:56",
        u"zh_TW",            u"1943/3/16 æ™šä¸Š11:56", // rdar://17278425
        u"zh_US",            u"3/16/43 ä¸‹åˆ11:56",
        u"zh_CN@rg=USzzzz",  u"3/16/43 ä¸‹åˆ11:56",
        u"zh_TW@rg=USzzzz",  u"3/16/43 æ™šä¸Š11:56", // rdar://17278425

        u"pt_BR",            u"16/03/1943, 23:56",
        u"pt_PT",            u"16/03/43, 23:56",
        u"pt_US",            u"3/16/43, 11:56â€¯PM",
        u"pt_BR@rg=USzzzz",  u"3/16/43, 11:56â€¯PM",
        u"pt_PT@rg=USzzzz",  u"3/16/43, 11:56â€¯PM",

        u"fr_FR",            u"16/03/1943 23:56",
        u"fr_CA",            u"1943-03-16 23:56",
        u"fr_US",            u"3/16/43 11:56â€¯PM",
        u"fr_FR@rg=USzzzz",  u"3/16/43 11:56â€¯PM",
        u"fr_CA@rg=USzzzz",  u"3/16/43 11:56â€¯p.m.",

        u"ar_SA",            u"Ù© Ø±Ø¨ÙŠØ¹Ù¡ØŒ Ù¡Ù£Ù¦Ù¢ Ù‡Ù€ØŒ Ù¡Ù¡:Ù¥Ù¦\u00a0Ù…",
...
static void TestRelativeDateTime(void) {
    ...
    RelativeDateTimeTestCase testCases[] = {
        { "en_US", UDAT_FULL_RELATIVE,   u"today at 5:00â€¯PM" },
        { "en_US", UDAT_LONG_RELATIVE,   u"today at 5:00â€¯PM" },
        { "en_US", UDAT_MEDIUM_RELATIVE, u"today at 5:00â€¯PM" },
        { "en_US", UDAT_SHORT_RELATIVE,  u"today, 5:00â€¯PM" },
        { "fi_FI", UDAT_FULL_RELATIVE,   u"tÃ¤nÃ¤Ã¤n klo 17.00" },
        { "fi_FI", UDAT_LONG_RELATIVE,   u"tÃ¤nÃ¤Ã¤n klo 17.00" },
        { "fi_FI", UDAT_MEDIUM_RELATIVE, u"tÃ¤nÃ¤Ã¤n klo 17.00" },
        { "fi_FI", UDAT_SHORT_RELATIVE,  u"tÃ¤nÃ¤Ã¤n klo 17.00" },
        // rdar://129389486
        { "ta",    UDAT_LONG_RELATIVE,   u"à®‡à®©à¯à®±à¯, à®®à®¾à®²à¯ˆ 5:00" },
        // rdar://140753035
        { "hi",    UDAT_LONG_RELATIVE,   u"à¤†à¤œ, à¤¶à¤¾à¤® 5:00" },
        // rdar://128053661
        { "or",    UDAT_LONG_RELATIVE,   u"à¬†à¬œà¬¿, 5:00 PM" },
    };
...
static void TestUkrainianDayNames(void) {
    ...
    UChar *expectedResults[] = {
        u"ÑÐµÑ€ÐµÐ´Ð°, 10 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"Ñ‡ÐµÑ‚Ð²ÐµÑ€, 11 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"Ð¿Ê¼ÑÑ‚Ð½Ð¸Ñ†Ñ, 12 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"ÑÑƒÐ±Ð¾Ñ‚Ð°, 13 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"Ð½ÐµÐ´Ñ–Ð»Ñ, 14 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"Ð¿Ð¾Ð½ÐµÐ´Ñ–Ð»Ð¾Ðº, 15 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
        u"Ð²Ñ–Ð²Ñ‚Ð¾Ñ€Ð¾Ðº, 16 ÐºÐ²Ñ–Ñ‚Ð½Ñ",
    };
...
static void TestIndianAMPM(void) {
    ...
    
    {
        ...
        if (assertSuccess("Failed to create time-with-weekday formatter", &err)) {
            udat_format(df, pmDate, result, 200, NULL, &err);
            if (assertSuccess("Error in formatting", &err)) {
                assertUEquals("Wrong formatting result", u"Ù…Ù†Ú¯Ù„ \u200e3:45 PM", result);
            }
            
            udat_format(df, amDate, result, 200, NULL, &err);
            if (assertSuccess("Error in formatting", &err)) {
                assertUEquals("Wrong formatting result", u"Ù…Ù†Ú¯Ù„ \u200e6:30 AM", result);
            }
        }
        udat_close(df);
        udatpg_close(dtpg);
...
static void TestTaiwanDayPeriods(void) {
    ...
    UChar* testData[]  = {
        // NOTE: "@ldpn=no" is an internal cheat code to simulate having the log-day-period-name feature turned off
        u"hi",            u"à¤¦à¥‹à¤ªà¤¹à¤° 3:45", u"à¤¸à¥à¤¬à¤¹ 6:30",
        u"hi@ldpn=no",    u"à¤… 3:45",   u"à¤ªà¥‚ 6:30",
        u"zh_TW",         u"ä¸‹åˆ3:45",  u"æ¸…æ™¨6:30",
        u"zh_TW@ldpn=no", u"ä¸‹åˆ3:45",  u"æ¸…æ™¨6:30",
    };
    const UDate pmDate = -845601267742; // March 16, 1943, 3:45 PM
...
static void TestMonthAndDayNames(void) {
    ...
    MonthAndDayNameTestCase testCases[] = {
        { "gu", UDAT_SHORT_MONTHS, { u"àªœàª¾àª¨à«°", u"àª«à«‡àª¬à«°", u"àª®àª¾àª°à«àªš", u"àªàªªà«àª°àª¿àª²", u"àª®à«‡", u"àªœà«‚àª¨", u"àªœà«àª²àª¾àªˆ", u"àª‘àª—à«°", u"àª¸àªªà«àªŸà«°", u"àª‘àª•à«àªŸà«°", u"àª¨àªµà«°", u"àª¡àª¿àª¸à«°" } }, // rdar://143103676
        { "ur", UDAT_NARROW_MONTHS, { u"Ø¬", u"Ù", u"Ù…", u"Ø§", u"Ù…", u"Ø¬", u"Ø¬", u"Ø§", u"Ø³", u"Ø§", u"Ù†", u"Ø¯" } }, // rdar://132385606
        { "ur", UDAT_NARROW_WEEKDAYS, { u"", u"Ø§", u"Ù¾", u"Ù…", u"Ø¨", u"Ø¬", u"Ø¬", u"Û", u"", u"", u"", u"", } }, // rdar://132231977
        { "hi", UDAT_MONTHS, { u"à¤œà¤¨à¤µà¤°à¥€", u"à¤«à¤¼à¤°à¤µà¤°à¥€", u"à¤®à¤¾à¤°à¥à¤š", u"à¤…à¤ªà¥à¤°à¥ˆà¤²", u"à¤®à¤ˆ", u"à¤œà¥‚à¤¨", u"à¤œà¥à¤²à¤¾à¤ˆ", u"à¤…à¤—à¤¸à¥à¤¤", u"à¤¸à¤¿à¤¤à¤‚à¤¬à¤°", u"à¤…à¤•à¥à¤¤à¥‚à¤¬à¤°", u"à¤¨à¤µà¤‚à¤¬à¤°", u"à¤¦à¤¿à¤¸à¤‚à¤¬à¤°", } }, // rdar://140215649
    };
