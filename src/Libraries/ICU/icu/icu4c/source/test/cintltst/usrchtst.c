...
static const UChar ukApostText[] = u"Ð±â€™ÑŽ, Ð¿Ê¼ÑÑ‚ÑŒ, Ð¿â€™Ñ”, Ð²Ê¼ÑÌÐ·Ð¸"; // 1st & 3rd apostrophes are 2019, 2nd & 4th are 02BC
static const UChar ukApost2019[] = u"â€™";
static const UChar ukApost02BC[] = u"Ê¼";
...
static void TestIndicSearch(void)
{
    ...
    UChar *target = u"à¤¸à¥‹à¥žà¥€ à¤¸à¥à¤‚à¤¦à¤° à¤¹à¥ˆ à¥¤";
    UChar *pattern = u"à¤¸à¥à¤¨à¥à¤¦à¤°";

    IndicSearchItem searchItems[] = {
        // Devanagari
        { u"à¤¸à¥‹à¥žà¥€ à¤¸à¥à¤‚à¤¦à¤° à¤¹à¥ˆ à¥¤", u"à¤¸à¥à¤¨à¥à¤¦à¤°", 5 },
        { u"abcde à¤¸à¥à¤à¤¦à¤° efg", u"à¤¸à¥à¤¨à¥à¤¦à¤°", 6 },
        { u"abcdef à¤¸à¥à¤à¤¦à¤° ghi", u"à¤¸à¥à¤‚à¤¦à¤°", 7 },
        // Gujarati
        { u"abcdefg àª¸à«àª‚àª¦àª° hij", u"àª¸à«àª¨à«àª¦àª°", 8 },
        // Bengali
        { u"abcdefgh à¦…à¦™à§à¦•à¦¨ ijk", u"à¦…à¦‚à¦•à¦¨", 9 },
