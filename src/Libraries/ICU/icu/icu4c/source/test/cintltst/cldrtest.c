...
#if APPLE_ICU_CHANGES
// rdar://104877633 (â˜‚ï¸ Add new locales to CLDR: mid, mic, ber_Tfng, ber_Latn, nqo, nnp,rej, hmn, pqm)
...
#if APPLE_ICU_CHANGES
// rdar://
    { "en",    u"â€œ", u"â€", u"â€˜", u"â€™"},
    { "es",    u"â€œ", u"â€", u"â€˜", u"â€™"},
    { "fr_CA", u"Â«", u"Â»", u"â€", u"â€œ" },  // Apple data change
    { "de_CH", u"â€ž", u"â€œ", u"â€š", u"â€˜" },  // inherited from de
    { "es_MX", u"â€œ", u"â€", u"â€˜", u"â€™"}, // inherited from es_419
    { "es_US", u"â€œ", u"â€", u"â€˜", u"â€™"}, // rdar://75095012 (Apple data change)
    { "ja",    u"ã€Œ", u"ã€", u"ã€Ž", u"ã€"},
    { NULL,NULL,NULL,NULL,NULL }
#else
    { "fr_CA", u"Â«", u"Â»" }, // inherited from fr
    { "de_CH", u"â€ž", u"â€œ" }, // inherited from de
    { "es_MX", u"â€œ", u"â€" }, // inherited from es_419
    { "ja",    u"ã€Œ", u"ã€" },
    { NULL, NULL, NULL }
#endif  // APPLE_ICU_CHANGES
};
