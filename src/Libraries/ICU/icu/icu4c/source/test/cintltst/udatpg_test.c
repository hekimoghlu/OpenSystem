...
#endif  // APPLE_ICU_CHANGES
                  u"M/d/y, h:mm\u202Fa" } },
        { "fr", { u"EEEE d MMMM y 'Ã ' HH:mm", // medium != short
                  u"d MMMM y 'Ã ' HH:mm",
#if APPLE_ICU_CHANGES
// rdar://
                  u"d MMM y 'Ã ' HH:mm",
...
static void TestCountryFallback(void) {
    ...
    UChar* testData[] = {
        ...
        u"ru_Cyrl_BA", u"GyMMMM", u"LLLL y\u202F'Ð³'. G",
        // And these are just a few additional arbitrary combinations:
        u"ja_US", u"GyMMMM", u"Gyå¹´Mæœˆ",
        ...
        u"ar-SA@rg=uszzzz",              u"GyMMMMd", u"d MMMMØŒ y G",
        u"ar-SA@rg=uszzzz;numbers=latn", u"GyMMMMd", u"d MMMMØŒ y G",
        ...
        u"uk",    u"yMMMd", u"d MMM y\u202F'Ñ€'.", // rdar://70781056
...
static void TestRgSubtag(void) {
    ...
    const RgSubtagTest testCases[] = {
        { "es_MX",            u"yMdjmm", u"d/M/y, h:mmâ€¯a" }, // rdar://17705154
        { "es_419@rg=MXzzzz", u"yMdjmm", u"d/M/y, h:mmâ€¯a" }, // rdar://17705154
        { "en_MX",            u"yMdjmm", u"d/M/y, h:mmâ€¯a" }, // rdar://17705154
        { "es_ES",            u"yMdjmm", u"d/M/y, H:mm" },
        { "es_US",            u"yMdjmm", u"M/d/y, h:mmâ€¯a" },
        { "es_ES@rg=USzzzz",  u"yMdjmm", u"M/d/y, h:mmâ€¯a" },
        { "es_MX@rg=USzzzz",  u"yMdjmm", u"M/d/y, h:mmâ€¯a" },
...
static void TestISO8601(void) {
    ...
    const TestCase testCases[] = {
        { "en_GB@calendar=iso8601;rg=uszzzz", u"EEEEyMMMMdjmm", u"y MMMM d, EEEE 'at' h:mmâ€¯a" },
        { "en_GB@calendar=iso8601;rg=uszzzz", u"EEEEyMMMMdHmm", u"y MMMM d, EEEE 'at' HH:mm" },
        { "en_GB@calendar=iso8601;rg=uszzzz", u"Edjmm",         u"d, EEE, h:mmâ€¯a" },
        { "en_GB@calendar=iso8601;rg=uszzzz", u"EdHmm",         u"d, EEE, HH:mm" },

        { "en_US@calendar=iso8601",           u"EEEEyMMMMdjmm", u"y MMMM d, EEEE 'at' h:mmâ€¯a" },
        { "en_US@calendar=iso8601",           u"EEEEyMMMMdHmm", u"y MMMM d, EEEE 'at' HH:mm" },
        { "en_US@calendar=iso8601",           u"Edjmm",         u"d, EEE, h:mmâ€¯a" },
        { "en_US@calendar=iso8601",           u"EdHmm",         u"d, EEE, HH:mm" },

        { "en_US",                            u"EEEEyMMMMdjmm", u"EEEE, MMMM d, y 'at' h:mmâ€¯a" },
        { "en_US",                            u"EEEEyMMMMdHmm", u"EEEE, MMMM d, y 'at' HH:mm" },
#if APPLE_ICU_CHANGES
// rdar://
        { "en_US",                            u"Edjmm",         u"EEE d, h:mmâ€¯a" },
        { "en_US",                            u"EdHmm",         u"EEE d, HH:mm" },
#else
        { "en_US",                            u"Edjmm",         u"d EEE, h:mmâ€¯a" },
...
static void TestLongDayPeriodDefaults(void) {
    ...
    const TestCase testCases[] = {
        ...
        { "en_US",   u"jmm", u"h:mmâ€¯a", u"h:mmâ€¯a" },
        { "en_US",   u"Cmm", u"h:mmâ€¯a", u"h:mmâ€¯a" },
        { "en_US",   u"hmm", u"h:mmâ€¯a", u"h:mmâ€¯a" },
