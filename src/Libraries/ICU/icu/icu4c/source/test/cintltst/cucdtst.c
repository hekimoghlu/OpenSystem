...
TestAdditionalProperties(void) {
    ...
    // C API coverage
    if (u_stringHasBinaryProperty(u"â±", 1, UCHAR_BASIC_EMOJI) ||
            u_stringHasBinaryProperty(u"â±", -1, UCHAR_BASIC_EMOJI) ||
            !u_stringHasBinaryProperty(u"â±\uFE0F", 2, UCHAR_BASIC_EMOJI) ||
            !u_stringHasBinaryProperty(u"â±\uFE0F", -1, UCHAR_BASIC_EMOJI)) {
