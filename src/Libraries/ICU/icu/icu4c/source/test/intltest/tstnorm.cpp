...
BasicNormalizerTest::TestComposeUTF8WithEdits() {
    ...
    StringPiece expected = u8"  aÃ¤Ã¤áº¡\u0308áº¡\u0308,ê°€ê°ê°ƒ  ";
    std::string result;
    ...
    static const EditChange expectedChanges[] = {
        ...
        { true, 2, 2 },  // Ã„â†’Ã¤
        { true, 3, 2 },  // A\u0308â†’Ã¤
        { true, 7, 5 },  // A\u0308\u00ad\u0323â†’áº¡\u0308 removes the soft hyphen
        { true, 4, 5 },  // Ã„\u0323â†’áº¡\u0308
        { false, 1, 1 },  // comma
    ...
    // Omit unchanged text.
    expected = u8"aÃ¤Ã¤áº¡\u0308áº¡\u0308ê°€ê°ê°ƒ";
    result.clear();
    edits.reset();
    ...
    expected = u8"  AÃ¤A\u0308A\u0323\u0308áº¡\u0308,ê°€ê°ê°ƒ  ";
    result.clear();
    edits.reset();
    ...
    static const EditChange filteredChanges[] = {
        ...
        { true, 2, 2 },  // Ã„â†’Ã¤
        { false, 4, 4 },  // A\u0308A
        { true, 6, 4 },  // \u0308\u00ad\u0323â†’\u0323\u0308 removes the soft hyphen
        { true, 4, 5 },  // Ã„\u0323â†’áº¡\u0308
        { false, 1, 1 },  // comma
        { true, 2, 0 },  // U+00AD soft hyphen maps to empty
        { true, 6, 3 },  // \u1100\u1161â†’ê°€
...
BasicNormalizerTest::TestNormalizeIllFormedText() {
    ...
    src.append(static_cast<char16_t>(0xD800)).append(u"Ã„A\u0308").append(static_cast<char16_t>(0xD900)).
        append(u"A\u0308\u00ad\u0323").append(static_cast<char16_t>(0xDBFF)).
        append(u"Ã„\u0323,\u00ad").append(static_cast<char16_t>(0xDC00)).
        append(u"\u1100\u1161ê°€\u11A8ê°€\u3133  ").append(static_cast<char16_t>(0xDFFF));
    UnicodeString expected(u"  a");
    expected.append(static_cast<char16_t>(0xD800)).append(u"Ã¤Ã¤").append(static_cast<char16_t>(0xD900)).
        append(u"áº¡\u0308").append(static_cast<char16_t>(0xDBFF)).
        append(u"áº¡\u0308,").append(static_cast<char16_t>(0xDC00)).
        append(u"ê°€ê°ê°ƒ  ").append(static_cast<char16_t>(0xDFFF));
    ...
    src8.append("\x80").append(reinterpret_cast<const char*>(u8"Ã„A\u0308")).append("\xC0\x80").
        append(reinterpret_cast<const char*>(u8"A\u0308\u00ad\u0323")).append("\xED\xA0\x80").
        append(reinterpret_cast<const char*>(u8"Ã„\u0323,\u00ad")).append("\xF4\x90\x80\x80").
        append(reinterpret_cast<const char*>(u8"\u1100\u1161ê°€\u11A8ê°€\u3133  ")).append("\xF0");
    std::string expected8(reinterpret_cast<const char*>(u8"  a"));
    expected8.append("\x80").append(reinterpret_cast<const char*>(u8"Ã¤Ã¤")).append("\xC0\x80").
        append(reinterpret_cast<const char*>(u8"áº¡\u0308")).append("\xED\xA0\x80").
        append(reinterpret_cast<const char*>(u8"áº¡\u0308,")).append("\xF4\x90\x80\x80").
...
BasicNormalizerTest::TestComposeJamoTBase() {
    ...
    UnicodeString s(u"\u1100\u1161\u11A7\u1100\u314F\u11A7ê°€\u11A7");
    UnicodeString expected(u"ê°€\u11A7ê°€\u11A7ê°€\u11A7");
...
BasicNormalizerTest::TestNFKC_SCF() {
    ...
    UnicodeString s(u"aA\u0308 ÃŸáºž \u1F80\u1F88");
    UnicodeString expected(u"aÃ¤ ÃŸÃŸ \u1F80\u1F80");
