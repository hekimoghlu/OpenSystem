...
#if APPLE_ICU_CHANGES
// rdar://16482189&16567439 chinese calendar date formats: Use rU or r (not y), drop æ—¥ in zh formats
// rdar://
...
#if APPLE_ICU_CHANGES
// rdar://98584839 en_US: Compact date shown alongside inline widget shows â€œ12 Friâ€ instead of â€œFri 12â€
...
// rdar://
        ...
        u"AD1999/1",                         // 00: yM
#endif  // APPLE_ICU_CHANGES
        u"è¥¿æš¦1999å¹´1æœˆ",                     // 01: yMMM
        u"1999å¹´1æœˆ13æ—¥",                     // 02: yMd
        u"è¥¿æš¦1999å¹´1æœˆ13æ—¥",                  // 03: yMMMd
        u"1/13",                             // 04: Md
        u"1æœˆ13æ—¥",                           // 05: MMMd
        u"1æœˆ13æ—¥",                           // 06: MMMMd
        u"è¥¿æš¦1999/Q1",                       // 07: yQQQ
        u"åˆå¾Œ11:58",                         // 08: hhmm
        u"23:58",                            // 09: HHmm
        u"23:58",                            // 10: jjmm
        u"58:59",                            // 11: mmss
        u"è¥¿æš¦1999å¹´1æœˆ",                     // 12: yyyyMMMM
        u"1æœˆ13æ—¥(æ°´)",                       // 13: MMMEd
        u"13æ—¥(æ°´)",                          // 14: Ed
...
#if APPLE_ICU_CHANGES
// rdar://
        { "zh@calendar=chinese",  "yyyy",  u"Uå¹´",    UDATPG_MATCH_NO_OPTIONS },
        { "zh@calendar=chinese",  "YYYY",  u"Yå¹´",    UDATPG_MATCH_NO_OPTIONS }, // not a good result, may want r(Y) or r(U)
        { "zh@calendar=chinese",  "U",     u"Uå¹´",    UDATPG_MATCH_NO_OPTIONS },
#else
...
// rdar://
        ...
        {"ja_TRADITIONAL", u"Hæ™‚", u"H:mm", UDAT_HOUR_CYCLE_23},
    };
...
// rdar://
        ...
        { "fr", { UnicodeString(u"EEEE d MMMM y 'Ã ' HH:mm"), // medium != short
                  UnicodeString(u"d MMMM y 'Ã ' HH:mm"),
 #if APPLE_ICU_CHANGES
// rdar://
                 UnicodeString(u"d MMM y 'Ã ' HH:mm"),
#else
...
void IntlTestDateTimePatternGeneratorAPI::testISO8601() {
    ...
    for (int32_t i = 0; i < UPRV_LENGTHOF(localeIDs); i++) {
        ...
        if (pattern.indexOf(UnicodeString(u"â”œ")) >= 0 || pattern.indexOf(UnicodeString(u"Minute")) >= 0) {
        ...
        if (format.indexOf(UnicodeString(u"â”œ")) >= 0 || format.indexOf(UnicodeString(u"Minute")) >= 0) {
