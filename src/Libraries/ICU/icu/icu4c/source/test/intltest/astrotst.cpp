...
// rdar://
	static const double angle[] = {356.8493418421329, 356.8386760059673, 0.09625415252237701, 355.9986960782416, 3.5714026601303317, 124.26906744384183, /*53.50364630964228*/59.867652096146927,
    // (NOTE: Last value changed with rdar://136543653 -- not sure whether this is okay)
#else
...
double foo = got / (CalendarAstronomer::PI/180);
		//logln(testString);
