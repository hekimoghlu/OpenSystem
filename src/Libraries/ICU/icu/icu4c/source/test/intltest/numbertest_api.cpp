...
// rdar://
    ...
    assertFormatSingle(
            ...
            Locale("de-CH"),
            2.4,
            u"2.4\u00A0Kibijouleâ‹…Fuss pro Kubikgigafurlongâ‹…Quadratsekunde");
...
void NumberFormatterApiTest::unitInflections() {
    ...
    const char16_t *skeleton;
    {
        ...
        const UnitInflectionTestCase percentCases[] = {
            {"percent", "ru", nullptr, 10, u"10 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ð¾Ð²"},    // many
            {"percent", "ru", "genitive", 10, u"10 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ð¾Ð²"}, // many
            {"percent", "ru", nullptr, 33, u"33 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ð°"},     // few
            {"percent", "ru", "genitive", 33, u"33 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ð¾Ð²"}, // few
            {"percent", "ru", nullptr, 1, u"1 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚"},        // one
            {"percent", "ru", "genitive", 1, u"1 Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ð°"},    // one
        };
    ...
    }
    {
        ...
        const UnitInflectionTestCase testCases[] = {
            ...
            {"square-decimeter-dekameter", "de", nullptr, 1, u"1 Dekameterâ‹…Quadratdezimeter"},
            {"square-decimeter-dekameter", "de", "genitive", 1, u"1 Dekameterâ‹…Quadratdezimeter"},
            {"square-decimeter-dekameter", "de", nullptr, 2, u"2 Dekameterâ‹…Quadratdezimeter"},
            {"square-decimeter-dekameter", "de", "dative", 2, u"2 Dekameterâ‹…Quadratdezimeter"},
            // Feminine "Meile" better demonstrates singular-vs-plural form:
            {"cubic-mile-dekamile", "de", nullptr, 1, u"1 Dekameileâ‹…Kubikmeile"},
            {"cubic-mile-dekamile", "de", nullptr, 2, u"2 Dekameileâ‹…Kubikmeilen"},
            ...
            {"square-decimeter-square-second", "fr", nullptr, 1, u"1\u00A0dÃ©cimÃ¨tre carrÃ©-seconde carrÃ©e"},
            {"square-decimeter-square-second", "fr", nullptr, 2, u"2\u00A0dÃ©cimÃ¨tres carrÃ©s-secondes carrÃ©es"},
        };
...
// rdar://
    ...
    // TODO: look at "â†‘â†‘â†‘" cases: check that inheritance is done right.
}
...
void NumberFormatterApiTest::padding() {
    ...
    assertFormatDescending(
            ...
            Locale::getEnglish(),
            u"**ðŸ´ðŸ³,ðŸ²ðŸ±ðŸ¬",
            u"***ðŸ´,ðŸ³ðŸ²ðŸ±",
            u"***ðŸ´ðŸ³ðŸ².ðŸ±",
            u"***ðŸ´ðŸ³.ðŸ²ðŸ±",
            u"***ðŸ´.ðŸ³ðŸ²ðŸ±",
            u"**ðŸ¬.ðŸ´ðŸ³ðŸ²ðŸ±",
            u"*ðŸ¬.ðŸ¬ðŸ´ðŸ³ðŸ²ðŸ±",
            u"ðŸ¬.ðŸ¬ðŸ¬ðŸ´ðŸ³ðŸ²ðŸ±",
            u"*******ðŸ¬");
...
void NumberFormatterApiTest::signCoverage() {
    ...
    const struct TestCase {
        ...
        { UNUM_SIGN_AUTO, {        u"-âˆž", u"-1", u"-0",  u"0",  u"1",  u"âˆž",  u"NaN", u"-NaN" } },
        { UNUM_SIGN_ALWAYS, {      u"-âˆž", u"-1", u"-0", u"+0", u"+1", u"+âˆž", u"+NaN", u"-NaN" } },
        { UNUM_SIGN_NEVER, {        u"âˆž",  u"1",  u"0",  u"0",  u"1",  u"âˆž",  u"NaN",  u"NaN" } },
        { UNUM_SIGN_EXCEPT_ZERO, { u"-âˆž", u"-1",  u"0",  u"0", u"+1", u"+âˆž",  u"NaN",  u"NaN" } },
    };
...
void NumberFormatterApiTest::locale() {
    ...
    assertFormatSingle(
            ...
            2,
#if APPLE_ICU_CHANGES
// rdar:// ??? Apple changes ja.xml to omit the space
            u"2ãƒ¡ãƒ¼ãƒˆãƒ«");
#else
            u"2 ãƒ¡ãƒ¼ãƒˆãƒ«");
#endif // APPLE_ICU_CHANGES
...
void NumberFormatterApiTest::fieldPositionCoverage() {
...

    {
        ...
        FormattedNumber result = assertFormatSingle(
                ...
                68,
                u"ÑÐµÐºÑƒÐ½Ð´Ð°ÑÑ‹Ð½Ð° 68 Ð¼ÐµÑ‚Ñ€");
        static const UFieldPosition expectedFieldPositions[] = {
                // field, begin index, end index
...
// rdar://143383524 ([Numerals]?: BL: CrystalE22E190a: Suggesting to keep Western Arabic numerals (1,2,3...) as system default for Bangla instead of native numerals)
    FormattedNumber fn = NumberFormatter::withLocale("bn-BD-u-nu-beng")
#else
