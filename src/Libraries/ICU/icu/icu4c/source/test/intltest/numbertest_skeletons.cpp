...
void NumberSkeletonTest::invalidTokens() {
    static const char16_t* cases[] = {
            ...
            u".00/@@@+r",
            u".00/floor/@@+", // wrong order
            u"precision-increment/fran̤ais", // non-invariant characters for C++
            u"scientific/ee",
            ...
            u"scale/Infinity",
            u"scale/0.1.2",
            u"scale/fran̤ais", // non-invariant characters for C++
            u"currency/dummy",
            u"currency/̤̤̤", // three characters but not ASCII
            u"measure-unit/foo",
            u"integer-width/xxx",
            u"integer-width/0*",
            u"integer-width/*0#",
...
void NumberSkeletonTest::unknownTokens() {
    static const char16_t* cases[] = {
            ...
            u"fran̤ais",
            u"measure-unit/fran̤ais-fran̤ais", // non-invariant characters for C++
            u"numbering-system/fran̤ais", // non-invariant characters for C++
            u"currency-USD"};
