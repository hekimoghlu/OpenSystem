...
void IntlTestDecimalFormatSymbols::testNumberingSystem() {
    ...
    static const testcase cases[] = {
            ...
            {"en", "mathsanb", u"ðŸ­,ðŸ®ðŸ¯ðŸ°.ðŸ±ðŸ²", u"%"},
            {"en", "mymr", u"á,á‚áƒá„.á…á†", u"%"},
            {"my", "latn", u"1,234.56", u"%"},
            {"my", "arab", u"Ù¡Ù¬Ù¢Ù£Ù¤Ù«Ù¥Ù¦", u"Ùª\u061C"},
            {"my", "mathsanb", u"ðŸ­,ðŸ®ðŸ¯ðŸ°.ðŸ±ðŸ²", u"%"},
            {"my", "mymr", u"á,á‚áƒá„.á…á†", u"%"},
            {"ar", "latn", u"1,234.56", u"\u200E%\u200E"},
            {"ar", "arab", u"Ù¡Ù¬Ù¢Ù£Ù¤Ù«Ù¥Ù¦", u"Ùª\u061C"},
            {"en@numbers=thai", "mymr", u"á,á‚áƒá„.á…á†", u"%"}, // conflicting numbering system
    };
