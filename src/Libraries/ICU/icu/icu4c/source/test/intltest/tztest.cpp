...
void TimeZoneTest::TestCustomParse()
{
    ...
    kData[] =
    {
        ...
        {u"GMT-à¹‘à¹’",          (-((12*60)*60))}, // ICU-22637
        {u"GMT-à¹‘à¹’:à¹“à¹”",       (-((12*60+34)*60))}, // ICU-22637
        {u"GMT+à¹‘à¹’:à¹“à¹”:à¹•à¹–",    ((12*60+34)*60+56)}, // ICU-22637
        {nullptr, 0}
    };
...
#if APPLE_ICU_CHANGES
// Fix exclusion list to reflect the fact that in our current version of zomeinfo64.txt, Antarctica/Vostok is
// canonical version of Asia/Urumqi, rather than the other way around.
// NOTE: Neither zoneinfo64.txt nor tztest.cpp in this project match the current versions in OSICU-- we
// need to figure out how to solve this problem in the future.  See rdar://123871496 for more thoughts.
...
// rdar://
     ...
     // rdar://95729967
     {"Australia/Sydney",     "kk", FALSE, TimeZone::LONG,  "ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ñ‚Ñ‹ ÑˆÑ‹Ò“Ñ‹Ñ ÑƒÐ°Ò›Ñ‹Ñ‚Ñ‹"},
     {"Australia/Sydney",     "kk", TRUE,  TimeZone::LONG,  "ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ Ð¶Ð°Ð·Ò“Ñ‹ ÑˆÑ‹Ò“Ñ‹Ñ ÑƒÐ°Ò›Ñ‹Ñ‚Ñ‹"},
     {"Australia/Perth",      "kk", FALSE, TimeZone::LONG,  "ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ñ‚Ñ‹ Ð±Ð°Ñ‚Ñ‹Ñ ÑƒÐ°Ò›Ñ‹Ñ‚Ñ‹"},
     {"Australia/Perth",      "kk", TRUE,  TimeZone::LONG,  "ÐÑƒÑÑ‚Ñ€Ð°Ð»Ð¸Ñ Ð¶Ð°Ð·Ò“Ñ‹ Ð±Ð°Ñ‚Ñ‹Ñ ÑƒÐ°Ò›Ñ‹Ñ‚Ñ‹"},
#endif  // APPLE_ICU_CHANGES
