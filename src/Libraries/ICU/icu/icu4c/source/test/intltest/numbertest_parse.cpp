...
void NumberParserTest::testBasic() {
    ...
    static const struct TestCase {
        ...
        double expectedResultDouble;
                 ...
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"0", 10, 51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯x", u"0", 10, 51423.},
                 {3, u" ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"0", 11, 51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯ ", u"0", 10, 51423.},
                 ...
                 {7, u"51,423.5.", u"#,##,##0", 8, 51423.5},
                 {7, u"51,423.5..", u"#,##,##0", 8, 51423.5},
                 {7, u"ðŸ±ðŸ­,ðŸ°ðŸ®ðŸ¯", u"#,##,##0", 11, 51423.},
                 {7, u"ðŸ³,ðŸ´ðŸµ,ðŸ±ðŸ­,ðŸ°ðŸ®ðŸ¯", u"#,##,##0", 19, 78951423.},
                 {7, u"ðŸ³ðŸ´,ðŸµðŸ±ðŸ­.ðŸ°ðŸ®ðŸ¯", u"#,##,##0", 18, 78951.423},
                 {7, u"ðŸ³ðŸ´,ðŸ¬ðŸ¬ðŸ¬", u"#,##,##0", 11, 78000.},
                 {7, u"ðŸ³ðŸ´,ðŸ¬ðŸ¬ðŸ¬.ðŸ¬ðŸ¬ðŸ¬", u"#,##,##0", 18, 78000.},
                 {7, u"ðŸ³ðŸ´,ðŸ¬ðŸ¬ðŸ¬.ðŸ¬ðŸ®ðŸ¯", u"#,##,##0", 18, 78000.023},
                 {7, u"ðŸ³ðŸ´.ðŸ¬ðŸ¬ðŸ¬.ðŸ¬ðŸ®ðŸ¯", u"#,##,##0", 11, 78.},
                 {7, u"1,", u"#,##,##0", 1, 1.},
                 {7, u"1,,", u"#,##,##0", 1, 1.},
                 {7, u"1.,", u"#,##,##0", 2, 1.},
                 {3, u"1,.", u"#,##,##0", 3, 1.},
                 ...
                 {3, u"âˆž", u"0", 1, INFINITY},
                 {3, u"-âˆž", u"0", 2, -INFINITY},
                 ...
                 {3, u"a ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯ b", u"a0b", 14, 51423.},
                 {3, u"-a ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯ b", u"a0b", 15, -51423.},
                 {3, u"a -ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯ b", u"a0b", 15, -51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"[0];(0)", 10, 51423.},
                 {3, u"[ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"[0];(0)", 11, 51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯]", u"[0];(0)", 11, 51423.},
                 {3, u"[ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯]", u"[0];(0)", 12, 51423.},
                 {3, u"(ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"[0];(0)", 11, -51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯)", u"[0];(0)", 11, -51423.},
                 {3, u"(ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯)", u"[0];(0)", 12, -51423.},
                 {3, u"ðŸ±ðŸ­ðŸ°ðŸ®ðŸ¯", u"{0};{0}", 10, 51423.},
                 ...
                 {3, u"ðŸ±.ðŸ­ðŸ°ðŸ®EðŸ¯", u"0", 12, 5142.},
                 {3, u"ðŸ±.ðŸ­ðŸ°ðŸ®E-ðŸ¯", u"0", 13, 0.005142},
                 {3, u"ðŸ±.ðŸ­ðŸ°ðŸ®e-ðŸ¯", u"0", 13, 0.005142},
                 ...
                 {3, u"ðŸ“º1.23", u"ðŸ“º0;ðŸ“»0", 6, 1.23},
                 {3, u"ðŸ“»1.23", u"ðŸ“º0;ðŸ“»0", 6, -1.23},
                 {3, u".00", u"0", 3, 0.0},
