...
#if APPLE_ICU_CHANGES
// rdar://
        u"\u2068a\u2069ØŒ \u2068bbb\u2069ØŒ Ø§ÙˆØ± \u2068cc\u2069",
#else
        u"aØŒ bbbØŒ Ø§ÙˆØ± cc",
#endif  // APPLE_ICU_CHANGES
...
// rdar://
    ...
    struct TestCase {
        ...
        { es, ULISTFMT_TYPE_AND, u"fascinante e increÃ­blemente",
          u"fascinante",                     u"increÃ­blemente",       nullptr },
        { es, ULISTFMT_TYPE_AND, u"Comunicaciones Industriales e IIoT",
          u"Comunicaciones Industriales",    u"IIoT",                 nullptr },
        { es, ULISTFMT_TYPE_AND, u"EspaÃ±a e Italia",         u"EspaÃ±a",   u"Italia",      nullptr },
        { es, ULISTFMT_TYPE_AND, u"hijas intrÃ©pidas e hijos solidarios",
          u"hijas intrÃ©pidas",               u"hijos solidarios",     nullptr },
        ...
        { es, ULISTFMT_TYPE_AND, u"colÃ¡geno y hialurÃ³nico",  u"colÃ¡geno", u"hialurÃ³nico", nullptr },

        { es, ULISTFMT_TYPE_OR, u"desierto u oasis",         u"desierto", u"oasis",       nullptr },
        { es, ULISTFMT_TYPE_OR, u"oasis, desierto u ocÃ©ano", u"oasis",    u"desierto",    u"ocÃ©ano" },
...
#if APPLE_ICU_CHANGES
// rdar://
        { he, ULISTFMT_TYPE_AND, u"\u2068a\u2069, \u2068b\u2069 ×•-\u2068c\u2069", u"a", u"b", u"c" },
        { he, ULISTFMT_TYPE_AND, u"\u2068a\u2069 ×•-\u2068b\u2069",                u"a", u"b", nullptr },
#else
        { he, ULISTFMT_TYPE_AND, u"a, b ×•-c",               u"a",      u"b",      u"c" },
        { he, ULISTFMT_TYPE_AND, u"a ×•-b",                  u"a",      u"b",      nullptr },
#endif  // APPLE_ICU_CHANGES
        { he, ULISTFMT_TYPE_AND, u"1, 2 ×•-3",               u"1",      u"2",      u"3" },
        { he, ULISTFMT_TYPE_AND, u"1 ×•-2",                  u"1",      u"2",      nullptr },
        { he, ULISTFMT_TYPE_AND, u"××”×‘×” ×•×ž×§×•×•×”",            u"××”×‘×”",   u"×ž×§×•×•×”",  nullptr },
        { he, ULISTFMT_TYPE_AND, u"××”×‘×”, ×ž×§×•×•×” ×•××ž×•× ×”",     u"××”×‘×”",   u"×ž×§×•×•×”",  u"××ž×•× ×”" },
#if APPLE_ICU_CHANGES
// rdar://
        // rdar://64483589
        { th, ULISTFMT_TYPE_AND, u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²à¹à¸¥à¸° 1 à¸ à¸²à¸ž",                    u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  u"1 à¸ à¸²à¸ž",        nullptr },
        { th, ULISTFMT_TYPE_AND, u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²à¹à¸¥à¸°à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",               u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  nullptr },
        { th, ULISTFMT_TYPE_AND, u"0 à¹à¸¥à¸° 1 à¸ à¸²à¸ž",                              u"0",            u"1 à¸ à¸²à¸ž",        nullptr },
        { th, ULISTFMT_TYPE_AND, u"0 à¹à¸¥à¸°à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",                         u"0",           u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  nullptr },
        { th, ULISTFMT_TYPE_AND, u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¹à¸¥à¸°à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²" },
        { th, ULISTFMT_TYPE_AND, u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¹à¸¥à¸° 1 à¸ à¸²à¸ž",       u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  u"1 à¸ à¸²à¸ž" },
        { th, ULISTFMT_TYPE_OR,  u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¸«à¸£à¸·à¸­ 1 à¸ à¸²à¸ž",                     u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"1 à¸ à¸²à¸ž",        nullptr },
        { th, ULISTFMT_TYPE_OR,  u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¸«à¸£à¸·à¸­ à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",               u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²",  nullptr },
        { th, ULISTFMT_TYPE_OR,  u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸², à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸² à¸«à¸£à¸·à¸­ 1 à¸ à¸²à¸ž",       u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸˜à¸£à¸£à¸¡à¸”à¸²", u"1 à¸ à¸²à¸ž" },
#endif  // APPLE_ICU_CHANGES
    };
...
void ListFormatterTest::TestBidi() {
    UnicodeString arabicOne(u"Ø¨Ø¨Ø¨");
    UnicodeString arabicTwo(u"Ù„Ù„Ù„");
    UnicodeString arabicThree(u"Ø­Ø­Ø­");
    UnicodeString arabicFour(u"Ù…Ù…Ù…");
