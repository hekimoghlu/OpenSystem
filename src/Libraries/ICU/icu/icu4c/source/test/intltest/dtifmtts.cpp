...
#if APPLE_ICU_CHANGES
// rdar://
                 u"æ°‘åœ‹ 1/1/2 æ¸…æ™¨6æ™‚è‡³æ°‘åœ‹ 2/1/2 æ¸…æ™¨6æ™‚",
#else
                 u"æ°‘åœ‹1/1/2 ä¸Šåˆ6æ™‚\u2009\u2013\u2009æ°‘åœ‹2/1/2 ä¸Šåˆ6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"æ°‘åœ‹å‰ 1/1/2 æ¸…æ™¨6æ™‚è‡³æ°‘åœ‹ 2/1/2 æ¸…æ™¨6æ™‚",
#else
                 u"æ°‘åœ‹å‰1/1/2 ä¸Šåˆ6æ™‚\u2009\u2013\u2009æ°‘åœ‹2/1/2 ä¸Šåˆ6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"æ°‘åœ‹å‰ 2/1/2 æ¸…æ™¨6æ™‚è‡³æ°‘åœ‹å‰ 1/1/2 æ¸…æ™¨6æ™‚",
#else
                 u"æ°‘åœ‹å‰2/1/2 ä¸Šåˆ6æ™‚\u2009\u2013\u2009æ°‘åœ‹å‰1/1/2 ä¸Šåˆ6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);
}
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"R1/05/04 åˆå‰6æ™‚ï½žR1/06/05 åˆå‰6æ™‚",
#else
                 u"R1/5/4 åˆå‰6æ™‚ï½žR1/6/5 åˆå‰6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
    getCategoryAndField(formatted, expectedCategory,
                        expectedField, status);
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"H31/03/02 åˆå‰6æ™‚ï½žH31/04/03 åˆå‰6æ™‚",
#else
                 u"H31/3/2 åˆå‰6æ™‚ï½žH31/4/3 åˆå‰6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"H31/03/02 åˆå‰6æ™‚ï½žR1/05/04 åˆå‰6æ™‚",
#else
                 u"H31/3/2 åˆå‰6æ™‚ï½žR1/5/4 åˆå‰6æ™‚",
#endif  // APPLE_ICU_CHANGES
                 formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);
}
