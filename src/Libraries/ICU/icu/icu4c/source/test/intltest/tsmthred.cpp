...
TxThread::~TxThread() {}
void TxThread::run() {
    UnicodeString greekString(u"Î´Î¹Î±Ï†Î¿ÏÎµÏ„Î¹ÎºÎ¿ÏÏ‚");
    gSharedTranslit->transliterate(greekString);
    IntlTest::gTest->assertEquals(WHERE, UnicodeString(u"diaphoretikoÃºs"), greekString);
}
#endif
...
void MultithreadTest::TestBreakTranslit() {
    ...
    UnicodeString input(
        u"\u0E42\u0E14\u0E22\u0E1E\u0E37\u0E49\u0E19\u0E10\u0E32\u0E19\u0E41\u0E25\u0E49\u0E27,");
        // Thai script, à¹‚à¸”à¸¢à¸žà¸·à¹‰à¸™à¸à¸²à¸™à¹à¸¥à¹‰à¸§
