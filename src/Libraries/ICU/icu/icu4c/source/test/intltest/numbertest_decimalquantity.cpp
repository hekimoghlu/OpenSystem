...
void DecimalQuantityTest::testScientificAndCompactSuppressedExponent() {
    ...
    struct TestCase {
        ...
        {u"",              123456789, u"123â€¯456â€¯789",  123456789L, 123456789.0, u"123456789", 0, 0},
        {u"compact-long",  123456789, u"123 millions", 123000000L, 123000000.0, u"123000000", 6, 6},
        {u"compact-short", 123456789, u"123Â M",        123000000L, 123000000.0, u"123000000", 6, 6},
        {u"scientific",    123456789, u"1,234568E8",   123456800L, 123456800.0, u"123456800", 8, 8},

        {u"",              1234567, u"1â€¯234â€¯567",   1234567L, 1234567.0, u"1234567", 0, 0},
        {u"compact-long",  1234567, u"1,2 million", 1200000L, 1200000.0, u"1200000", 6, 6},
        {u"compact-short", 1234567, u"1,2Â M",       1200000L, 1200000.0, u"1200000", 6, 6},
        {u"scientific",    1234567, u"1,234567E6",  1234567L, 1234567.0, u"1234567", 6, 6},

        {u"",              123456, u"123â€¯456",   123456L, 123456.0, u"123456", 0, 0},
        {u"compact-long",  123456, u"123 mille", 123000L, 123000.0, u"123000", 3, 3},
        {u"compact-short", 123456, u"123Â k",     123000L, 123000.0, u"123000", 3, 3},
        ...
        {u"compact-short", 999.9, u"1Â k",       1000L, 1000.0, u"1000",  3, 3},
        {u"scientific",    999.9, u"9,999E2",   999L,  999.9,  u"999.9", 2, 2},

        {u"",              1000.0, u"1â€¯000",     1000L, 1000.0, u"1000", 0, 0},
        {u"compact-long",  1000.0, u"mille",     1000L, 1000.0, u"1000", 3, 3},
        {u"compact-short", 1000.0, u"1Â k",       1000L, 1000.0, u"1000", 3, 3},
