...
// rdar://
    ...
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,    "fr_CG", u"French (Congo - Brazzaville)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_VARIANT, "fr_CG", u"French (Congo [Republic])" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,    "en_SZ", u"English (Eswatini)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_VARIANT, "en_SZ", u"English (Swaziland)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,    "en_GB", u"English (UK)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_VARIANT, "en_GB", u"English (UK)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,    "fr_FR", u"French (France)" },
    { "en", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_VARIANT, "fr_FR", u"French (France)" },
    
    // Test for rdar://79109691 [Apple-specific]
    { "ja", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,    "en_GB", u"è‹±èªžï¼ˆã‚¤ã‚®ãƒªã‚¹ï¼‰" },
    
    // Test for rdar://79401338 [Apple-specific]
    { "ain", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,   "ain_Kana", u"ã‚¢ã‚¤ãƒŒãƒ»ã‚¤ã‚¿ã‡° (ã‚«ã‚¿ã‚«ãƒŠ)" },
    { "syr", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,         UDISPCTX_LENGTH_FULL,   "syr_Syrc", u"Ü£Ü˜ÜªÜÜÜ (Ü£Ü˜ÜªÜÜ¬)" },
    ...
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_HK", u"ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_HK", u"ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼»ä¸­å›½ï¼½ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_MO", u"ä¸­æ–‡ï¼ˆæ¾³é—¨ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_MO", u"ä¸­æ–‡ï¼ˆæ¾³é—¨ï¼»ä¸­å›½ï¼½ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_TW", u"ä¸­æ–‡ï¼ˆå°æ¹¾ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_TW", u"ä¸­æ–‡ï¼ˆå°æ¹¾ï¼»ä¸­å›½ï¼½ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_HK", u"ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_HK", u"ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼»ä¸­åœ‹ï¼½ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_MO", u"ä¸­æ–‡ï¼ˆæ¾³é–€ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_MO", u"ä¸­æ–‡ï¼ˆæ¾³é–€ï¼»ä¸­åœ‹ï¼½ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_TW", u"ä¸­æ–‡ï¼ˆå°ç£ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_TW", u"ä¸­æ–‡ï¼ˆå°ç£ï¼»ä¸­åœ‹ï¼½ï¼‰" },
    ...
    { "fr",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_TW", u"chinois (TaÃ¯wan)" },
    { "fr",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_TW", u"chinois (TaÃ¯wan)" },
    ...
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_CN", u"ä¸­æ–‡ï¼ˆä¸­å›½å¤§é™†ï¼‰" },
    { "zh",    UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_CN", u"ä¸­æ–‡ï¼ˆä¸­å›½ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_FULL,    "zh_CN", u"ä¸­æ–‡ï¼ˆä¸­åœ‹å¤§é™¸ï¼‰" },
    { "zh_TW", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,      UDISPCTX_LENGTH_PRC,     "zh_CN", u"ä¸­æ–‡ï¼ˆä¸­åœ‹ï¼‰" },
...
void LocaleDisplayNamesTest::TestNumericRegionID() {
    ...
    test_assert_equal(UnicodeString(u"AmÃ©rica"), UnicodeString(displayName));
    uldn_close(ldn);    
