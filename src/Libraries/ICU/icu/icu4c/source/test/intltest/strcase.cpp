...
StringCaseTest::TestTitleOptions() {
    ...
    TestCasingImpl(u"Ê»cAt! Ê»eTc.", u"Ê»Cat! Ê»etc.", TEST_TITLE,
                   nullptr, "", U_TITLECASE_WHOLE_STRING);
    TestCasingImpl(u"a Ê»CaT. A Ê»dOg! Ê»eTc.", u"A Ê»CaT. A Ê»dOg! Ê»ETc.", TEST_TITLE,
                   nullptr, "", U_TITLECASE_SENTENCES|U_TITLECASE_NO_LOWERCASE);
    TestCasingImpl(u"49eRs", u"49ers", TEST_TITLE,
                   nullptr, "", U_TITLECASE_WHOLE_STRING);
    TestCasingImpl(u"Â«ä¸°(aBc)Â»", u"Â«ä¸°(abc)Â»", TEST_TITLE,
                   nullptr, "", U_TITLECASE_WHOLE_STRING);
    TestCasingImpl(u"49eRs", u"49Ers", TEST_TITLE,
    ...
    TestCasingImpl(u"Â«ijsÂ»", u"Â«IJsÂ»", TEST_TITLE,
                   nullptr, "nl-BE", U_TITLECASE_WHOLE_STRING);
    TestCasingImpl(u"Â«ijsÂ»", u"Â«Ä°jsÂ»", TEST_TITLE,
...
void StringCaseTest::TestDutchTitle() {
    ...
    struct dutchTitleTestCase {
        ...
        {u"Ã¯jÌ",              u"ÃjÌ",             u"Ã"},
        {u"Ã­j\u0308",        u"Ãj\u0308",       u"Ã"},
        {u"Ã­jÌ\U0001D16E",    u"ÃjÌ\U0001D16E",   u"Ã"},
        {u"Ã­j\u1ABE",        u"Ãj\u1ABE",       u"Ã"},

        {u"ijabc",              u"IJabc",             u"IJ"},
        {u"IJabc",              u"IJabc",             u""},
        {u"Ã­jÌabc",              u"ÃJÌabc",             u"ÃJ"},
        {u"ÃJÌabc",              u"ÃJÌabc",             u""},
        {u"Ã­JÌabc",              u"ÃJÌabc",             u"Ã"},
        {u"IjÌabc",              u"IjÌabc",             u""},
        {u"ijÌabc",              u"IjÌabc",             u"I"},
        {u"Ã¯jÌabc",              u"ÃjÌabc",             u"Ã"},
        {u"Ã­jabc\u0308",        u"Ãjabc\u0308",       u"Ã"},
        {u"Ã­jÌabc\U0001D16E",    u"ÃJÌabc\U0001D16E",   u"ÃJ"},
        {u"Ã­jabc\u1ABE",        u"Ãjabc\u1ABE",       u"Ã"},
...
StringCaseTest::TestGreekUpper() {
    ...
    assertGreekUpper(u"Î¬Î´Î¹ÎºÎ¿Ï‚, ÎºÎµÎ¯Î¼ÎµÎ½Î¿, Î¯ÏÎ¹Î´Î±", u"Î‘Î”Î™ÎšÎŸÎ£, ÎšÎ•Î™ÎœÎ•ÎÎŸ, Î™Î¡Î™Î”Î‘");
    // https://bugzilla.mozilla.org/show_bug.cgi?id=307039
    // https://bug307039.bmoattachments.org/attachment.cgi?id=194893
    assertGreekUpper(u"Î Î±Ï„Î¬Ï„Î±", u"Î Î‘Î¤Î‘Î¤Î‘");
    assertGreekUpper(u"Î‘Î­ÏÎ±Ï‚, ÎœÏ…ÏƒÏ„Î®ÏÎ¹Î¿, Î©ÏÎ±Î¯Î¿", u"Î‘Î•Î¡Î‘Î£, ÎœÎ¥Î£Î¤Î—Î¡Î™ÎŸ, Î©Î¡Î‘Î™ÎŸ");
    assertGreekUpper(u"ÎœÎ±ÎÎ¿Ï…, Î ÏŒÏÎ¿Ï‚, Î¡ÏÎ¸Î¼Î¹ÏƒÎ·", u"ÎœÎ‘ÎªÎŸÎ¥, Î ÎŸÎ¡ÎŸÎ£, Î¡Î¥Î˜ÎœÎ™Î£Î—");
    assertGreekUpper(u"Î°, Î¤Î·ÏÏŽ, ÎœÎ¬Î¹Î¿Ï‚", u"Î«, Î¤Î—Î¡Î©, ÎœÎ‘ÎªÎŸÎ£");
    assertGreekUpper(u"Î¬Ï…Î»Î¿Ï‚", u"Î‘Î«Î›ÎŸÎ£");
    assertGreekUpper(u"Î‘Î«Î›ÎŸÎ£", u"Î‘Î«Î›ÎŸÎ£");
    assertGreekUpper(u"Î†ÎºÎ»Î¹Ï„Î± ÏÎ®Î¼Î±Ï„Î± Î® Î¬ÎºÎ»Î¹Ï„ÎµÏ‚ Î¼ÎµÏ„Î¿Ï‡Î­Ï‚", u"Î‘ÎšÎ›Î™Î¤Î‘ Î¡Î—ÎœÎ‘Î¤Î‘ Î‰ Î‘ÎšÎ›Î™Î¤Î•Î£ ÎœÎ•Î¤ÎŸÎ§Î•Î£");
    // http://www.unicode.org/udhr/d/udhr_ell_monotonic.html
    assertGreekUpper(u"Î•Ï€ÎµÎ¹Î´Î® Î· Î±Î½Î±Î³Î½ÏŽÏÎ¹ÏƒÎ· Ï„Î·Ï‚ Î±Î¾Î¹Î¿Ï€ÏÎ­Ï€ÎµÎ¹Î±Ï‚", u"Î•Î Î•Î™Î”Î— Î— Î‘ÎÎ‘Î“ÎÎ©Î¡Î™Î£Î— Î¤Î—Î£ Î‘ÎžÎ™ÎŸÎ Î¡Î•Î Î•Î™Î‘Î£");
    assertGreekUpper(u"Î½Î¿Î¼Î¹ÎºÎ¿Ï Î® Î´Î¹ÎµÎ¸Î½Î¿ÏÏ‚", u"ÎÎŸÎœÎ™ÎšÎŸÎ¥ Î‰ Î”Î™Î•Î˜ÎÎŸÎ¥Î£");
    // http://unicode.org/udhr/d/udhr_ell_polytonic.html
    assertGreekUpper(u"á¼˜Ï€ÎµÎ¹Î´á½´ á¼¡ á¼€Î½Î±Î³Î½á½½ÏÎ¹ÏƒÎ·", u"Î•Î Î•Î™Î”Î— Î— Î‘ÎÎ‘Î“ÎÎ©Î¡Î™Î£Î—");
    assertGreekUpper(u"Î½Î¿Î¼Î¹ÎºÎ¿á¿¦ á¼¢ Î´Î¹ÎµÎ¸Î½Î¿á¿¦Ï‚", u"ÎÎŸÎœÎ™ÎšÎŸÎ¥ Î‰ Î”Î™Î•Î˜ÎÎŸÎ¥Î£");
    // From Google bug report
    assertGreekUpper(u"ÎÎ­Î¿, Î”Î·Î¼Î¹Î¿Ï…ÏÎ³Î¯Î±", u"ÎÎ•ÎŸ, Î”Î—ÎœÎ™ÎŸÎ¥Î¡Î“Î™Î‘");
    // http://crbug.com/234797
    assertGreekUpper(u"Î•Î»Î¬Ï„Îµ Î½Î± Ï†Î¬Ï„Îµ Ï„Î± ÎºÎ±Î»ÏÏ„ÎµÏÎ± Ï€Î±ÏŠÎ´Î¬ÎºÎ¹Î±!", u"Î•Î›Î‘Î¤Î• ÎÎ‘ Î¦Î‘Î¤Î• Î¤Î‘ ÎšÎ‘Î›Î¥Î¤Î•Î¡Î‘ Î Î‘ÎªÎ”Î‘ÎšÎ™Î‘!");
    assertGreekUpper(u"ÎœÎ±ÎÎ¿Ï…, Ï„ÏÏŒÎ»ÎµÏŠ", u"ÎœÎ‘ÎªÎŸÎ¥, Î¤Î¡ÎŸÎ›Î•Îª");
    assertGreekUpper(u"Î¤Î¿ Î­Î½Î± Î® Ï„Î¿ Î¬Î»Î»Î¿.", u"Î¤ÎŸ Î•ÎÎ‘ Î‰ Î¤ÎŸ Î‘Î›Î›ÎŸ.");
    // http://multilingualtypesetting.co.uk/blog/greek-typesetting-tips/
    assertGreekUpper(u"ÏÏ‰Î¼Î­Î¹ÎºÎ±", u"Î¡Î©ÎœÎ•ÎªÎšÎ‘");
    assertGreekUpper(u"Î®.", u"Î‰.");

    // The á½‘Ï€Î¿Î³ÎµÎ³ÏÎ±Î¼Î¼Î­Î½Î±Î¹ become Î™ as in default case conversion, but they are
    // specially handled by the implementation.
    assertGreekUpper(u"á¾ Î´Î®, -Î®Î½, -á¿†Ï‚, -á¿‡", u"Î©Î™Î”Î—, -Î—Î, -Î—Î£, -Î—Î™");
    assertGreekUpper(u"á¾Î´Î·Ï‚", u"Î‘Î™Î”Î—Î£");
}
...
void StringCaseTest::TestArmenian() {
    ...
    assertEquals("upper root", u"ÔµÕ’ ÔµÕÔµÕ’Ô±Õ†Ô»", UnicodeString(s).toUpper(root));
    assertEquals("upper hy", u"ÔµÕŽ ÔµÕÔµÕŽÔ±Õ†Ô»", UnicodeString(s).toUpper(hy));
    assertEquals("upper hyw", u"ÔµÕ’ ÔµÕÔµÕ’Ô±Õ†Ô»", UnicodeString(s).toUpper(hyw));
#if !UCONFIG_NO_BREAK_ITERATION
...
void StringCaseTest::TestCaseMapWithEdits() {
    ...
    assertEquals(u"toLower(IstanBul)", UnicodeString(u"Ä±b"), UnicodeString(true, dest, length));
    ...
    length = CaseMap::toUpper("el", U_OMIT_UNCHANGED_TEXT,
                              u"Î Î±Ï„Î¬Ï„Î±", 6, dest, UPRV_LENGTHOF(dest), &edits, errorCode);
    assertEquals(u"toUpper(Î Î±Ï„Î¬Ï„Î±)", UnicodeString(u"Î‘Î¤Î‘Î¤Î‘"), UnicodeString(true, dest, length));
    ...
    TestUtility::checkEditsIter(*this, u"toUpper(Î Î±Ï„Î¬Ï„Î±)",
            edits.getFineIterator(), edits.getFineIterator(),
    ...
    length = CaseMap::fold(U_OMIT_UNCHANGED_TEXT | U_EDITS_NO_RESET | U_FOLD_CASE_EXCLUDE_SPECIAL_I,
                           u"IÃŸtanBul", 8, dest, UPRV_LENGTHOF(dest), &edits, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)", UnicodeString(u"Ä±ssb"), UnicodeString(true, dest, length));
    ...
    TestUtility::checkEditsIter(*this, u"foldCase(no Edits reset, IÃŸtanBul)",
            edits.getFineIterator(), edits.getFineIterator(),
...
void StringCaseTest::TestCaseMapUTF8WithEdits() {
    ...
    length = CaseMap::utf8Fold(U_OMIT_UNCHANGED_TEXT | U_EDITS_NO_RESET |
                               ...
                               reinterpret_cast<const char*>(u8"IÃŸtanBul"), 1 + 2 + 6,
                               dest, UPRV_LENGTHOF(dest), &edits, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)", UnicodeString(u"Ä±ssb"),
                 UnicodeString::fromUTF8(StringPiece(dest, length)));
    static const EditChange foldExpectedChanges[] = {
#if !UCONFIG_NO_BREAK_ITERATION
            // From titlecasing.
    ...
    TestUtility::checkEditsIter(*this, u"foldCase(IÃŸtanBul)",
            edits.getFineIterator(), edits.getFineIterator(),
            foldExpectedChanges, UPRV_LENGTHOF(foldExpectedChanges),
            true, errorCode);
}
...
void StringCaseTest::TestCaseMapToString() {
    ...
    assertEquals(u"toLower(IstanBul)",
                 UnicodeString(u"Ä±b"), UnicodeString(true, dest, length));
    length = CaseMap::toUpper("el", U_OMIT_UNCHANGED_TEXT,
                              u"Î Î±Ï„Î¬Ï„Î±", 6, dest, UPRV_LENGTHOF(dest), nullptr, errorCode);
    assertEquals(u"toUpper(Î Î±Ï„Î¬Ï„Î±)",
                 UnicodeString(u"Î‘Î¤Î‘Î¤Î‘"), UnicodeString(true, dest, length));
#if !UCONFIG_NO_BREAK_ITERATION
    length = CaseMap::toTitle("nl",
                              U_OMIT_UNCHANGED_TEXT |
                              U_TITLECASE_NO_BREAK_ADJUSTMENT |
    ...
    length = CaseMap::fold(U_OMIT_UNCHANGED_TEXT | U_FOLD_CASE_EXCLUDE_SPECIAL_I,
                           u"IÃŸtanBul", 8, dest, UPRV_LENGTHOF(dest), nullptr, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)",
                 UnicodeString(u"Ä±ssb"), UnicodeString(true, dest, length));

    // Return the whole result string.
    length = CaseMap::toLower("tr", 0,
                              u"IstanBul", 8, dest, UPRV_LENGTHOF(dest), nullptr, errorCode);
    assertEquals(u"toLower(IstanBul)",
                 UnicodeString(u"Ä±stanbul"), UnicodeString(true, dest, length));
    length = CaseMap::toUpper("el", 0,
                              u"Î Î±Ï„Î¬Ï„Î±", 6, dest, UPRV_LENGTHOF(dest), nullptr, errorCode);
    assertEquals(u"toUpper(Î Î±Ï„Î¬Ï„Î±)",
                 UnicodeString(u"Î Î‘Î¤Î‘Î¤Î‘"), UnicodeString(true, dest, length));
#if !UCONFIG_NO_BREAK_ITERATION
    length = CaseMap::toTitle("nl",
                              U_TITLECASE_NO_BREAK_ADJUSTMENT |
                              U_TITLECASE_NO_LOWERCASE,
    ...
    length = CaseMap::fold(U_FOLD_CASE_EXCLUDE_SPECIAL_I,
                           u"IÃŸtanBul", 8, dest, UPRV_LENGTHOF(dest), nullptr, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)",
                 UnicodeString(u"Ä±sstanbul"), UnicodeString(true, dest, length));
}
...
void StringCaseTest::TestCaseMapUTF8ToString() {
    ...
    CaseMap::utf8Fold(U_OMIT_UNCHANGED_TEXT | U_FOLD_CASE_EXCLUDE_SPECIAL_I,
                      u8"IÃŸtanBul", sink, nullptr, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)", UnicodeString(u"Ä±ssb"),
                 UnicodeString::fromUTF8(dest));
...
#endif
    dest.clear();
    CaseMap::utf8Fold(U_FOLD_CASE_EXCLUDE_SPECIAL_I, u8"IÃŸtanBul", sink, nullptr, errorCode);
    assertEquals(u"foldCase(IÃŸtanBul)", UnicodeString(u"Ä±sstanbul"),
                 UnicodeString::fromUTF8(dest));
}
...
void StringCaseTest::TestInPlaceTitle() {
    ...
    char16_t s[32] = u"ÃŸ ÃŸ ÃŸæ—¥æœ¬èªž abcdef";
    const char16_t *expected = u"Ss Ss Ssæ—¥æœ¬èªž Abcdef";
...
void StringCaseTest::TestCaseMapEditsIteratorDocs() {
    ...
    const char16_t* input = u"abcÃŸDeF";
    ...
    static const char16_t* fineIteratorExpected[] = {
            u"{ src[0..3] â‰¡ dest[0..3] (no-change) }",
            u"{ src[3..4] â‡ dest[3..5], repl[0..2] }",
            u"{ src[4..5] â‡ dest[5..6], repl[2..3] }",
            u"{ src[5..6] â‰¡ dest[6..7] (no-change) }",
            u"{ src[6..7] â‡ dest[7..8], repl[3..4] }",
    };
