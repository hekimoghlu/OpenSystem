...
DateFormatTest::TestLocaleDateFormat() // Bug 495
{
    ...
    UnicodeString expectedFRENCH ( u"lundi 15 septembre 1997 Ã  00:00:00 heure dâ€™Ã©tÃ© du Pacifique nord-amÃ©ricain", -1 );
...
void DateFormatTest::TestRelative()
{
    ...
    TestRelative(-1, ur, "Ú©Ù„"); // yesterday
    TestRelative(-2, ur, "Ù¾Ø±Ø³ÙˆÚº"); // day before yesterday
    // "tomorrow" and "day after tomorrow" should use consistent term for "future"
    TestRelative(+1, ur, "Ø¢Ø¦Ù†Ø¯Û Ú©Ù„"); // tomorrow
    TestRelative(+2, ur, "Ø¢Ø¦Ù†Ø¯Û Ù¾Ø±Ø³ÙˆÚº"); // day after tomorrow
#endif // APPLE_ICU_CHANGES
}
...
#if APPLE_ICU_CHANGES
// rdar://
        { "zh@calendar=chinese",      DateFormat::kLong, CharsToUnicodeString("rU\\u5E74MMMd"), CharsToUnicodeString("2015\\u4E59\\u672A\\u5E74\\u51AC\\u6708\\u5EFF\\u4E00") }, // "2015ä¹™æœªå¹´å†¬æœˆå»¿ä¸€"
        { "zh_Hant@calendar=chinese", DateFormat::kLong, CharsToUnicodeString("rU\\u5E74MMMd"), CharsToUnicodeString("2015\\u4E59\\u672A\\u5E74\\u51AC\\u6708\\u5EFF\\u4E00") }, // "2015ä¹™æœªå¹´å†¬æœˆå»¿ä¸€"
        { "ja@calendar=chinese", DateFormat::kLong, CharsToUnicodeString("U\\u5E74MMMd\\u65E5"), CharsToUnicodeString("\\u4E59\\u672A\\u5E74\\u5341\\u4E00\\u6708\\u4E8C\\u5341\\u4E00\\u65E5") }, // "ä¹™æœªå¹´åä¸€æœˆäºŒåä¸€æ—¥"
#else
...
// (also see https://unicode-org.atlassian.net/browse/CLDR-17484 English day periods are wrong)
    ...
    sdf.applyPattern(UnicodeString("hh:mm:ss BBBB"));
    assertEquals("hh:mm:ss BBBB | 01:00:00 | es_CO", u"01:00:00 de la maÃ±ana",
        sdf.format(k010000, out.remove()));
...
void DateFormatTest::TestHourCycle() {
    ...
    static const struct {
        ...
        { "en-us", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
#if APPLE_ICU_CHANGES
// rdar://
        { "en-ca", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
#else
        { "en-ca", u"Tuesday, March 16, 1943 at 3:45:32â€¯p.m." },
#endif
        { "en-gb", u"Tuesday, 16 March 1943 at 15:45:32" },
        { "en-au", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" },
        // test a couple locales for which we don't have specific locale files (we should still get the correct hour cycle)
        { "en-co", u"Tuesday, 16 March 1943 at 3:45:32â€¯PM" },
        { "en-mx", u"Tuesday, 16 March 1943 at 3:45:32â€¯p.m." },
...
// but probably can't without breaking rdar://112976115.  This needs more thought! --rtg 1/3/24
        ...
        { "en-us-u-rg-cazzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
        { "en-ca-u-rg-uszzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
        ...
        { "en-gb-u-rg-auzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" }, // rdar://123446235
#else
        { "en-us-u-rg-gbzzzz", u"Tuesday, March 16, 1943 at 15:45:32" },
        { "en-us-u-rg-cazzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
        { "en-ca-u-rg-uszzzz", u"Tuesday, March 16, 1943 at 3:45:32â€¯p.m." },
        { "en-gb-u-rg-uszzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" },
        { "en-gb-u-rg-cazzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" },
        { "en-gb-u-rg-auzzzz", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" },
#endif // APPLE_ICU_CHANGES
        // test that the hc ("hours") subtag does the right thing
        { "en-us-u-hc-h23", u"Tuesday, March 16, 1943 at 15:45:32" },
        { "en-gb-u-hc-h12", u"Tuesday, 16 March 1943 at 3:45:32â€¯pm" },
...
#else
        { "en-us-u-rg-gbzzzz-hc-h12", u"Tuesday, March 16, 1943 at 3:45:32â€¯PM" },
