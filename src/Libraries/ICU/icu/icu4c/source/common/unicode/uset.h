...
enum {
     ...
     * closure over case mappings, e.g. 'Å¿' (U+017F long s) for 's'.
     *
     ...
     *
     * Unlike the â€œcase insensitiveâ€ options, this does not perform a closure.
     * For example, it does not add 'Å¿' (U+017F long s) for 's',
 ...
 * In order to achieve a â€œcode point complementâ€ (all code points minus this set),
