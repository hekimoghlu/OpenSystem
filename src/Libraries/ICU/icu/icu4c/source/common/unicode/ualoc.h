 ...
 *
 *                                 en_US â†’ en â†’ root;
 *                en_HK â†’ en_GB â†’ en_001 â†’ en â†’ root;
 *                en_IN â†’ en_GB â†’ en_001 â†’ en â†’ root;
 *                                 es_ES â†’ es â†’ root;
 *                        es_MX â†’ es_419 â†’ es â†’ root;
 *                                        haw â†’ root;
 *                                 pt_BR â†’ pt â†’ root;
 *                                 pt_PT â†’ pt â†’ root;
 *                               sr_Cyrl â†’ sr â†’ root;
 *                                    sr_Latn â†’ root;
 *                       zh_Hans â†’ zh â†’ zh_CN â†’ root;
 *  zh_Hant_MO â†’ zh_Hant_HK â†’ zh_Hant â†’ zh_TW â†’ root;
 *       zh_HK â†’ zh_Hant_HK â†’ zh_Hant â†’ zh_TW â†’ root;
 *                                       root â†’ root;
 *                                        tlh â†’ root;
 *
 ...
 *
 *  --------
 *  lproj sets â†’    list1       list2       list3       list4       list5        list6
