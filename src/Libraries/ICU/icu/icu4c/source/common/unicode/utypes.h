...
#if APPLE_ICU_CHANGES
// rdar://30624081 64b8ed9b89.. Add #if U_SHOW_CPLUSPLUS_API..#endif around C++ interfaces that donâ€™t have it
 ...
 */ 
#if APPLE_ICU_CHANGES
// rdar://9390182 45b2490fc2.. Fix #8093 - #incude â€œfloat.hâ€ incorrectly added for DBL_MAX, use explicit number for now
// rdar://10040518 2ca6a7de75.. Refine previous fix to use platform conditionals
#if U_PLATFORM!=U_PF_IPHONE
