...
// rdar://51601250 08f73497e6.. Numbers-specific fix, if applyPattern â€œ#.##E+00;-#.##E+00â€, make it â€œ0.##E+00â€
...
PatternStringUtils::convertLocalized(const UnicodeString& input, const DecimalFormatSymbols& symbols,
    ...
    // Substitute them with 'â€™' instead.
    for (int32_t i = 0; i < LEN; i++) {
        table[i][localIdx].findAndReplace(u'\'', u'â€™');
    }
