...
void AlphabeticIndex::addIndexExemplars(const Locale &locale, UErrorCode &status) {
    ...
    if (exemplars.containsSome(0x1200, 0x137F)) {  // Ethiopic block
        ...
        // the base is 0 mod 8.
        UnicodeSet ethiopic(UnicodeString(u"[áˆ€áˆˆáˆáˆ˜áˆ áˆ¨áˆ°áˆ¸á‰€á‰ˆá‰á‰˜á‰ á‰¨á‰°á‰¸áŠ€áŠˆáŠáŠ˜áŠ áŠ¨áŠ°áŠ¸á‹€á‹ˆá‹á‹˜á‹ á‹¨á‹°á‹¸áŒ€áŒˆáŒáŒ˜áŒ áŒ¨áŒ°áŒ¸á€áˆáá˜]"), status);
        ethiopic.retainAll(exemplars);
        exemplars.remove(u'áˆ€', 0x137F).addAll(ethiopic);
    }
