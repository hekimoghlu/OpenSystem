...
// rdar://116185298 (D74/21C15: Arabic numerals (1,2,3..) should be set as default when language of device is changed to Arabic instead of Arabic-Indic numerals (Ù£ØŒÙ¢ØŒÙ¡))
...
#if APPLE_ICU_CHANGES
// rdar://116185298 (D74/21C15: Arabic numerals (1,2,3..) should be set as default when language of device is changed to Arabic instead of Arabic-Indic numerals (Ù£ØŒÙ¢ØŒÙ¡))
// Additional changes for rdar://130919763 (CrystalSeed â˜‚: Mr Investment (æŠ•è³‡å…ˆç”Ÿ) Crashes on launch 1382114621)
