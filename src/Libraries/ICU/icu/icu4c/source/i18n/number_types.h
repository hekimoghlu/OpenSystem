...
enum AffixPatternType {
    ...
    // Represents a permille sign symbol 'â€°'.
            TYPE_PERMILLE = -5,

    // Represents a single currency symbol 'Â¤'.
            TYPE_CURRENCY_SINGLE = -6,

    // Represents a double currency symbol 'Â¤Â¤'.
            TYPE_CURRENCY_DOUBLE = -7,

    // Represents a triple currency symbol 'Â¤Â¤Â¤'.
            TYPE_CURRENCY_TRIPLE = -8,

    // Represents a quadruple currency symbol 'Â¤Â¤Â¤Â¤'.
            TYPE_CURRENCY_QUAD = -9,

    // Represents a quintuple currency symbol 'Â¤Â¤Â¤Â¤Â¤'.
