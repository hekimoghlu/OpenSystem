...
typedef enum UNumberRangeCollapse {
    ...
    /**
     * Do not collapse any part of the number. Example: "3.2 thousand kilograms â€“ 5.3 thousand kilograms"
     *
     * @stable ICU 63
     */
    ...
    /**
     * Collapse the unit part of the number, but not the notation, if present. Example: "3.2 thousand â€“ 5.3 thousand
     * kilograms"
     *
     * @stable ICU 63
     */
     ...
     * number. Example: "3.2 â€“ 5.3 thousand kilograms"
     *
     * @stable ICU 63
     */
...
typedef enum UNumberRangeIdentityFallback {
     ...
     * same. Example (with RangeCollapse.NONE): "$5 â€“ $5"
     *
     * @stable ICU 63
     */
