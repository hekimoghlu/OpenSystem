 ...
 * UChar* str1 = (UChar*) u"A1\u05D0";  // A1×
 * UChar* str2 = (UChar*) u"A\u05D01";  // A×1
 *
 * USpoofChecker* sc = uspoof_open(&status);
 * uspoof_setChecks(sc, USPOOF_CONFUSABLE, &status);
 *
 ...
 * <ul>
 * <li>
 * The usernames "A1×" (A one aleph) and "A×1" (A aleph 1)
 * would be considered confusable, since they both appear as \@A1× in a left-to-right context, and the
 * usernames "×A_1" (aleph A underscore one) and "×1_A" (aleph one underscore A) would be considered
 * confusable, since they both appear as A_1×@ in a right-to-left context.
 * </li>
 * <li>
...
typedef enum USpoofChecks {
     ...
     * <li>Dotless 'i' and 'j' ('Ä±' and 'È·', U+0131 and U+0237)</li>
     * <li>Any character whose confusable prototype ends with such a character
     * (Soft_Dotted, 'l', 'Ä±', or 'È·')</li>
     * </ul>
