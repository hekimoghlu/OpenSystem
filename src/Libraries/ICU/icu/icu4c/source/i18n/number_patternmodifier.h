...
class U_I18N_API MutablePatternModifier
  ...
  public:
     ...
     * @param rules
     *            Required if the triple currency sign, "Â¤Â¤Â¤", appears in the pattern, which can be determined from the
     ...
     *            currency sign, "Â¤Â¤Â¤" (and as indicated by {@link #needsPlurals()}).
     */
     ...
     * This is currently true only if there is a currency long name placeholder in the pattern ("Â¤Â¤Â¤").
     */
