...
public:
    ...
    static int64_t  get64(const int64_t& from)              INLINE { return OSReadLittleInt64(&from, 0); }
    static void     set64(int64_t& into, int64_t value)     INLINE { OSWriteLittleInt64(&into, 0, value); }
