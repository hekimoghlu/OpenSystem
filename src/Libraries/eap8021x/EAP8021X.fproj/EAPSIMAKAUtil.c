...
TLVCheckValidity(TLVListRef tlvs_p, TLVRef tlv_p)
{
	...
	break;
    default:
	ret = (tlv_p->tlv_type > kAT_MAX) ? kTLVBad : kTLVUnrecognized;
	break;
    }
    return (ret);
}
...
const uint8_t	aka_challenge_unrecognized_skippable_valid_attr[] = {
    /* EAP-Request/AKA-Challenge with malformed attributes */
    0x01, /* Code=Request*/
    0x01, /* Identifier=1 */
    0x00, 0xb8, /* length=184 */
    0x17, /* EAP-AKA */
    0x01, /* AKA-Challenge */
    0x00, 0x00, /* Reserved */
    /* attrs */
    0x8c, /* Attribute Type=140 i.e. unrecognized and skippable */
    0x13,
    0x00, 0x4a,
    0x77, 0x38, 0x77, 0x34, 0x39, 0x50, 0x65, 0x78, 0x43, 0x61, 0x7a, 0x57, 0x4a, 0x26, 0x78, 0x43,
    0x49, 0x41, 0x52, 0x6d, 0x78, 0x75, 0x4d, 0x4b, 0x68, 0x74, 0x35, 0x53, 0x31, 0x73, 0x78, 0x52,
...
const uint8_t	aka_challenge_unrecognized_skippable_invalid_attr[] = {
    /* EAP-Request/AKA-Challenge with malformed attributes */
    0x01, /* Code=Request*/
    0x01, /* Identifier=1 */
    0x00, 0xb8, /* length=184 */
...
const uint8_t	aka_challenge_valid_attr[] = {
    /* EAP-Request/AKA-Challenge with well-formed attributes */
    0x01, /* Code=Request*/
    0x01, /* Identifier=1 */
    0x00, 0xb8, /* length=184 */
    0x17, /* EAP-AKA */
    ...
    0x00, 0x00,
    /* attrs */
    0x84, /* Attribuye type=AT_NEXT_PSEUDONYM */
    0x13,
    0x00, 0x46,
    0x77, 0x38, 0x77, 0x34, 0x39, 0x50, 0x65, 0x78, 0x43, 0x61, 0x7a, 0x57, 0x4a, 0x26, 0x78, 0x43,
    0x49, 0x41, 0x52, 0x6d, 0x78, 0x75, 0x4d, 0x4b, 0x68, 0x74, 0x35, 0x53, 0x31, 0x73, 0x78, 0x52,
    ...
    0x65, 0x4a, 0x4f, 0x55, 0x31, 0x47,
    0x00, 0x00,
    0x85, /* Attribuye type=AT_NEXT_REAUTH_ID */
    0x16,
    0x00, 0x51,
    0x59, 0x32, 0x34, 0x66, 0x4e, 0x53, 0x72, 0x7a, 0x38, 0x42, 0x50, 0x32, 0x37, 0x34, 0x6a, 0x4f,
    0x4a, 0x61, 0x46, 0x31, 0x37, 0x57, 0x66, 0x78, 0x49, 0x38, 0x59, 0x4f, 0x37, 0x51, 0x58, 0x30,
...
struct {
    ...
    { aka_challenge_unrecognized_skippable_valid_attr, sizeof(aka_challenge_unrecognized_skippable_valid_attr), TRUE, "aka_challenge_unrecognized_skippable_valid_attr" },
    { aka_challenge_unrecognized_skippable_invalid_attr, sizeof(aka_challenge_unrecognized_skippable_invalid_attr), FALSE, "aka_challenge_unrecognized_skippable_invalid_attr" },
    { aka_challenge_valid_attr, sizeof(aka_challenge_valid_attr), TRUE, "aka_challenge_valid_attr" },
    { NULL, 0 }
};
...
main(int argc, char * argv[])
{
	...
	printf("<======= completed test %d '%s' %s (found%serrors) ========>\n", i,
	       packets[i].name,
