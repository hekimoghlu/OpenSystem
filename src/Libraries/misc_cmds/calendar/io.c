...
/* Close enough for our purposes; just a bit heavier than we might need. */
#ifndef O_PATH
#define	O_PATH	O_SEARCH
#endif

/* Mirrors libutil's getlocalbase(3) implementation, mostly */
...
getlocalbase(void)
{
	...
	/* setugid or LOCALBASE isn't set */
