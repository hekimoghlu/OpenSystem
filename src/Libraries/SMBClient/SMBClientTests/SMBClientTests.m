...
-(void)testNetBIOSNameConversion
{
    static const struct {
        ...
        //{ CFSTR("jÃ¥mes"), CFSTR("JAMES") }, /* Unknown failure */
        //{ CFSTR("iPadÃ¦Ã¸Ã¥Ã½Ãë§ŒëŒ"), CFSTR("IPADAYMANDOL") }, /* Unknown failure */
     ...
     * Debugging code to try to figure out why CFSTR("jÃ¥mes") and
     * CFSTR("iPadÃ¦Ã¸Ã¥Ã½Ãë§ŒëŒ").
     *
