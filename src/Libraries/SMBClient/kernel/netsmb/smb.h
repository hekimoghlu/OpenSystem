 ...
 *
 * For SMB 1, this field is filled in by the NTCreateX, but for SMB 2/3, its 
 * filled in manually by SMB 2. For SMB 2/3, the kNO_FINDERINFO and kNO_RSRCFORK
 * were defined
 */
...
/* SMB 2/3 Usage Only */
#define kNO_FINDERINFO  0x0010
#define kNO_RSRCFORK    0x0020
...
#define SMB_EFA_RECALL_ON_DATA_OPEN 0x00040000
#define SMB_EFA_RECALL_ON_DATA_ACCESS 0x00400000
