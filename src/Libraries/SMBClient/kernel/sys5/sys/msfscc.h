...
#define IO_REPARSE_TAG_RESERVED_ONE     0x00000001          /* unused */
#define IO_REPARSE_TAG_MOUNT_POINT      0xA0000003          /* unused */
#define IO_REPARSE_TAG_HSM              0xC0000004          /* unused */
#define IO_REPARSE_TAG_HSM2             0x80000006          /* unused */
#define IO_REPARSE_TAG_DRIVER_EXTENDER  0x80000005          /* unused */
#define IO_REPARSE_TAG_SIS              0x80000007          /* unused */
#define IO_REPARSE_TAG_DFS              0x8000000A
#define IO_REPARSE_TAG_DFSR             0x80000012          /* unused */
 ...
 * File Attributes of SMB_EFA_REPARSE_POINT and SMB_EFA_OFFLINE
 *
 * If the file is offline and its a reparse point, the create request is sent
 * without setting NTCREATEX_OPTIONS_OPEN_REPARSE_POINT in the create options
 * to try to force the file to be retrieved.
 *
 * If the file is online and its a reparse point, the create request is sent
 * with NTCREATEX_OPTIONS_OPEN_REPARSE_POINT set in the create options.
 *
 * Azure Tiered Files has several file attributes that can be set.
 * If a file is fully tiered or partially recalled, then SMB_EFA_SPARSE,
 * SMB_EFA_REPARSE_POINT and SMB_EFA_OFFLINE will be set. Once the file is
 * fully recalled, then all three attributes will be cleared and it becomes
 * a normal file.
 */
