...
#   define DG_START_LATIN 0xa1
	...
	{'A', '!', 0xc0},
	{'A', '`', 0xc0},	// Ã€ Vim 5.x compatible
	{'A', '\'', 0xc1},
	{'A', '>', 0xc2},
	{'A', '^', 0xc2},	// Ã‚ Vim 5.x compatible
	{'A', '?', 0xc3},
	{'A', '~', 0xc3},	// Ãƒ Vim 5.x compatible
	{'A', ':', 0xc4},
	{'A', '"', 0xc4},	// Ã„ Vim 5.x compatible
	{'A', 'A', 0xc5},
	{'A', '@', 0xc5},	// Ã… Vim 5.x compatible
	{'A', 'E', 0xc6},
	{'C', ',', 0xc7},
	{'E', '!', 0xc8},
	{'E', '`', 0xc8},	// Ãˆ Vim 5.x compatible
	{'E', '\'', 0xc9},
	{'E', '>', 0xca},
	{'E', '^', 0xca},	// ÃŠ Vim 5.x compatible
	{'E', ':', 0xcb},
	{'E', '"', 0xcb},	// Ã‹ Vim 5.x compatible
	{'I', '!', 0xcc},
	{'I', '`', 0xcc},	// ÃŒ Vim 5.x compatible
	{'I', '\'', 0xcd},
	{'I', '>', 0xce},
	...
	{'D', '-', 0xd0},
	{'N', '?', 0xd1},
	{'N', '~', 0xd1},	// Ã‘ Vim 5.x compatible
	{'O', '!', 0xd2},
	{'O', '`', 0xd2},	// Ã’ Vim 5.x compatible
	{'O', '\'', 0xd3},
	{'O', '>', 0xd4},
	{'O', '^', 0xd4},	// Ã” Vim 5.x compatible
	{'O', '?', 0xd5},
	{'O', '~', 0xd5},	// Ã• Vim 5.x compatible
	{'O', ':', 0xd6},
	{'*', 'X', 0xd7},
	{'/', '\\', 0xd7},	// Ã— Vim 5.x compatible
	{'O', '/', 0xd8},
	{'U', '!', 0xd9},
	{'U', '`', 0xd9},	// Ã™ Vim 5.x compatible
	{'U', '\'', 0xda},
	{'U', '>', 0xdb},
	{'U', '^', 0xdb},	// Ã› Vim 5.x compatible
	{'U', ':', 0xdc},
	{'Y', '\'', 0xdd},
	{'T', 'H', 0xde},
	{'I', 'p', 0xde},	// Ãž Vim 5.x compatible
	{'s', 's', 0xdf},
	{'a', '!', 0xe0},
	{'a', '`', 0xe0},	// Ã  Vim 5.x compatible
	{'a', '\'', 0xe1},
	{'a', '>', 0xe2},
	{'a', '^', 0xe2},	// Ã¢ Vim 5.x compatible
	{'a', '?', 0xe3},
	{'a', '~', 0xe3},	// Ã£ Vim 5.x compatible
	{'a', ':', 0xe4},
	{'a', '"', 0xe4},	// Ã¤ Vim 5.x compatible
	{'a', 'a', 0xe5},
	{'a', '@', 0xe5},	// Ã¥ Vim 5.x compatible
	{'a', 'e', 0xe6},
	{'c', ',', 0xe7},
	{'e', '!', 0xe8},
	{'e', '`', 0xe8},	// Ã¨ Vim 5.x compatible
	{'e', '\'', 0xe9},
	{'e', '>', 0xea},
	{'e', '^', 0xea},	// Ãª Vim 5.x compatible
	{'e', ':', 0xeb},
	{'e', '"', 0xeb},	// Ã« Vim 5.x compatible
	{'i', '!', 0xec},
	{'i', '`', 0xec},	// Ã¬ Vim 5.x compatible
	{'i', '\'', 0xed},
	{'i', '>', 0xee},
	{'i', '^', 0xee},	// Ã® Vim 5.x compatible
	{'i', ':', 0xef},
	{'d', '-', 0xf0},
	{'n', '?', 0xf1},
	{'n', '~', 0xf1},	// Ã± Vim 5.x compatible
	{'o', '!', 0xf2},
	{'o', '`', 0xf2},	// Ã² Vim 5.x compatible
	{'o', '\'', 0xf3},
	{'o', '>', 0xf4},
	{'o', '^', 0xf4},	// Ã´ Vim 5.x compatible
	{'o', '?', 0xf5},
	{'o', '~', 0xf5},	// Ãµ Vim 5.x compatible
	{'o', ':', 0xf6},
	{'-', ':', 0xf7},
	{'o', '/', 0xf8},
	{'u', '!', 0xf9},
	{'u', '`', 0xf9},	// Ã¹ Vim 5.x compatible
	{'u', '\'', 0xfa},
	{'u', '>', 0xfb},
	{'u', '^', 0xfb},	// Ã» Vim 5.x compatible
	{'u', ':', 0xfc},
	{'y', '\'', 0xfd},
	{'t', 'h', 0xfe},
	{'y', ':', 0xff},
