 ...
 *
 * There is some nuance to this. Scores donâ€™t have an intrinsic meaning. The
 * score range isnâ€™t 0 to 100. Itâ€™s roughly [50, 150]. Longer words have a
 ...
 * quite a bit.
 *
 * There is a penalty if you DONâ€™T match the first three letters. Which
 * effectively rewards matching near the start. However thereâ€™s no difference
