...
bool SVGAltGlyphItemElement::hasValidGlyphElements(Vector<String>& glyphNames) const
{
    ...
    // The â€˜altGlyphItemâ€™ element defines a candidate set of possible glyph substitutions.
    // The first â€˜altGlyphItemâ€™ element whose referenced glyphs are all available is chosen.
