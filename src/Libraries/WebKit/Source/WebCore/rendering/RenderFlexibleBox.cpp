...
void RenderFlexibleBox::performBaselineAlignment(LineState& lineState)
{
    ...
    auto flexItemWritingModeForBaselineAlignment = [&](const RenderBox& flexItem) {
        ...
        // the line-under and line-over edges for synthesis. However, when that writing modeâ€™s block flow direction
        ...
        //   Otherwise:
        //
        // If the boxâ€™s own writing mode is vertical, assume horizontal-tb.
        // If the boxâ€™s own writing mode is horizontal, assume vertical-lr if
