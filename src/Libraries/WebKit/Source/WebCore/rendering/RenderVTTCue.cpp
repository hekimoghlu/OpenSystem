...
void RenderVTTCue::repositionCueSnapToLinesNotSet()
{
    ...
    // â†³ If cueâ€™s WebVTT cue snap-to-lines flag is false
    ...
    case VTTCue::DirectionSetting::Horizontal:
        // â†³ If the WebVTT cue writing direction is horizontal
        if (m_cue->lineAlign() == VTTCue::LineAlignSetting::Center) {
            // â†³ If the WebVTT cue line alignment is center alignment
            ...
            // â†³ If the WebVTT cue line alignment is end alignment
    ...
    case VTTCue::DirectionSetting::VerticalGrowingRight:
        // â†³ If the WebVTT cue writing direction is vertical growing left or
