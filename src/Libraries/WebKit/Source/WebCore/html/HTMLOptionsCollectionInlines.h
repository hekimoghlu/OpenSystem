...
inline HTMLSelectElement& HTMLOptionsCollection::selectElement()
{
    return downcast<HTMLSelectElement>(ownerNode());
}

inline const HTMLSelectElement& HTMLOptionsCollection::selectElement() const
{
    return downcast<HTMLSelectElement>(ownerNode());
}
