...
bool MediaControlsHost::showMediaControlsContextMenu(HTMLElement& target, String&& optionsJSONString, Ref<VoidCallback>&& callback)
{
    ...
    if (optionsJSONObject->getBoolean("includePlaybackRates"_s).value_or(false)) {
        ...
        items.append(createSubmenu(WEB_UI_STRING_KEY("Playback Speed", "Playback Speed (Media Controls Menu)", "Playback Speed media controls context menu title"), "speedometer"_s, {
            createMenuItem(PlaybackSpeed::x0_5, WEB_UI_STRING_KEY("0.5Ã—", "0.5Ã— (Media Controls Menu Playback Speed)", "0.5Ã— media controls context menu playback speed label"), playbackRate == 0.5),
            createMenuItem(PlaybackSpeed::x1_0, WEB_UI_STRING_KEY("1Ã—", "1Ã— (Media Controls Menu Playback Speed)", "1Ã— media controls context menu playback speed label"), playbackRate == 1.0),
            createMenuItem(PlaybackSpeed::x1_25, WEB_UI_STRING_KEY("1.25Ã—", "1.25Ã— (Media Controls Menu Playback Speed)", "1.25Ã— media controls context menu playback speed label"), playbackRate == 1.25),
            createMenuItem(PlaybackSpeed::x1_5, WEB_UI_STRING_KEY("1.5Ã—", "1.5Ã— (Media Controls Menu Playback Speed)", "1.5Ã— media controls context menu playback speed label"), playbackRate == 1.5),
            createMenuItem(PlaybackSpeed::x2_0, WEB_UI_STRING_KEY("2Ã—", "2Ã— (Media Controls Menu Playback Speed)", "2Ã— media controls context menu playback speed label"), playbackRate == 2.0),
        }));
    }
