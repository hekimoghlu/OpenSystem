...
RefPtr<CSSValue> consumeGridLine(CSSParserTokenRange& range, const CSSParserContext& context)
{
    // <grid-line> = auto
    //             | <custom-ident>
    //             | [ [ <integer [-âˆž,-1]> | <integer [1,âˆž]> ] && <custom-ident>? ]
...
{
    // <track-breadth>       = <length-percentage [0,âˆž]> | <flex [0,âˆž]> | min-content | max-content | auto
...
RefPtr<CSSValue> consumeGridTrackSize(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    // <track-breadth>       = <length-percentage [0,âˆž]> | <flex [0,âˆž]> | min-content | max-content | auto
    // <inflexible-breadth>  = <length-percentage [0,âˆž]> | min-content | max-content | auto
    //
