...
private:
    CSSAppleColorFilterPropertyValue(CSS::AppleColorFilterProperty);

    CSS::AppleColorFilterProperty m_filter;
};

} // namespace WebCore

SPECIALIZE_TYPE_TRAITS_CSS_VALUE(CSSAppleColorFilterPropertyValue, isAppleColorFilterPropertyValue())
