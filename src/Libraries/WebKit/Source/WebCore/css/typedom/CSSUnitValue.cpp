...
static CSS::Range rangeForProperty(CSSPropertyID propertyID, CSSUnitType)
{
    ...
    case CSSPropertyOrphans:        // FIXME: Support more fine-grain ranges: `<integer [1,âˆž]>`
    case CSSPropertyWidows:         // FIXME: Support more fine-grain ranges: `<integer [1,âˆž]>`
    case CSSPropertyColumnCount:    // FIXME: Support more fine-grain ranges: `<integer [1,âˆž]>`
