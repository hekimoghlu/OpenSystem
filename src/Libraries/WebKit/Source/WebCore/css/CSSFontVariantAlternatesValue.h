...
public:
    static Ref<CSSFontVariantAlternatesValue> create(FontVariantAlternates&& value)
    {
        return adoptRef(*new CSSFontVariantAlternatesValue(WTFMove(value)));
    }
...
private:
    CSSFontVariantAlternatesValue(FontVariantAlternates&&);
