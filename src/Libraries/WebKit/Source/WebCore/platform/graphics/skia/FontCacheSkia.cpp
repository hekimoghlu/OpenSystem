...
Vector<hb_feature_t> FontCache::computeFeatures(const FontDescription& fontDescription, const FontCreationContext& fontCreationContext)
{
    ...
    // 3. Font features implied by the value of the â€˜font-variantâ€™ property, the related â€˜font-variantâ€™
    ...
    // 4. Feature settings determined by properties other than â€˜font-variantâ€™ or â€˜font-feature-settingsâ€™.
    ...
    // 5. Font features implied by the value of â€˜font-feature-settingsâ€™ property.
