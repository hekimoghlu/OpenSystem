...
Vector<uint8_t> vpcCFromVPCodecConfigurationRecord(const VPCodecConfigurationRecord& record)
{
    ...
    // }
    //
    // codecIntializationDataSizeâ€‹For VP8 and VP9 this field must be 0.
    // codecIntializationDataâ€‹binary codec initialization data. Not used for VP8 and VP9.
...
void setConfigurationColorSpaceFromVP9ColorSpace(VPCodecConfigurationRecord& record, uint8_t colorSpace)
{
    ...
    case Vp9ColorSpaceValues::kCS_BT_2020:
        ...
        // however, VP9 does not specify if it is in the form of â€œconstant luminanceâ€ or â€œnonconstant luminanceâ€.
