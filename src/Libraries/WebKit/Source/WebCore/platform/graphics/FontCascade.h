...
public:
    ...
    static bool isCharacterWhoseGlyphsShouldBeDeletedForTextRendering(char32_t character)
    {
        ...
        // "Control characters (Unicode category Cc)â€”other than tabs (U+0009), line feeds (U+000A), carriage returns (U+000D) and sequences that form a segment breakâ€”must be rendered as a visible glyph"
...
{
    ASSERT(m_fonts);
    auto& font = protectedFonts()->primaryFont(m_fontDescription, protectedFontSelector().get());
