...
private:
    String extractCodec(const webm::TrackEntry& track) const
    {
        ...
        // slash (â€œ/â€) as a separator between the Major Codec ID and the Codec ID Suffix. The Major Codec
        // ID MUST be composed of only capital letters (A-Z) and numbers (0-9). The Codec ID Suffix MUST
        // be composed of only capital letters (A-Z), numbers (0-9), underscore (â€œ_â€), and forward slash (â€œ/â€)."
