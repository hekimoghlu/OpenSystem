...
ExceptionOr<void> AnimationEffect::updateTiming(Document& document, std::optional<OptionalEffectTiming> timing)
{
    ...
    //
    //    delay â†’ start delay
    //    endDelay â†’ end delay
    //    fill â†’ fill mode
    //    iterationStart â†’ iteration start
    //    iterations â†’ iteration count
    //    duration â†’ iteration duration
    //    direction â†’ playback direction
    //    easing â†’ timing function
