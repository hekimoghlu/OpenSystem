...
static String canonicalizeTimeZoneName(const String& timeZoneName)
{
    ...
    do {
        ...
        // 2. If ianaTimeZone is a Link name, then let ianaTimeZone be the corresponding Zone name as specified in the â€œbackwardâ€ file of the IANA Time Zone Database.
...
JSValue IntlDateTimeFormat::formatRangeToParts(JSGlobalObject* globalObject, double startDate, double endDate)
{
    ...
    //
    // Formatted string: "1/3/2019â€‰â€“â€‰1/5/2019"
    //                    | | |  |   | | |  |
    //                    B C |  |   F G |  |
    //                    |   +-D+   |   +-H+
    //                    |      |   |      |
    ...
    //  For example, in the above formatted string, "â€‰â€“â€‰" is "shared" part. For UFIELD_CATEGORY_DATE ranges, we generate corresponding
