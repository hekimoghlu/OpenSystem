 ...
 */
#if !defined(ZYAN_FALLTHROUGH) && defined(__cplusplus) && defined(__has_cpp_attribute)

#if __has_cpp_attribute(fallthrough)
#define ZYAN_FALLTHROUGH [[fallthrough]]
#elif __has_cpp_attribute(clang::fallthrough)
#define ZYAN_FALLTHROUGH [[clang::fallthrough]]
#elif __has_cpp_attribute(gnu::fallthrough)
#define ZYAN_FALLTHROUGH [[gnu::fallthrough]]
#endif

#elif !defined(ZYAN_FALLTHROUGH) && !defined(__cplusplus)

#if ((defined(ZYAN_GCC) && __GNUC__ >= 7) || defined(ZYAN_CLANG)) && defined(__has_attribute)
...
#endif // !defined(ZYAN_FALLTHROUGH) && defined(__cplusplus) && defined(__has_cpp_attribute)

#if !defined(ZYAN_FALLTHROUGH)
