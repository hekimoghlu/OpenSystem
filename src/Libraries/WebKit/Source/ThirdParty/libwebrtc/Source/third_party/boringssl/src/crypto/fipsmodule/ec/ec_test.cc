...
// Test that multiplying by the order produces Ã¢Ë†Å¾ and, moreover, that callers may
...
TEST_P(ECCurveTest, MulOrder) {
  ...
  // Test that p Ãƒâ€” order = Ã¢Ë†Å¾, for some arbitrary p.
