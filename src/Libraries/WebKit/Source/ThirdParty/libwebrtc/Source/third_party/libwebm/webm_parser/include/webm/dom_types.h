...
enum class MatrixCoefficients : std::uint64_t {
  ...
  /**
   Rec.Â ITU-R BT.470â€‘6 System B, G (historical).
   */
  kBt470Bg = 5,
  ...
  /**
   Rec.Â ITU-R BT.2020 (non-constant luminance).
   */
  kBt2020NonconstantLuminance = 9,

  /**
   Rec.Â ITU-R BT.2020 (constant luminance).
   */
...
enum class TransferCharacteristics : std::uint64_t {
  ...
  /**
   Rec. ITUâ€‘R BT.470â€‘6 System M (historical) with assumed display gamma 2.2.
   */
  kGamma22curve = 4,

  /**
   Rec. ITUâ€‘R BT.470-6 System B, G (historical) with assumed display gamma 2.8.
   */
  kGamma28curve = 5,
  ...
  /**
   Logarithmic transfer characteristic (100Â *Â Sqrt(10)Â :Â 1 range).
   */
  kLogSqrt = 10,
  ...
  /**
   Rec. ITUâ€‘R BT.1361-0 extended colour gamut system (historical).
   */
...
enum class Primaries : std::uint64_t {
  ...
  /**
   Rec. ITUâ€‘R BT.470â€‘6 System M (historical).
   */
  kBt470M = 4,

  /**
   Rec. ITUâ€‘R BT.470â€‘6 System B, G (historical).
   */
  kBt470Bg = 5,
