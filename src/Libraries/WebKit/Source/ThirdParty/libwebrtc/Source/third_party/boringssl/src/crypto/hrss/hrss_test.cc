...
TEST(HRSS, Poly3Invert) {
  ...
  for (size_t i = 0; i < N - 1; i++) {
    ...
    // rÃƒâ€”rÃ¢ÂÂ»Ã‚Â¹ = 1, and |p| contains 1.
    EXPECT_EQ(
...
TEST(HRSS, Poly3UnreducedInput) {
  ...
  // |r| is reduced mod ÃŽÂ¦(N), so add x^701 - 1 and recompute to ensure that we
  // get the same answer. (Since (x^701 - 1) Ã¢â€°Â¡ 0 mod ÃŽÂ¦(N).)
  ...
  // Check that x^700 Ãƒâ€” 1 gives -x^699 - x^698 Ã¢â‚¬Â¦ -1.
  poly3 x700;
