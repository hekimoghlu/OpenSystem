...
void CubeMapTextureTest::runSampleCoordinateTransformTest(const char *shader, const bool useES3)
{
    ...
    for (GLenum face = 0; face < kCubeFaceCount; face++)
    {
        ...
        //  +rx  TEXTURE_CUBE_MAP_POSITIVE_X âˆ’rz âˆ’ry rx
        //  âˆ’rx  TEXTURE_CUBE_MAP_NEGATIVE_X  rz âˆ’ry rx
        //  +ry  TEXTURE_CUBE_MAP_POSITIVE_Y  rx  rz ry
        //  âˆ’ry  TEXTURE_CUBE_MAP_NEGATIVE_Y  rx âˆ’rz ry
        //  +rz  TEXTURE_CUBE_MAP_POSITIVE_Z  rx âˆ’ry rz
        //  âˆ’rz  TEXTURE_CUBE_MAP_NEGATIVE_Z âˆ’rx âˆ’ry rz
        //
