...
inline constexpr const char kBaseLevelNegative[] = "Base level must be at least 0.";
inline constexpr const char kBaseLevelNonZero[] = "Base level must be 0.";
...
inline constexpr const char kNegativeBufferSize[] = "Negative buffer size.";
inline constexpr const char kNegativeBufSize[] = "Invalid bufSize.";
inline constexpr const char kNegativeCount[] = "Negative count.";
inline constexpr const char kNegativeHeightWidthDepth[] = "Cannot have negative height, width, or depth.";
inline constexpr const char kNegativeLayer[] = "Negative layer.";
inline constexpr const char kNegativeLength[] = "Negative length.";
inline constexpr const char kNegativeLevel[] = "Level is negative.";
inline constexpr const char kNegativeLocation[] = "Location cannot be less than 0.";
...
inline constexpr const char kNegativeParam[] = "param is negative.";
inline constexpr const char kNegativePrimcount[] = "Primcount must be greater than or equal to zero.";
inline constexpr const char kNegativeSize[] = "Negative size.";
inline constexpr const char kNegativeStart[] = "Cannot have negative start.";
inline constexpr const char kNegativeStride[] = "Cannot have negative stride.";
inline constexpr const char kNegativeXYZ[] = "x = y = or z cannot be negative.";
...
inline constexpr const char kViewportNegativeSize[] = "Viewport size cannot be negative.";
