 ...
 *
 * - A unique â€œidentifierâ€: [method@Feature.get_identifier].
 * - A â€œdefault valueâ€, which indicates whether the option is enabled
 *   automatically: [method@Feature.get_default_value].
 * - Its â€œstatusâ€, which determines whether it should be considered
 ...
 * - An optional short â€œnameâ€ which can be presented to an user:
 *   [method@Feature.get_name].
 * - An optional longer â€œdetailedâ€ description:
 ...
 * (i.e. in â€œtechnology previewâ€ or â€œcanaryâ€ builds).
 *
