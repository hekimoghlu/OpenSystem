...
ALLOW_DEPRECATED_DECLARATIONS_END
    ...
    NSString *openInExternalApplicationTitle = [NSString stringWithFormat:WEB_UI_NSSTRING(@"Open in â€œ%@â€", "Title for Open in External Application Link action button"), externalApplicationName];
