...
void WebAutomationSession::handleRunOpenPanel(const WebPageProxy& page, const WebFrameProxy&, const API::OpenPanelParameters& parameters, WebOpenPanelResultListenerProxy& resultListener)
{
    ...
    // Per Â§14.3.10.5 in the W3C spec, if at least one file cannot be accepted, the command should fail.
...
{
    // This command implements WebKit support for Â§17.5 Perform Actions.
    ...
    // already performed the steps in Â§17.3 Processing Actions Requests.
    ...
    // Delegate the rest of Â§17.4 Dispatching Actions to the dispatcher.
...
{
    // This command implements WebKit support for Â§17.6 Release Actions.
