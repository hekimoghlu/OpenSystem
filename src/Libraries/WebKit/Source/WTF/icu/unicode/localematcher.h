 ...
 * the clientâ€™s Accept-Language header data.
...
enum ULocMatchDirection {
    /**
     * Locale matching includes one-way matches such as Bretonâ†’French. (default)
     *
     * @stable ICU 67
     */
    ULOCMATCH_DIRECTION_WITH_ONE_WAY,
    /**
     * Locale matching limited to two-way matches including e.g. Danishâ†”Norwegian
...
public:
    ...
    public:
         ...
         * constructorâ€™s or builderâ€™s input order (â€œsetâ€ Collection plus â€œaddedâ€ locales).
