...
mDNSlocal int SetupSocket(struct sockaddr *intfAddr, mDNSIPPort port, int interfaceIndex, int *sktPtr)
{
    ...
    {
        // <rdar://problem/20946253> Suggestions from Jonny Țrnbom at Axis Communications
        // We test for SO_REUSEADDR first, as suggested by Jonny Țrnbom from Axis Communications
