 ...
 * Version strings less than or equal to 1661 are encoded as (x * 10000) + (y * 100) + z, where 0 â‰¤ y,z â‰¤ 99.
 * Version strings greater than 1661 are encoded as (x * 1000000) + (y * 1000) + z, where 0 â‰¤ y,z â‰¤ 999.
