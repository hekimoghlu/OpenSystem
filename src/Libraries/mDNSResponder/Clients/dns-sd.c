...
static void print_usage(const char *arg0, int print_all)
{
    ...
    fprintf(stderr, "%s -L <Name> <Type> <Domain>        (Resolve (â€˜lookupâ€™) a service instance)\n", arg0);
...
int main(int argc, char **argv)
{
    ...
    case 'V':   {
        ...
        else
        {
            ...
            // Newer version strings are encoded as (x * 1000000) + (y * 1000) + z, where 0 â‰¤ y,z â‰¤ 999.
            // Older version strings were encoded as (x * 10000) + (y * 100) + z, where 0 â‰¤ y,z â‰¤ 99.
            uint32_t x, y, z;
