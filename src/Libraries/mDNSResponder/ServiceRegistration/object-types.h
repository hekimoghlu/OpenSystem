...
OBJECT_TYPE(adv_service_state)
OBJECT_TYPE(adv_instance_state)
OBJECT_TYPE(advertising_proxy_conn_ref)
OBJECT_TYPE(advertising_proxy_subscription)
OBJECT_TYPE(comm)
...
NW_OBJECT_TYPE(nw_connection)
NW_OBJECT_TYPE(nw_listener)
NW_OBJECT_TYPE(nw_path_evaluator)
...
OBJECT_TYPE(threadsim_network_state)
OBJECT_TYPE(threadsim_node_state)
OBJECT_TYPE(wakeup)
