...
void PullbackCloner::Implementation::
  ...
  //  %18 = function_ref @$ss27_allocateUninitializedArrayySayxG_BptBwlF : $@convention(thin) <Ï„_0_0> (Builtin.Word) -> (@owned Array<Ï„_0_0>, Builtin.RawPointer)
  //  %19 = apply %18<Float>(%17) : $@convention(thin) <Ï„_0_0> (Builtin.Word) -> (@owned Array<Ï„_0_0>, Builtin.RawPointer)
  ...
  //  %25 = function_ref @$ss27_finalizeUninitializedArrayySayxGABnlF : $@convention(thin) <Ï„_0_0> (@owned Array<Ï„_0_0>) -> @owned Array<Ï„_0_0>
  //  %26 = apply %25<Float>(%20) : $@convention(thin) <Ï„_0_0> (@owned Array<Ï„_0_0>) -> @owned Array<Ï„_0_0> // user: %27
