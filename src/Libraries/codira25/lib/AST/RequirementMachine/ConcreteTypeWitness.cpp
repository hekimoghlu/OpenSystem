...
///
///    T => { conforms_to: [ P ], concrete: Foo<Int, Ï„_0_0> with <U> }
///
/// The type witness for A in the conformance Foo<Int, Ï„_0_0> : P is
...
/// abstract type 'Ï„_0_0.V', which via the substitutions <U> corresponds
