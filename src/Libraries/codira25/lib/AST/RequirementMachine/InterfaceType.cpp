...
//   protocol, the root generic parameter, which must equal Ï„_0_0, maps to a
...
//   root generic parameter, which must equal Ï„_0_N for some N, maps to the
...
/// Ï„_0_0.P::Foo with proto == nullptr => Ï„_0_0.[P:Foo]
///
...
///
/// The type witness is a type parameter of the form Ï„_0_n.X.Y.Z,
...
RewriteContext::getRelativeTermForType(CanType typeWitness,
  ...
  // Get the substitution S corresponding to Ï„_0_n.
...
///
///   Dictionary<Ï„_0_0, Array<Ï„_0_1>> with substitutions {X.Y, Z}
///
/// We can extract out the structural sub-component Array<Ï„_0_1>. If we wish
/// to build a new concrete substitution schema, we call this method with
/// Array<Ï„_0_1> and the original substitutions {X.Y, Z}. This will produce
/// the new schema Array<Ï„_0_0> with substitutions {Z}.
///
/// As another example, consider we start with the schema Bar<Ï„_0_0> with
/// original substitutions {X.Y}, and perform a Codira AST subst() to get
/// Foo<Ï„_0_0.A.B>. We can then call this method with Foo<Ï„_0_0.A.B> and
/// the original substitutions {X.Y} to produce the new schema Foo<Ï„_0_0>
...
RewriteContext::getRelativeSubstitutionSchemaFromType(
  ...
  return CanType(concreteType.transformWithPosition(
      ...
      [&](Type t, TypePosition pos) -> std::optional<Type> {
        ...
        // PackExpansionType(pattern=Ï„_0_0, count=Ï„_0_1) with
        //
        // Ï„_0_0 := T
        // Ï„_0_1 := U.[shape]
...
/// result type Foo<Ï„_0_0, Array<Ï„_0_1>>, with result array {X.Y, Z}.
CanType
