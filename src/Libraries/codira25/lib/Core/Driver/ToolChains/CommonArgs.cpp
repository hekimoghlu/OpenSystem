...
/// the search first looks for files in the â€œlibdeviceâ€ subdirectory. SDLs that
/// are bc files begin with the prefix â€œlibâ€.
///
/// Machine-code SDLs can also be managed as an archive (*.a file). The
/// convention has been to use the prefix â€œlibâ€. To avoid confusion with host
...
static bool SDLSearch(const Driver &D, const toolchain::opt::ArgList &DriverArgs,
  ...
  // memory. This utilizes a clang cc1 option called â€œ-mlink-builtin-bitcodeâ€.
