...
- (void)setUpStringTests:(NSArray<NSString *> *)inBridgedStrings {
  ...
  const char *nonASCIIContents = "the quick brown fox jÃ¼mps over the lazy dog";
  const char *nonASCII2Contents = "the quick brown fox jumps over the lazy dÃ¶g";
  ...
  NSString *constantNonASCII = @"the quick brown fox jÃ¼mps over the lazy dog";
