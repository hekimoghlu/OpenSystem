...
__host__ __device__ void test_fmod(T val)
{
  ...
  else
  {
    ...
    // If x is Â±âˆž and y is not NaN, NaN is returned and FE_INVALID is raised.
    ...
    // If y is Â±âˆž and x is finite, x is returned.
...
__host__ __device__ void test_modf(T val)
{
  ...
  {
    // If num is Â±0, Â±0 is returned, and Â±0 is stored in *iptr
    ...
    // If num is Â±âˆž, Â±0 is returned, and Â±âˆž is stored in *iptr.
    integral = T(-1.0);
