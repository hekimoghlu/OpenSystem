...
#ifndef DALI_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_
#define DALI_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_
...
#endif  // DALI_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_
