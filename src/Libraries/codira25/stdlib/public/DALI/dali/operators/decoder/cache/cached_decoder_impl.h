...
#ifndef DALI_OPERATORS_DECODER_CACHE_CACHED_DECODER_IMPL_H_
#define DALI_OPERATORS_DECODER_CACHE_CACHED_DECODER_IMPL_H_
...
#endif  // DALI_OPERATORS_DECODER_CACHE_CACHED_DECODER_IMPL_H_
