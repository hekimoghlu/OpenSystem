...
#ifndef DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_GPU_H_
#define DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_GPU_H_
...
#endif  // DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_GPU_H_
