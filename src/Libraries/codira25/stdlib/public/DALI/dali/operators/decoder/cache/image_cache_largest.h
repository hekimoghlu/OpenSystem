...
#ifndef DALI_OPERATORS_DECODER_CACHE_IMAGE_CACHE_LARGEST_H_
#define DALI_OPERATORS_DECODER_CACHE_IMAGE_CACHE_LARGEST_H_
...
#endif  // DALI_OPERATORS_DECODER_CACHE_IMAGE_CACHE_LARGEST_H_
