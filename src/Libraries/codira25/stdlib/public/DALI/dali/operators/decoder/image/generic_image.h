...
#ifndef DALI_OPERATORS_DECODER_IMAGE_GENERIC_IMAGE_H_
#define DALI_OPERATORS_DECODER_IMAGE_GENERIC_IMAGE_H_
...
#endif  // DALI_OPERATORS_DECODER_IMAGE_GENERIC_IMAGE_H_
