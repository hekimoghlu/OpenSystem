...
#ifndef DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_UTILS_H_
#define DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_UTILS_H_
...
#endif  // DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_UTILS_H_
