...
#ifndef DALI_OPERATORS_VIDEO_READER_VIDEO_READER_RESIZE_OP_H_
#define DALI_OPERATORS_VIDEO_READER_VIDEO_READER_RESIZE_OP_H_
...
#include "dali/operators/video/legacy/reader/video_reader_op.h"
