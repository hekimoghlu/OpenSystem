...
#ifndef DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_H_
#define DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_H_
...
template <typename T>
void ApplyOrientation(nvimgcodecOrientation_t orientation, T *&data,
 ...
 */
template <typename Out, typename In>
void ConvertCPU(Out *out, const int64_t *out_strides, int out_channel_dim, DALIImageType out_format,
...
#endif  // DALI_OPERATORS_IMGCODEC_UTIL_CONVERT_H_
