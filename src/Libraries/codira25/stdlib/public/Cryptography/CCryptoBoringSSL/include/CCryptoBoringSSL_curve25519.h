...
// sometimes referred to as â€œcurve25519â€, but â€œX25519â€ is a more precise name.
...
// Ed25519 â€œseedâ€. Seed values are not exposed by this API (although they
...
// spake2_role_t enumerates the different â€œrolesâ€ in SPAKE2. The protocol
// requires that the symmetry of the two parties be broken so one participant
// must be â€œAliceâ€ and the other be â€œBobâ€.
enum spake2_role_t {
  spake2_role_alice,
  spake2_role_bob,
};
