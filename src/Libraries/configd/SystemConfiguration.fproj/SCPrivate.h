...
/*!
 ...
 1. Trim .â€™s and *â€™s from the front and back of hostname and domain.
 2. If the number of .â€™s left in the hostname and domain are equal, require an exact match.
 3. Else, if the number of .â€™s in the hostname is greater than the number of .â€™s in the domain, and the number of .â€™s in the domain is greater than zero, append a . to the front of the domain and do a suffix match on the hostname.
 4. Else, fail.
