...
const CFStringRef kSCPrefCategories                                = CFSTR("Categories");
...
const CFStringRef kSCEntNetPvD                                     = CFSTR("PvD");
...
const CFStringRef kSCPropNetProxiesFTPUser                         = CFSTR("FTPUser");
...
const CFStringRef kSCPropNetProxiesGopherUser                      = CFSTR("GopherUser");
...
const CFStringRef kSCPropNetProxiesHTTPUser                        = CFSTR("HTTPUser");
...
const CFStringRef kSCPropNetProxiesHTTPSUser                       = CFSTR("HTTPSUser");
...
const CFStringRef kSCPropNetProxiesRTSPUser                        = CFSTR("RTSPUser");
...
const CFStringRef kSCPropNetProxiesSOCKSUser                       = CFSTR("SOCKSUser");
...
const CFStringRef kSCPropNetQoSMarkingAllowListAppIdentifiers      = CFSTR("QoSMarkingAllowListAppIdentifiers");
