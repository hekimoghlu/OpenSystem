...
extern const NSString * const kSCTestInterfaceRankAssertion;
extern const NSString * const kSCTestServiceRankAssertion;
...
#define kSCTestOptionEntriesNonBridgeOS \
		...
		{"interface", 1, NULL, 0}, \
		{"watch", 0, NULL, 0}, \
		{"interface_rank", 0, NULL, 0}, \
		{"service_rank", 0, NULL, 0}, \
...
#define kSCTestOptionHelpNonBridgeOS \
		...
		"\n============== rank_assertion options =============\n"\
		"-interface_rank      : Runs a unit test for interface rank assertion\n"\
		"-service_rank        : Runs a unit test for interface rank assertion\n"\
