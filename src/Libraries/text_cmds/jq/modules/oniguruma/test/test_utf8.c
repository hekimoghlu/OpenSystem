...
extern int main(int argc, char* argv[])
{
  ...
  x2("æ²³+", "æ²³", 0, 3);
  x2("æ™‚+", "æ™‚æ™‚æ™‚æ™‚", 0, 12);
  x2("ãˆ+", "ãˆãˆã†ã†ã†", 0, 6);
  x2("ã†+", "ãŠã†ã†ã†ã†", 3, 15);
  x2(".?", "ãŸ", 0, 3);
  x2(".*", "ã±ã´ã·ãº", 0, 12);
  x2(".+", "ã‚", 0, 3);
  x2(".+", "ã„ã†ãˆã‹\n", 0, 12);
  ...
  x2("(ã‚|ã„)*", "ã„ã‚", 0, 6);
  x2("(ã‚|ã„)+", "ã„ã‚ã„", 0, 9);
  x2("(ã‚ã„|ã†ã‚)+", "ã†ã‚ã‚ã„ã†ãˆ", 0, 12);
  x2("(ã‚ã„|ã†ãˆ)+", "ã†ã‚ã‚ã„ã†ãˆ", 6, 18);
  ...
  x2("(?:å¤¢?)+?", "å¤¢å¤¢å¤¢", 0, 3);
  x2("(?:é¢¨+)?\?", "é¢¨é¢¨é¢¨", 0, 0);
  x2("(?:é›ª+)?\?éœœ", "é›ªé›ªé›ªéœœ", 0, 12);
  x2("(?:ã‚ã„)?{2}", "", 0, 0);
  x2("(?:é¬¼è»Š)?{2}", "é¬¼è»Šé¬¼è»Šé¬¼", 0, 12);
  x2("(?:é¬¼è»Š)*{0}", "é¬¼è»Šé¬¼è»Šé¬¼", 0, 0);
  x2("(?:é¬¼è»Š){3,}", "é¬¼è»Šé¬¼è»Šé¬¼è»Šé¬¼è»Š", 0, 24);
  n("(?:é¬¼è»Š){3,}", "é¬¼è»Šé¬¼è»Š");
  x2("(?:é¬¼è»Š){2,4}", "é¬¼è»Šé¬¼è»Šé¬¼è»Š", 0, 18);
  x2("(?:é¬¼è»Š){2,4}", "é¬¼è»Šé¬¼è»Šé¬¼è»Šé¬¼è»Šé¬¼è»Š", 0, 24);
  x2("(?:é¬¼è»Š){2,4}?", "é¬¼è»Šé¬¼è»Šé¬¼è»Šé¬¼è»Šé¬¼è»Š", 0, 12);
  x2("(?:é¬¼è»Š){,}", "é¬¼è»Š{,}", 0, 9);
  x2("(?:ã‹ãã)+?{2}", "ã‹ããã‹ããã‹ãã", 0, 18);
  x3("(ç«)", "ç«", 0, 3, 1);
  x3("(ç«æ°´)", "ç«æ°´", 0, 6, 1);
  x2("((æ™‚é–“))", "æ™‚é–“", 0, 6);
  x3("((é¢¨æ°´))", "é¢¨æ°´", 0, 6, 1);
  ...
  x2("(ç©º?)\\1", "ç©ºç©º", 0, 6);
  x2("(ç©º?\?)\\1", "ç©ºç©º", 0, 0);
  x2("(ç©º*)\\1", "ç©ºç©ºç©ºç©ºç©º", 0, 12);
  x3("(ç©º*)\\1", "ç©ºç©ºç©ºç©ºç©º", 0, 6, 1);
  x2("ã‚(ã„*)\\1", "ã‚ã„ã„ã„ã„", 0, 15);
  x2("ã‚(ã„*)\\1", "ã‚ã„", 0, 3);
  x2("(ã‚*)(ã„*)\\1\\2", "ã‚ã‚ã‚ã„ã„ã‚ã‚ã‚ã„ã„", 0, 30);
  x2("(ã‚*)(ã„*)\\2", "ã‚ã‚ã‚ã„ã„ã„ã„", 0, 21);
  x3("(ã‚*)(ã„*)\\2", "ã‚ã‚ã‚ã„ã„ã„ã„", 9, 15, 2);
  x2("(((((((ã½*)ãº))))))ã´\\7", "ã½ã½ã½ãºã´ã½ã½ã½", 0, 24);
  x3("(((((((ã½*)ãº))))))ã´\\7", "ã½ã½ã½ãºã´ã½ã½ã½", 0, 9, 7);
  ...
  x2("aaaaaaaaaaaaaaaaaaaaaaaã‚b", "aaaaaaaaaaaaaaaaaaaaaaaã‚b", 0, 27); /* Issue #221 */
