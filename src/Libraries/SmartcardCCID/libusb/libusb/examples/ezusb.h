...
#define ezusb_H
/*
 * Copyright Â© 2001 Stephen Williams (steve@icarus.com)
 * Copyright Â© 2002 David Brownell (dbrownell@users.sourceforge.net)
 * Copyright Â© 2013 Federico Manzan (f.manzan@gmail.com)
 *
