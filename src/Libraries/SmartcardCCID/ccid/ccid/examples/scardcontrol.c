...
int main(int argc, char *argv[])
{
	...
	printf("V 1.4 Â© 2004-2010, Ludovic Rousseau <ludovic.rousseau@free.fr>\n\n");
	 ...
	 * 00: PIN insertion prompt        â€œENTER SMARTCARD PINâ€
	 * 01: PIN Modification prompt     â€œ ENTER NEW PINâ€
	 * 02: NEW PIN Confirmation prompt â€œ CONFIRM NEW PINâ€
	 */
