...
namespace Connections {
    [GtkTemplate (ui = "/org/gnome/Connections/ui/spice-preferences.ui")]
    private class SpicePreferencesWindow : Connections.PreferencesWindow {
        [GtkChild]
        ...
        public SpicePreferencesWindow (Connection connection) {
