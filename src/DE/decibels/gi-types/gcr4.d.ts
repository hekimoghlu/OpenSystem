...
export function trust_is_certificate_distrusted(
    serial_nr: Uint8Array | string,
    issuer: Uint8Array | string,
    cancellable?: Gio.Cancellable | null
): boolean;
export function trust_is_certificate_distrusted_async(
    serial_nr: Uint8Array | string,
    issuer: Uint8Array | string,
    cancellable?: Gio.Cancellable | null
): Promise<boolean>;
...
export class CertificateField extends GObject.Object {
    ...
    constructor(properties?: Partial<CertificateField.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<CertificateField.ConstructorProperties>, ...args: any[]): void;
...
export class CertificateSection extends GObject.Object {
    ...
    constructor(properties?: Partial<CertificateSection.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<CertificateSection.ConstructorProperties>, ...args: any[]): void;
...
export class Pkcs11Certificate extends Gck.Object implements Certificate {
    ...
    static new_from_uri_async(pkcs11_uri: string, cancellable?: Gio.Cancellable | null): Promise<Certificate | null>;
...
export class SimpleCertificate extends GObject.Object implements Certificate {
...
export interface CertificatePrototype extends GObject.Object {
    // Properties
