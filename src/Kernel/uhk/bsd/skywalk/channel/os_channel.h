 ...
 * need to specify the ring_id_t which identifies the ring â€” this is true
 ...
 * call returns a NULL handle.  Itâ€™s important to note that this
 * call does NOT advance the ringâ€™s current slot pointer; calling this
 ...
 *
 * To advance the ringâ€™s current pointer, the client invokes
