...
// Things get started with a call to netstats to say that thereÃ¢â‚¬â„¢s a new connection:
...
// Things get started with a call from the provider to netstats to say that thereÃ¢â‚¬â„¢s a new source
...
/* Performs interface matching based on NSTAT_IFNET_ISÃ¢â‚¬Â¦ filter flags provided by an external caller */
static bool
