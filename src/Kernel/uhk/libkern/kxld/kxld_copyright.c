...
#define kCopyrightToken "Copyright Ã‚Â© "
...
CFStringRef passes[] = {
	CFSTR("Copyright Ã‚Â© 2008 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2004-2008 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2004,2006 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2004,2006-2008 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2004 , 2006-2008 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 1998,2000-2002,2004,2006-2008 Apple Inc. All rights reserved."),
	CFSTR("IOPCIFamily 2.1; Copyright Ã‚Â© 2004,2006-2008 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2004,2006-2008 Apple Inc. All rights reserved.  The quick brown fox jumped over the lazy dog."),
	CFSTR("IOPCIFamily 2.1; Copyright Ã‚Â© 2004,2006-2008 Apple Inc. All rights reserved.  The quick brown fox jumped over the lazy dog.")
};

CFStringRef fails[] = {
	CFSTR("Copyright Ã‚Â© 2007-08 Apple Inc. All rights reserved."),
	CFSTR("Copyright (c) 2007 Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2007- Apple Inc. All rights reserved."),
	CFSTR("Copyright Ã‚Â© 2007 - 2008 Apple Inc. All rights reserved.")
};
...
*   1) A copyright notice, "Copyright Ã‚Â©"
