...
printFormat(void)
{
	fprintf(stderr,
	    ...
	    "\tCopyright Ã‚Â© [year(s) of publication] Apple Inc. All rights reserved.\n\n"
	    ...
	    "\tCopyright Ã‚Â© 2008 Apple Inc. All rights reserved.\n"
	    "\tCopyright Ã‚Â© 2004-2008 Apple Inc. All rights reserved.\n"
	    "\tCopyright Ã‚Â© 1998,2000-2002,2004,2006-2008 Apple Inc. All rights reserved.\n");
}
