...
#define yyparse IOCFUnserializeparse
#define yylex   IOCFUnserializelex
#define yyerror IOCFUnserializeerror
#define yylval  IOCFUnserializelval
#define yychar  IOCFUnserializechar
#define yydebug IOCFUnserializedebug
#define yynerrs IOCFUnserializenerrs
...
{
       0,   139,   139,   142,   147,   152,   153,   154,   155,   156,
     157,   158,   159,   172,   175,   178,   181,   182,   187,   196,
     201,   204,   207,   210,   213,   216,   219,   222,   229,   232,
     235,   238,   241
};
#endif
...
#line 187 "IOCFUnserialize.yacc"
    { (yyval) = (yyvsp[(1) - (2)]);
				  (yyval)->key = (CFStringRef)(yyval)->object;
...
/* Line 1267 of yacc.c.  */
#line 1595 "IOCFUnserialize.temp"
      default: break;
    }
